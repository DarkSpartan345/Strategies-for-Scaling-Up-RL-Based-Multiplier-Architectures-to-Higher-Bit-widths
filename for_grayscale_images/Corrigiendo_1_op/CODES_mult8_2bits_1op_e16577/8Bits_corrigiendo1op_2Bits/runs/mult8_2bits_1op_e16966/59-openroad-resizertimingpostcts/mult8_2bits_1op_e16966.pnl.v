module mult8_2bits_1op_e16966 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__inv_2 _275_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__inv_2 _276_ (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _277_ (.A(net41),
    ...
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__and2_1 _278_ (.A(net48),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__nand2_1 _279_ (.A(net51),
    .B(net57),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__and4_4 _280_ (.A(net49),
    .B(net48),
    .C(net2),
    .D(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__and2b_1 _281_ (.A_N(net17),
    .B(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__and2_4 _282_ (.A(net49),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__and3_1 _283_ (.A(_217_),
    .B(_216_),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__a21oi_1 _284_ (.A1(_216_),
    .A2(_217_),
    .B1(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__nand2_2 _285_ (.A(net34),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__o21a_1 _286_ (.A1(net84),
    .A2(_220_),
    .B1(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__nor3_2 _287_ (.A(net83),
    .B(_220_),
    .C(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__nor2_1 _288_ (.A(_222_),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net25));
 sky130_fd_sc_hd__nand2_1 _289_ (.A(net48),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__and4_1 _290_ (.A(net47),
    .B(net52),
    .C(net4),
    .D(net64),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__and3b_2 _291_ (.A_N(_225_),
    .B(net65),
    .C(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__nand4_4 _292_ (.A(net2),
    .B(net70),
    .C(net11),
    .D(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__nand4_4 _293_ (.A(net17),
    .B(net74),
    .C(net61),
    .D(_227_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__a31o_1 _294_ (.A1(_227_),
    .A2(net73),
    .A3(net71),
    .B1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__a21o_1 _295_ (.A1(_229_),
    .A2(_228_),
    .B1(_219_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__nand2_1 _296_ (.A(_226_),
    .B(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _297_ (.A(_226_),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__xor2_2 _298_ (.A(_230_),
    .B(_226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__nand2_2 _299_ (.A(_223_),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__or2_1 _300_ (.A(_223_),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__and2_1 _301_ (.A(_234_),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__nand2_1 _302_ (.A(net54),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__nand2_1 _303_ (.A(net59),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__a2111oi_4 _304_ (.A1(net17),
    .A2(net69),
    .B1(_218_),
    .C1(_214_),
    .D1(_213_),
    ...
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__nand2_1 _305_ (.A(net39),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__nor3b_1 _306_ (.A(_224_),
    .B(_239_),
    .C_N(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__or3b_4 _307_ (.A(_224_),
    .B(_239_),
    .C_N(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__a32o_1 _308_ (.A1(net48),
    .A2(net4),
    .A3(_221_),
    .B1(net11),
    .B2(net68),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__and3_1 _309_ (.A(_241_),
    .B(_238_),
    .C(_242_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _311_ (.A_N(_243_),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__and4b_1 _312_ (.A_N(_243_),
    .B(_226_),
    .C(net79),
    .D(_244_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_246_));
 sky130_fd_sc_hd__xnor2_1 _313_ (.A(_231_),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__xnor2_2 _314_ (.A(_247_),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__and3_1 _315_ (.A(net60),
    .B(net13),
    .C(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__xnor2_2 _316_ (.A(_237_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_250_));
 sky130_fd_sc_hd__and3_1 _317_ (.A(net55),
    .B(net37),
    .C(_250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__a21oi_1 _318_ (.A1(net56),
    .A2(net37),
    .B1(_250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__nor2_1 _319_ (.A(_251_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__and3_1 _320_ (.A(net47),
    .B(net6),
    .C(_236_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _322_ (.A(_253_),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nand2_1 _323_ (.A(net53),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _326_ (.A_N(_257_),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__nand2_1 _327_ (.A(_227_),
    .B(_228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__nand4_2 _328_ (.A(net4),
    .B(net67),
    .C(net11),
    .D(net74),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_261_));
 sky130_fd_sc_hd__nand4_2 _329_ (.A(net63),
    .B(net74),
    .C(_225_),
    .D(_261_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__a31o_1 _330_ (.A1(net66),
    .A2(net74),
    .A3(_261_),
    .B1(_225_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__nand2_2 _331_ (.A(_262_),
    .B(_263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_264_));
 sky130_fd_sc_hd__xnor2_2 _332_ (.A(_264_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__and3_1 _333_ (.A(_223_),
    .B(_233_),
    .C(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__nor2_2 _334_ (.A(_240_),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__and2b_1 _335_ (.A_N(_267_),
    .B(_265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__o31a_1 _336_ (.A1(_240_),
    .A2(_243_),
    .A3(_265_),
    .B1(_246_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_269_));
 sky130_fd_sc_hd__and4_1 _337_ (.A(net4),
    .B(net75),
    .C(_239_),
    .D(_262_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_270_));
 sky130_fd_sc_hd__a31o_1 _338_ (.A1(_260_),
    .A2(_262_),
    .A3(_263_),
    .B1(_270_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__o31ai_1 _339_ (.A1(_266_),
    .A2(_268_),
    .A3(_269_),
    .B1(_271_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__or4_4 _340_ (.A(_266_),
    .B(_268_),
    .C(_271_),
    .D(_269_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _341_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__nand2_1 _342_ (.A(net50),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__xor2_1 _343_ (.A(_274_),
    .B(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__nand2_1 _344_ (.A(net39),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _345_ (.A(_001_),
    ...
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__nand2_1 _346_ (.A(_001_),
    .B(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__and2b_1 _347_ (.A_N(_003_),
    .B(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and3_1 _348_ (.A(_272_),
    .B(_005_),
    .C(_273_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a21oi_1 _349_ (.A1(_272_),
    .A2(_273_),
    .B1(_005_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__or3b_4 _350_ (.A(_007_),
    .B(_006_),
    .C_N(_259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__o21bai_1 _351_ (.A1(_006_),
    .A2(_007_),
    .B1_N(_259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__nand4_1 _352_ (.A(net2),
    .B(net50),
    .C(net13),
    .D(net44),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__and3_1 _353_ (.A(net50),
    .B(net44),
    .C(_010_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__xor2_1 _354_ (.A(net82),
    .B(net85),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__a41o_1 _355_ (.A1(_223_),
    .A2(_231_),
    .A3(_232_),
    .A4(_245_),
    .B1(_246_),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__xnor2_1 _356_ (.A(_012_),
    .B(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__and4_1 _357_ (.A(net53),
    .B(net47),
    .C(net6),
    .D(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__and3b_1 _358_ (.A_N(_015_),
    .B(net37),
    .C(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__xor2_1 _359_ (.A(_011_),
    .B(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__a22o_1 _360_ (.A1(_011_),
    .A2(_014_),
    .B1(_016_),
    .B2(_017_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__and3_1 _361_ (.A(_008_),
    .B(_009_),
    .C(_018_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__a21o_1 _362_ (.A1(_008_),
    .A2(_009_),
    .B1(_018_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__and2b_1 _363_ (.A_N(_019_),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__xnor2_1 _364_ (.A(_016_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__o21ba_4 _365_ (.A1(_249_),
    .A2(_251_),
    .B1_N(_022_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__xor2_2 _366_ (.A(_021_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__nand2b_4 _367_ (.A_N(_006_),
    .B(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__and4_1 _368_ (.A(net53),
    .B(net47),
    .C(net8),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nand4_1 _369_ (.A(net86),
    .B(net47),
    .C(net8),
    .D(net35),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _370_ (.A(net47),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__nand4_1 _371_ (.A(net11),
    .B(net74),
    .C(net6),
    .D(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__o2111a_1 _372_ (.A1(net87),
    .A2(net11),
    .B1(net6),
    .C1(net37),
    .D1(net47),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nand4_1 _373_ (.A(net76),
    .B(net37),
    .C(_028_),
    .D(_029_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__a31o_1 _374_ (.A1(net46),
    .A2(net37),
    .A3(_028_),
    .B1(_029_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__and3_1 _375_ (.A(_027_),
    .B(_030_),
    .C(_031_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__a21oi_1 _376_ (.A1(_030_),
    .A2(_031_),
    .B1(_027_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__nor2_1 _377_ (.A(_032_),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__and2_1 _378_ (.A(_257_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nor2_1 _379_ (.A(_257_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__or2_1 _380_ (.A(_035_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _381_ (.A(net4),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__and3b_1 _382_ (.A_N(_038_),
    .B(net44),
    .C(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__nand4_2 _383_ (.A(net2),
    .B(net50),
    .C(net43),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__o2111a_1 _384_ (.A1(net13),
    .A2(net43),
    .B1(net44),
    .C1(net2),
    .D1(net50),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nand4_1 _385_ (.A(net50),
    .B(net41),
    .C(_040_),
    .D(_041_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__a31o_1 _386_ (.A1(net50),
    .A2(net41),
    .A3(_040_),
    .B1(_041_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__and3_1 _387_ (.A(_039_),
    .B(_042_),
    .C(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__a21oi_1 _388_ (.A1(_042_),
    .A2(_043_),
    .B1(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__nor2_1 _389_ (.A(_044_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__nand2_2 _390_ (.A(_003_),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__xnor2_2 _391_ (.A(_003_),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__and3_1 _392_ (.A(_261_),
    .B(_262_),
    .C(_272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__or2_1 _393_ (.A(_048_),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _394_ (.A(_048_),
    ...
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__xor2_1 _395_ (.A(_037_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__and2_1 _396_ (.A(_024_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__xor2_4 _397_ (.A(_024_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__a21o_1 _398_ (.A1(_020_),
    .A2(_023_),
    .B1(_019_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__xor2_1 _399_ (.A(_054_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__nand2_1 _400_ (.A(net40),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__a32o_1 _401_ (.A1(net4),
    .A2(net44),
    .A3(_002_),
    .B1(net43),
    .B2(net40),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__and4_1 _402_ (.A(net4),
    .B(net44),
    .C(net43),
    .D(_002_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__and2_1 _403_ (.A(net40),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__a21bo_1 _404_ (.A1(net40),
    .A2(_058_),
    .B1_N(_057_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__o21ai_1 _405_ (.A1(_215_),
    .A2(_010_),
    .B1(_040_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__and4_1 _406_ (.A(net2),
    .B(net41),
    .C(_010_),
    .D(_040_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__xnor2_2 _407_ (.A(_060_),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__nand2_1 _408_ (.A(_044_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__xnor2_2 _409_ (.A(_044_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__xor2_2 _410_ (.A(_047_),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__and2_1 _411_ (.A(net11),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__a31o_1 _412_ (.A1(net47),
    .A2(net8),
    .A3(_256_),
    .B1(_067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__nand4_1 _413_ (.A(net80),
    .B(net8),
    .C(_256_),
    .D(_067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__nand2_1 _414_ (.A(_068_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__a21boi_4 _415_ (.A1(net46),
    .A2(_015_),
    .B1_N(_028_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__and3_1 _416_ (.A(net46),
    .B(net6),
    .C(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__xnor2_1 _417_ (.A(_070_),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__nand2_1 _418_ (.A(_032_),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__or2_1 _419_ (.A(_032_),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__nand2_1 _420_ (.A(_074_),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__xor2_1 _421_ (.A(_035_),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__inv_2 _422_ (.A(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__nand2_1 _423_ (.A(_066_),
    .B(_078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__xor2_1 _424_ (.A(_066_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__nand2_1 _425_ (.A(net13),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__nand2_1 _426_ (.A(_080_),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__or2_1 _427_ (.A(_080_),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__nand2_1 _428_ (.A(_082_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__o21ai_1 _429_ (.A1(_037_),
    .A2(_051_),
    .B1(_050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__nand2b_1 _430_ (.A_N(_084_),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__xor2_1 _431_ (.A(_084_),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__a21oi_4 _432_ (.A1(_055_),
    .A2(_054_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__xor2_2 _433_ (.A(_087_),
    .B(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__o21ai_1 _434_ (.A1(_047_),
    .A2(_065_),
    .B1(_064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__nand4_2 _435_ (.A(net4),
    .B(net40),
    .C(net43),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__nand4_2 _436_ (.A(net40),
    .B(net41),
    .C(_038_),
    .D(_090_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__a31o_1 _437_ (.A1(net40),
    .A2(net41),
    .A3(_090_),
    .B1(_038_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__and3_1 _438_ (.A(_061_),
    .B(_091_),
    .C(_092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__a21oi_1 _439_ (.A1(_091_),
    .A2(_092_),
    .B1(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__or2_2 _440_ (.A(_093_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__a21oi_2 _441_ (.A1(_057_),
    .A2(_062_),
    .B1(_059_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__nor2_1 _442_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__xnor2_2 _443_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__xnor2_2 _444_ (.A(_089_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__a21bo_1 _445_ (.A1(_035_),
    .A2(_075_),
    .B1_N(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__nand4_1 _446_ (.A(net11),
    .B(net46),
    .C(net8),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__or3b_1 _447_ (.A(_214_),
    .B(_026_),
    .C_N(_101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__a31o_1 _448_ (.A1(net46),
    .A2(net35),
    .A3(_101_),
    .B1(_025_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _449_ (.A(_102_),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__xor2_2 _450_ (.A(_071_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__a21boi_1 _451_ (.A1(_068_),
    .A2(_072_),
    .B1_N(_069_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _452_ (.A_N(_106_),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__xnor2_1 _453_ (.A(_105_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _454_ (.A(_100_),
    ...
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__inv_2 _455_ (.A(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__nand2_1 _456_ (.A(_099_),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__xor2_1 _457_ (.A(_099_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__and4_1 _458_ (.A(net13),
    .B(net44),
    .C(net6),
    .D(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__and3b_1 _459_ (.A_N(_113_),
    .B(net38),
    .C(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__nand2b_1 _460_ (.A_N(_112_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__xor2_1 _461_ (.A(_112_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__and3_1 _462_ (.A(_079_),
    .B(_083_),
    .C(_116_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _463_ (.A1(_079_),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__and2b_1 _464_ (.A_N(_117_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__o21a_1 _465_ (.A1(_087_),
    .A2(_088_),
    .B1(_086_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__xnor2_1 _466_ (.A(_119_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net32));
 sky130_fd_sc_hd__and3_1 _467_ (.A(net14),
    .B(net6),
    .C(_081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__and2_1 _468_ (.A(net38),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__xnor2_1 _469_ (.A(_121_),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nand2_1 _470_ (.A(net13),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__or2_1 _471_ (.A(_123_),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nand2_1 _472_ (.A(_123_),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__and2_1 _473_ (.A(_125_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__a41o_1 _474_ (.A1(net4),
    .A2(net41),
    .A3(_056_),
    .A4(_091_),
    .B1(_093_),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__nor2_1 _475_ (.A(_047_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__nor2_1 _476_ (.A(_064_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__o31ai_2 _477_ (.A1(_097_),
    .A2(_129_),
    .A3(_130_),
    .B1(_128_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__or4_1 _478_ (.A(_097_),
    .B(_128_),
    .C(_129_),
    .D(_130_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__and3_1 _479_ (.A(_032_),
    .B(_073_),
    .C(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__and3_1 _480_ (.A(_257_),
    .B(_034_),
    .C(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__or4b_1 _481_ (.A(_214_),
    .B(_025_),
    .C(_067_),
    .D_N(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__o21ai_1 _482_ (.A1(_071_),
    .A2(_104_),
    .B1(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__o31ai_1 _483_ (.A1(_107_),
    .A2(_133_),
    .A3(_134_),
    .B1(_136_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__or4_4 _484_ (.A(_107_),
    .B(_133_),
    .C(_134_),
    .D(_136_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__and4_1 _485_ (.A(_131_),
    .B(_138_),
    .C(_137_),
    .D(_132_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__inv_2 _486_ (.A(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__a22o_1 _487_ (.A1(_131_),
    .A2(_132_),
    .B1(_137_),
    .B2(_138_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__and3_4 _488_ (.A(_127_),
    .B(_140_),
    .C(_141_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__a21oi_1 _489_ (.A1(_140_),
    .A2(_141_),
    .B1(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__o211a_1 _490_ (.A1(_142_),
    .A2(_143_),
    .B1(_111_),
    .C1(_115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__a211o_1 _491_ (.A1(_111_),
    .A2(_115_),
    .B1(_142_),
    .C1(_143_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__nand2b_1 _492_ (.A_N(_144_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__or3b_4 _493_ (.A(_088_),
    .B(_087_),
    .C_N(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__o21a_1 _494_ (.A1(_086_),
    .A2(_117_),
    .B1(_118_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _496_ (.A1(_147_),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__and2b_1 _497_ (.A_N(_149_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__and4_1 _498_ (.A(net13),
    .B(net14),
    .C(net8),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__and3b_1 _499_ (.A_N(_151_),
    .B(net35),
    .C(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__and3_1 _500_ (.A(net6),
    .B(net41),
    .C(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__and3b_1 _501_ (.A_N(_153_),
    .B(net42),
    .C(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__and2_1 _502_ (.A(_113_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__a211oi_1 _503_ (.A1(_121_),
    .A2(_122_),
    .B1(_154_),
    .C1(_113_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__nor2_1 _504_ (.A(_155_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__and2_1 _505_ (.A(_152_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__xnor2_1 _506_ (.A(_152_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__nor2_1 _507_ (.A(_125_),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__or2_1 _508_ (.A(_125_),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__nand2_1 _509_ (.A(_125_),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__nand2_1 _510_ (.A(_161_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__and3_1 _511_ (.A(_090_),
    .B(_091_),
    .C(_131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__and3_1 _512_ (.A(_101_),
    .B(_102_),
    .C(_137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__nor2_1 _513_ (.A(_164_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__xnor2_1 _514_ (.A(_164_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__nor2_1 _515_ (.A(_163_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__xor2_1 _516_ (.A(_163_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__o21ai_2 _517_ (.A1(net78),
    .A2(_142_),
    .B1(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__nor3_2 _518_ (.A(net78),
    .B(_142_),
    .C(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__inv_2 _519_ (.A(_171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__a22oi_1 _520_ (.A1(_145_),
    .A2(_150_),
    .B1(_170_),
    .B2(_172_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__and4_1 _521_ (.A(_145_),
    .B(_150_),
    .C(_170_),
    .D(_172_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__or2_4 _522_ (.A(_173_),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__nand2_1 _523_ (.A(net43),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__and3_1 _524_ (.A(net14),
    .B(net8),
    .C(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__a21oi_1 _525_ (.A1(net43),
    .A2(net36),
    .B1(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__and3_1 _526_ (.A(net15),
    .B(net36),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__nor2_1 _527_ (.A(_177_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__and4bb_1 _528_ (.A_N(_122_),
    .B_N(_155_),
    .C(net6),
    .D(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__xnor2_1 _529_ (.A(_179_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__inv_2 _530_ (.A(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__nand2_1 _531_ (.A(_158_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__xnor2_1 _532_ (.A(_158_),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _535_ (.A(_166_),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__nand2b_1 _536_ (.A_N(_186_),
    .B(_187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__o21a_1 _537_ (.A1(_144_),
    .A2(_171_),
    .B1(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a41oi_4 _538_ (.A1(_147_),
    .A2(_145_),
    .A3(_148_),
    .A4(_170_),
    .B1(_189_),
    ...
    .VPWR(VPWR),
    .Y(_190_));
 sky130_fd_sc_hd__xnor2_1 _539_ (.A(_188_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net20));
 sky130_fd_sc_hd__and4_1 _540_ (.A(net15),
    .B(net42),
    .C(net8),
    .D(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__nor2_1 _541_ (.A(_215_),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__nand2_1 _542_ (.A(_151_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__a21o_1 _543_ (.A1(net36),
    .A2(_192_),
    .B1(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__o211a_1 _544_ (.A1(_153_),
    .A2(_155_),
    .B1(_193_),
    .C1(_194_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__a211oi_1 _545_ (.A1(_193_),
    .A2(_194_),
    .B1(_153_),
    .C1(_155_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__or2_1 _546_ (.A(_195_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__a21oi_1 _547_ (.A1(_179_),
    .A2(_180_),
    .B1(_178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__xnor2_1 _548_ (.A(_197_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__a21bo_1 _549_ (.A1(_160_),
    .A2(_184_),
    .B1_N(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__xnor2_1 _550_ (.A(_199_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__a211oi_1 _551_ (.A1(_187_),
    .A2(_190_),
    .B1(_201_),
    .C1(_186_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__o211a_1 _552_ (.A1(_186_),
    .A2(_190_),
    .B1(_201_),
    .C1(_187_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__nor2_2 _553_ (.A(_202_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net21));
 sky130_fd_sc_hd__or2_1 _554_ (.A(_183_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__a21o_1 _555_ (.A1(_161_),
    .A2(_198_),
    .B1(_197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__a31o_1 _556_ (.A1(net42),
    .A2(net8),
    .A3(_175_),
    .B1(_195_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__nand2_1 _557_ (.A(_193_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__a21oi_1 _558_ (.A1(_204_),
    .A2(_205_),
    .B1(_207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__and3_1 _559_ (.A(_204_),
    .B(_205_),
    .C(_207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__nor2_1 _560_ (.A(_208_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__o2111a_1 _561_ (.A1(_190_),
    .A2(_186_),
    .B1(_201_),
    .C1(_210_),
    .D1(_187_),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__xor2_2 _562_ (.A(_203_),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__a2111o_1 _563_ (.A1(net42),
    .A2(_151_),
    .B1(_211_),
    .C1(_208_),
    .D1(_191_),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__or3b_1 _564_ (.A(_249_),
    .B(_251_),
    .C_N(_022_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__and2b_1 _565_ (.A_N(_023_),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input16 (.A(B[7]),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_2 output17 (.A(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 output32 (.A(net32),
    ...
    .VPWR(VPWR),
    .X(P[9]));
 sky130_fd_sc_hd__clkbuf_1 max_cap33 (.A(_238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout35 (.A(net7),
    ...
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__buf_1 fanout36 (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkbuf_2 fanout37 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 fanout39 (.A(net3),
    ...
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkbuf_2 fanout40 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout42 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__clkbuf_4 fanout43 (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 fanout45 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__clkbuf_2 fanout46 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 fanout47 (.A(net48),
    ...
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__buf_6 fanout48 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout50 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer1 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer2 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer3 (.A(net52),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(net55),
    ...
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer7 (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer8 (.A(net57),
    ...
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer12 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(net67),
    ...
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer14 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer15 (.A(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer16 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer17 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer18 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__buf_2 rebuffer19 (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__buf_8 rebuffer20 (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__clkbuf_2 rebuffer21 (.A(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer23 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__buf_6 rebuffer24 (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer25 (.A(net74),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer26 (.A(net74),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer27 (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer28 (.A(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__buf_1 rebuffer29 (.A(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer30 (.A(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer31 (.A(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer32 (.A(_265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer33 (.A(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer34 (.A(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer35 (.A(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer36 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer37 (.A(net86),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__clkbuf_2 rebuffer38 (.A(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
