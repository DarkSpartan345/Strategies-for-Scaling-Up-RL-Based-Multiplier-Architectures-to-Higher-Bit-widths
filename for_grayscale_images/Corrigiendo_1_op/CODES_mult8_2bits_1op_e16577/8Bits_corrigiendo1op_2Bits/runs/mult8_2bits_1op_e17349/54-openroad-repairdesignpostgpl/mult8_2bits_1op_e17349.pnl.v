module mult8_2bits_1op_e17349 (VPWR,
 ...
 sky130_fd_sc_hd__inv_2 _279_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__inv_2 _280_ (.A(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _281_ (.A(net39),
    ...
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__inv_2 _282_ (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _284_ (.A(net8),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__and2_1 _285_ (.A(net9),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _290_ (.A1(net1),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__or4bb_1 _291_ (.A(net17),
    .B(_223_),
    .C_N(_226_),
    .D_N(net11),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _297_ (.A_N(_231_),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__nand4_1 _298_ (.A(net37),
    .B(net1),
    .C(net11),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__a22o_1 _299_ (.A1(net37),
    .A2(net11),
    .B1(net40),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__and3_1 _300_ (.A(_224_),
    .B(_233_),
    .C(_234_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _301_ (.A1(_233_),
    ...
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__a21oi_1 _302_ (.A1(_227_),
    .A2(_236_),
    .B1(_235_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _303_ (.A(_232_),
    ...
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__xnor2_1 _304_ (.A(_232_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _309_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_243_));
 sky130_fd_sc_hd__and3_1 _310_ (.A(net37),
    .B(net40),
    .C(_233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__xor2_1 _311_ (.A(_235_),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _312_ (.A(net36),
    ...
    .VPWR(VPWR),
    .X(_246_));
 sky130_fd_sc_hd__and4_1 _313_ (.A(net41),
    .B(net4),
    .C(_225_),
    .D(_246_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__a31o_1 _314_ (.A1(net41),
    .A2(net4),
    .A3(_225_),
    .B1(_246_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _315_ (.A_N(_247_),
    ...
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__xnor2_1 _316_ (.A(_245_),
    .B(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _326_ (.A(_257_),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__nand2_1 _327_ (.A(net9),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _330_ (.A(_261_),
    ...
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__a21boi_1 _331_ (.A1(_235_),
    .A2(_244_),
    .B1_N(_233_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _335_ (.A1(net3),
    ...
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__nand2b_1 _336_ (.A_N(_267_),
    .B(_268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__xnor2_1 _337_ (.A(_264_),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_270_));
 sky130_fd_sc_hd__a21oi_1 _338_ (.A1(_245_),
    .A2(_248_),
    .B1(_247_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _339_ (.A(_270_),
    ...
    .VPWR(VPWR),
    .X(_272_));
 sky130_fd_sc_hd__xnor2_1 _340_ (.A(_270_),
    .B(_271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_273_));
 sky130_fd_sc_hd__or3_1 _341_ (.A(_230_),
    .B(_239_),
    .C(_270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__o211a_1 _342_ (.A1(_251_),
    .A2(_273_),
    .B1(_274_),
    .C1(_272_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o32a_1 _343_ (.A1(_246_),
    ...
    .VPWR(VPWR),
    .X(_276_));
 sky130_fd_sc_hd__xnor2_1 _344_ (.A(_275_),
    .B(_276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__nand2_1 _345_ (.A(net37),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__and3_1 _346_ (.A(net37),
    .B(net39),
    .C(_243_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _353_ (.A(_000_),
    ...
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__xor2_1 _354_ (.A(_000_),
    .B(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__xnor2_1 _355_ (.A(_263_),
    .B(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _356_ (.A1(_216_),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__a21bo_1 _357_ (.A1(_240_),
    .A2(_252_),
    .B1_N(_251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__xnor2_1 _358_ (.A(_273_),
    .B(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__nand4_1 _359_ (.A(net9),
    .B(net41),
    .C(net6),
    .D(net34),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _360_ (.A(net10),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__xor2_1 _361_ (.A(_012_),
    .B(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _369_ (.A1(_263_),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__or3_1 _370_ (.A(_215_),
    .B(_222_),
    .C(_260_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _372_ (.A(net11),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__or3_1 _373_ (.A(_218_),
    .B(_015_),
    .C(_027_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _382_ (.A_N(_036_),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__nand2_1 _383_ (.A(net37),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _388_ (.A(_037_),
    ...
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__or2_2 _389_ (.A(_006_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _392_ (.A1(_275_),
    ...
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__or2_1 _393_ (.A(_267_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _394_ (.A(_044_),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__xor2_1 _395_ (.A(_046_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _399_ (.A(_024_),
    ...
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__a21o_1 _400_ (.A1(_020_),
    .A2(_023_),
    .B1(_019_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o32a_2 _406_ (.A1(_221_),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__and3_1 _407_ (.A(net2),
    .B(net16),
    .C(_060_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _411_ (.A(_063_),
    ...
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__xor2_1 _412_ (.A(_044_),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _420_ (.A(_071_),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__or2_1 _421_ (.A(_031_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _424_ (.A(_066_),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__and2_1 _425_ (.A(_066_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _432_ (.A(_084_),
    ...
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__a21oi_2 _433_ (.A1(_054_),
    .A2(_055_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__xor2_1 _434_ (.A(_086_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _440_ (.A(_060_),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__xor2_2 _441_ (.A(_060_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _443_ (.A(_094_),
    ...
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__xnor2_1 _444_ (.A(_094_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _446_ (.A1(_033_),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__or3b_1 _447_ (.A(_218_),
    .B(_222_),
    .C_N(_067_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__or3b_1 _448_ (.A(_218_),
    .B(_025_),
    .C_N(_100_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _450_ (.A1(_025_),
    ...
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__xor2_1 _451_ (.A(_072_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _453_ (.A(_104_),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__xnor2_1 _454_ (.A(_104_),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _459_ (.A(_109_),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__nor3_1 _460_ (.A(_079_),
    .B(_082_),
    .C(_112_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _462_ (.A_N(_113_),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__o21a_1 _463_ (.A1(_086_),
    .A2(_087_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__xnor2_1 _464_ (.A(_115_),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _465_ (.A(net14),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nand2_1 _466_ (.A(net34),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _479_ (.A_N(_067_),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__a2bb2o_1 _480_ (.A1_N(_072_),
    .A2_N(_103_),
    .B1(_131_),
    .B2(_025_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _482_ (.A(_033_),
    ...
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__or2_1 _483_ (.A(_075_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _496_ (.A(_084_),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__o311a_2 _497_ (.A1(_086_),
    .A2(_087_),
    .A3(_113_),
    .B1(_114_),
    .C1(_148_),
 ...
 sky130_fd_sc_hd__nor2_1 _517_ (.A(_166_),
    ...
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__xnor2_1 _518_ (.A(_165_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _519_ (.A(_164_),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__xor2_1 _520_ (.A(_164_),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__nor3_1 _521_ (.A(_139_),
    .B(_141_),
    .C(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__o21ai_1 _522_ (.A1(_139_),
    .A2(_141_),
    .B1(_171_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _523_ (.A_N(_172_),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__o21a_1 _524_ (.A1(_146_),
    .A2(_149_),
    .B1(_144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__xnor2_1 _525_ (.A(_174_),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _539_ (.A1(_168_),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__or3_1 _540_ (.A(_168_),
    .B(_170_),
    .C(_188_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _541_ (.A_N(_189_),
    ...
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__a21o_1 _542_ (.A1(_144_),
    .A2(_173_),
    .B1(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__o21a_1 _543_ (.A1(_146_),
    .A2(_172_),
    .B1(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__a21oi_2 _544_ (.A1(_149_),
    .A2(_192_),
    .B1(_193_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _567_ (.A(_195_),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__or3_1 _568_ (.A(_211_),
    .B(_213_),
    .C(_214_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 fanout33 (.A(net7),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkbuf_4 fanout34 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_2 fanout35 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout39 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__buf_2 fanout40 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
