module mult4_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__and2_1 _51_ (.A(net1),
    ...
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__nand2_1 _52_ (.A(net1),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__and4_1 _53_ (.A(net6),
    .B(net2),
    .C(_00_),
    .D(_03_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_05_));
 sky130_fd_sc_hd__a31o_1 _54_ (.A1(net6),
    .A2(net2),
    .A3(_00_),
    .B1(_03_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__and2b_1 _55_ (.A_N(_05_),
    .B(_06_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__xnor2_1 _56_ (.A(_02_),
    .B(_07_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _58_ (.A(net2),
    ...
    .VPWR(VPWR),
    .Y(_09_));
 sky130_fd_sc_hd__and2_1 _59_ (.A(net6),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_10_));
 sky130_fd_sc_hd__and4b_1 _60_ (.A_N(_09_),
    .B(_10_),
    .C(_02_),
    .D(_04_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_11_));
 sky130_fd_sc_hd__o2bb2a_1 _61_ (.A1_N(_02_),
    .A2_N(_10_),
    .B1(_03_),
    .B2(_09_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__a2bb2o_1 _62_ (.A1_N(_03_),
    .A2_N(_09_),
    .B1(_10_),
    .B2(_02_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__or3_1 _63_ (.A(_08_),
    .B(_11_),
    .C(_12_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__o21ai_1 _64_ (.A1(_11_),
    .A2(_12_),
    .B1(_08_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand4_1 _66_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_17_));
 sky130_fd_sc_hd__nand4_1 _67_ (.A(net1),
    .B(net8),
    .C(_01_),
    .D(_17_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_18_));
 sky130_fd_sc_hd__and4_1 _68_ (.A(net6),
    .B(net5),
    .C(net4),
    .D(net3),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_19_));
 sky130_fd_sc_hd__and3b_1 _69_ (.A_N(_19_),
    .B(net3),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__a31o_1 _70_ (.A1(net1),
    .A2(net8),
    .A3(_17_),
    .B1(_01_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_21_));
 sky130_fd_sc_hd__nand3_1 _71_ (.A(_18_),
    .B(_20_),
    .C(_21_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_22_));
 sky130_fd_sc_hd__a21bo_1 _72_ (.A1(_20_),
    .A2(_21_),
    .B1_N(_18_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_23_));
 sky130_fd_sc_hd__and3_1 _73_ (.A(_14_),
    .B(_15_),
    .C(_23_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_24_));
 sky130_fd_sc_hd__a21o_1 _74_ (.A1(_14_),
    .A2(_15_),
    .B1(_23_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_25_));
 sky130_fd_sc_hd__and2b_1 _75_ (.A_N(_24_),
    .B(_25_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_26_));
 sky130_fd_sc_hd__a21o_1 _76_ (.A1(_18_),
    .A2(_21_),
    .B1(_20_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_27_));
 sky130_fd_sc_hd__a31o_1 _77_ (.A1(net5),
    .A2(net3),
    .A3(_06_),
    .B1(_05_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_28_));
 sky130_fd_sc_hd__and3_1 _78_ (.A(_22_),
    .B(_27_),
    .C(_28_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_29_));
 sky130_fd_sc_hd__xor2_1 _79_ (.A(_26_),
    .B(_29_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__a21oi_1 _80_ (.A1(_25_),
    .A2(_29_),
    .B1(_24_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_30_));
 sky130_fd_sc_hd__and4_1 _81_ (.A(net8),
    .B(net7),
    .C(net4),
    .D(net3),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_31_));
 sky130_fd_sc_hd__and3b_1 _82_ (.A_N(_31_),
    .B(net3),
    .C(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_32_));
 sky130_fd_sc_hd__xnor2_1 _83_ (.A(_16_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_33_));
 sky130_fd_sc_hd__and4bb_1 _84_ (.A_N(_31_),
    .B_N(_33_),
    .C(net8),
    .D(net3),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _86_ (.A(_35_),
    ...
    .VPWR(VPWR),
    .Y(_36_));
 sky130_fd_sc_hd__a31oi_2 _87_ (.A1(net7),
    .A2(net3),
    .A3(_13_),
    .B1(_11_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _88_ (.A(_35_),
    ...
    .VPWR(VPWR),
    .Y(_38_));
 sky130_fd_sc_hd__xor2_1 _89_ (.A(_35_),
    .B(_37_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_39_));
 sky130_fd_sc_hd__xnor2_1 _90_ (.A(_30_),
    .B(_39_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _91_ (.A(net8),
    ...
    .VPWR(VPWR),
    .X(_40_));
 sky130_fd_sc_hd__a21o_1 _92_ (.A1(_16_),
    .A2(_19_),
    .B1(_34_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_41_));
 sky130_fd_sc_hd__and2_1 _93_ (.A(_40_),
    .B(_41_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_42_));
 sky130_fd_sc_hd__xor2_1 _94_ (.A(_40_),
    .B(_41_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_43_));
 sky130_fd_sc_hd__a221o_1 _95_ (.A1(_29_),
    .A2(_36_),
    .B1(_39_),
    .B2(_24_),
    .C1(_38_),
    ...
    .VPWR(VPWR),
    .X(_44_));
 sky130_fd_sc_hd__xor2_1 _96_ (.A(_43_),
    .B(_44_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__a211o_1 _97_ (.A1(_43_),
    .A2(_44_),
    .B1(_31_),
    .C1(_42_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__a21oi_1 _98_ (.A1(_22_),
    .A2(_27_),
    .B1(_28_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_45_));
 sky130_fd_sc_hd__nor2_1 _99_ (.A(_29_),
    .B(_45_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__decap_8 FILLER_2_3 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_2_16 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_9_7 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_8 FILLER_9_19 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
