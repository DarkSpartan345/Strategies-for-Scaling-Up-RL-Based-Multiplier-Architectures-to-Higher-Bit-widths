module SarsaNStepsRuido_e9 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__a21oi_1 _04_ (.A1(net3),
    .A2(net2),
    .B1(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_02_));
 sky130_fd_sc_hd__nand2b_1 _05_ (.A_N(net3),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_03_));
 sky130_fd_sc_hd__a31oi_1 _06_ (.A1(net2),
    .A2(net1),
    .A3(_03_),
    .B1(_02_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__nand3_1 _07_ (.A(net3),
    .B(net2),
    .C(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__and4_1 _08_ (.A(net3),
    .B(net2),
    .C(net1),
    .D(net4),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_2 output7 (.A(net7),
    ...
    .VPWR(VPWR),
    .X(P[3]));
 sky130_fd_sc_hd__conb_1 SarsaNStepsRuido_e9_8 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net8));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_5_6 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_5_18 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_5_24 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_5_28 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_9_26 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_9_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
