module mult8_2bits_1op_e16770 (VPWR,
 ...
 sky130_fd_sc_hd__inv_2 _274_ (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _279_ (.A(net8),
    ...
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__nand2_1 _280_ (.A(net33),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_2 _281_ (.A(net33),
    ...
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__and3_1 _282_ (.A(net43),
    .B(net46),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _283_ (.A(net45),
    ...
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__a32oi_2 _284_ (.A1(net43),
    .A2(net38),
    .A3(_217_),
    .B1(net42),
    .B2(net46),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__and4_1 _285_ (.A(net43),
    .B(net38),
    .C(net42),
    .D(_217_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _286_ (.A1(net46),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__nand2_1 _287_ (.A(net33),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__a211o_1 _288_ (.A1(net46),
    .A2(_221_),
    .B1(_223_),
    .C1(_220_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _292_ (.A_N(_226_),
    ...
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__and4_1 _293_ (.A(net38),
    .B(net45),
    .C(net42),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2111ai_1 _294_ (.A1(net33),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__and4bb_1 _295_ (.A_N(_228_),
    .B_N(_218_),
    .C(net41),
    .D(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__or4_1 _296_ (.A(_211_),
    .B(_213_),
    .C(_218_),
    .D(_228_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31ai_1 _297_ (.A1(_211_),
    ...
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__and3_1 _298_ (.A(_227_),
    .B(_231_),
    .C(_232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__a21oi_1 _299_ (.A1(_231_),
    .A2(_232_),
    .B1(_227_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _302_ (.A(_235_),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__nand2_1 _303_ (.A(net33),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__nand2_1 _304_ (.A(net45),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _314_ (.A(_245_),
    ...
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__xnor2_1 _315_ (.A(_235_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _316_ (.A_N(_238_),
    ...
    .VPWR(VPWR),
    .Y(_250_));
 sky130_fd_sc_hd__xnor2_1 _317_ (.A(_238_),
    .B(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _319_ (.A(_237_),
    ...
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__and3_1 _320_ (.A(net43),
    .B(net6),
    .C(_237_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__nand2_1 _321_ (.A(net42),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _322_ (.A(_253_),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nand2_1 _323_ (.A(net33),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _329_ (.A1(net36),
    ...
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__o211a_1 _330_ (.A1(_228_),
    .A2(_230_),
    .B1(_261_),
    .C1(_262_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _336_ (.A1(_263_),
    ...
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__o221a_1 _337_ (.A1(_235_),
    .A2(_265_),
    .B1(_268_),
    .B2(_246_),
    .C1(_267_),
 ...
 sky130_fd_sc_hd__a41o_1 _338_ (.A1(net4),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__nand2b_1 _339_ (.A_N(_270_),
    .B(_271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__xor2_1 _340_ (.A(_270_),
    .B(_271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_273_));
 sky130_fd_sc_hd__and3_1 _341_ (.A(net38),
    .B(net40),
    .C(_238_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__nand2_1 _342_ (.A(net45),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _348_ (.A(_273_),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__xor2_1 _349_ (.A(_273_),
    .B(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _350_ (.A(_259_),
    ...
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__nand4_1 _351_ (.A(net38),
    .B(net45),
    .C(net13),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__and3_1 _352_ (.A(net45),
    .B(net40),
    .C(_010_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _353_ (.A(_267_),
    ...
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__o21a_1 _354_ (.A1(_235_),
    .A2(_247_),
    .B1(_246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__xor2_1 _355_ (.A(_012_),
    .B(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__nand4_1 _356_ (.A(net33),
    .B(net43),
    .C(net6),
    .D(net35),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _357_ (.A(net44),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__xor2_1 _358_ (.A(_011_),
    .B(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _362_ (.A_N(_019_),
    ...
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__xnor2_1 _363_ (.A(_016_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _368_ (.A(net44),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__nand2_1 _369_ (.A(net41),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _379_ (.A_N(_036_),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__nand4_1 _380_ (.A(net38),
    .B(net45),
    .C(net15),
    .D(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__and3_1 _381_ (.A(net46),
    .B(net39),
    .C(_038_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _388_ (.A(_044_),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__and3_1 _389_ (.A(_260_),
    .B(_261_),
    .C(_272_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _390_ (.A(_046_),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__xnor2_1 _391_ (.A(_046_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__or2_1 _392_ (.A(_035_),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__xnor2_1 _393_ (.A(_035_),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _394_ (.A_N(_051_),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__xnor2_1 _395_ (.A(_024_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__a21o_1 _396_ (.A1(_020_),
    .A2(_023_),
    .B1(_019_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _407_ (.A(_044_),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__nand2_1 _408_ (.A(net42),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _411_ (.A(_065_),
    ...
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__o22a_1 _412_ (.A1(_213_),
    .A2(_015_),
    .B1(_027_),
    .B2(_254_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _424_ (.A(_079_),
    ...
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__a21o_1 _425_ (.A1(_048_),
    .A2(_050_),
    .B1(_081_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _426_ (.A(_048_),
    ...
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__and2_1 _427_ (.A(_082_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__a21oi_1 _428_ (.A1(_053_),
    .A2(_054_),
    .B1(_052_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand4_1 _443_ (.A(net11),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__or3b_1 _444_ (.A(_213_),
    .B(_025_),
    .C_N(_099_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _445_ (.A(net12),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__a21bo_1 _446_ (.A1(_025_),
    .A2(_101_),
    .B1_N(_100_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _447_ (.A(_069_),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__xor2_1 _448_ (.A(_069_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__a21oi_1 _449_ (.A1(_068_),
    .A2(_070_),
    .B1(_067_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or4_1 _481_ (.A(_106_),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__and4_1 _482_ (.A(_130_),
    .B(_131_),
    .C(_135_),
    .D(_136_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _484_ (.A1(_130_),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__and3_1 _485_ (.A(_126_),
    .B(_138_),
    .C(_139_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _493_ (.A(_146_),
    ...
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__xnor2_1 _494_ (.A(_145_),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _518_ (.A(_169_),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__a21bo_1 _519_ (.A1(_143_),
    .A2(_148_),
    .B1_N(_144_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a221oi_4 _535_ (.A1(_142_),
    ...
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__xnor2_1 _536_ (.A(_186_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_1 _548_ (.A1(_185_),
    ...
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__o211a_1 _549_ (.A1(_184_),
    .A2(_188_),
    .B1(_199_),
    .C1(_185_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _556_ (.A_N(_205_),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__o2111a_1 _557_ (.A1(_184_),
    .A2(_188_),
    .B1(_199_),
    .C1(_207_),
    .D1(_185_),
 ...
 sky130_fd_sc_hd__nand2_1 _559_ (.A(_189_),
    ...
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__or3_1 _560_ (.A(_205_),
    .B(_208_),
    .C(_209_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _562_ (.A(_023_),
    ...
    .VPWR(VPWR),
    .Y(net28));
 sky130_fd_sc_hd__clkbuf_1 _563_ (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout41 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkbuf_4 fanout42 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout43 (.A(net10),
    ...
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__buf_1 fanout44 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
