module mult8_2bits_1op_e17161 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__inv_2 _285_ (.A(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__inv_2 _286_ (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__inv_2 _287_ (.A(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__inv_2 _288_ (.A(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_226_));
 sky130_fd_sc_hd__inv_2 _289_ (.A(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__inv_2 _290_ (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__and2_1 _291_ (.A(net44),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__nand2_1 _292_ (.A(net61),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__nand4_4 _293_ (.A(net39),
    .B(net44),
    .C(net33),
    .D(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__nand2_1 _294_ (.A(net86),
    .B(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net17));
 sky130_fd_sc_hd__and3_1 _295_ (.A(net44),
    .B(net60),
    .C(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__nand2_1 _296_ (.A(net60),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__and4_1 _297_ (.A(net60),
    .B(net43),
    .C(_229_),
    .D(_230_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__a21boi_1 _298_ (.A1(_229_),
    .A2(_230_),
    .B1_N(_232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__nand2_1 _299_ (.A(net33),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__o21a_1 _300_ (.A1(_233_),
    .A2(_234_),
    .B1(_235_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor3_2 _301_ (.A(_233_),
    ...
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__nor2_1 _302_ (.A(_236_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net25));
 sky130_fd_sc_hd__nand2_1 _303_ (.A(net44),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__and4_1 _304_ (.A(net62),
    .B(net56),
    .C(net4),
    .D(net37),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _305_ (.A_N(_239_),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__nand4_1 _306_ (.A(net39),
    .B(net46),
    .C(net43),
    .D(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__and2_1 _307_ (.A(net60),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__or4b_4 _308_ (.A(_231_),
    .B(_225_),
    .C(_221_),
    .D_N(_241_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__a21bo_1 _309_ (.A1(_241_),
    .A2(_242_),
    .B1_N(_231_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__a21o_1 _310_ (.A1(_244_),
    .A2(_243_),
    .B1(_233_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _316_ (.A(_249_),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__nand2_1 _317_ (.A(net62),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__nand2_2 _318_ (.A(net50),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2111a_1 _319_ (.A1(_221_),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__nand2_1 _320_ (.A(net37),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__nor3b_1 _321_ (.A(_238_),
    .B(_254_),
    .C_N(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_255_));
 sky130_fd_sc_hd__or3b_1 _322_ (.A(_238_),
    .B(_254_),
    .C_N(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__a32o_1 _323_ (.A1(net44),
    .A2(net4),
    .A3(_235_),
    .B1(net43),
    .B2(net37),
    ...
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__and3_1 _324_ (.A(_253_),
    .B(_256_),
    .C(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__a21o_1 _325_ (.A1(_256_),
    .A2(_257_),
    .B1(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__and2b_1 _326_ (.A_N(_258_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_260_));
 sky130_fd_sc_hd__and4b_1 _327_ (.A_N(_258_),
    .B(_240_),
    .C(_245_),
    .D(_259_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__xnor2_1 _328_ (.A(_246_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__xnor2_1 _329_ (.A(_249_),
    .B(_262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__and3_1 _330_ (.A(net51),
    .B(net13),
    .C(_263_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__xnor2_1 _331_ (.A(_252_),
    .B(_263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__and3_1 _332_ (.A(net65),
    .B(net35),
    .C(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__a21oi_1 _333_ (.A1(net65),
    .A2(net36),
    .B1(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__nor2_1 _334_ (.A(_266_),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__nand2_1 _335_ (.A(net56),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _336_ (.A(net43),
    ...
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__a32o_1 _337_ (.A1(net57),
    .A2(net6),
    .A3(_251_),
    .B1(net35),
    .B2(net43),
    ...
    .VPWR(VPWR),
    .X(_270_));
 sky130_fd_sc_hd__or3b_1 _338_ (.A(_268_),
    .B(_269_),
    .C_N(_251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__nand2_1 _339_ (.A(net63),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__and3b_1 _340_ (.A_N(_272_),
    .B(_271_),
    .C(_270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_273_));
 sky130_fd_sc_hd__a21boi_1 _341_ (.A1(_270_),
    .A2(_271_),
    .B1_N(_272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_274_));
 sky130_fd_sc_hd__nor2_1 _342_ (.A(net48),
    .B(_274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__nand2_1 _343_ (.A(_241_),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_276_));
 sky130_fd_sc_hd__nand4_4 _344_ (.A(net4),
    .B(net37),
    .C(net43),
    .D(net82),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_277_));
 sky130_fd_sc_hd__nand4_4 _345_ (.A(net72),
    .B(net83),
    .C(_239_),
    .D(_277_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__a31o_1 _346_ (.A1(net37),
    .A2(net82),
    .A3(_277_),
    .B1(_239_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _348_ (.A(_276_),
    ...
    .VPWR(VPWR),
    .Y(_281_));
 sky130_fd_sc_hd__and3_1 _349_ (.A(_237_),
    .B(_248_),
    .C(_281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_282_));
 sky130_fd_sc_hd__nor2_1 _350_ (.A(_255_),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_283_));
 sky130_fd_sc_hd__and2b_1 _351_ (.A_N(_283_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_284_));
 sky130_fd_sc_hd__o31a_1 _352_ (.A1(_255_),
    .A2(_281_),
    .A3(_258_),
    .B1(_261_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _353_ (.A(net4),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__a31o_1 _354_ (.A1(_276_),
    .A2(_278_),
    .A3(_279_),
    .B1(_001_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__o31ai_4 _355_ (.A1(net54),
    .A2(net77),
    .A3(net85),
    .B1(_002_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__or4_4 _356_ (.A(_284_),
    .B(_282_),
    .C(_000_),
    .D(_002_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__nand2_1 _357_ (.A(net68),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__a32o_1 _358_ (.A1(net53),
    .A2(net41),
    .A3(_252_),
    .B1(net15),
    .B2(net47),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__or4b_4 _359_ (.A(_221_),
    .B(_005_),
    .C(net13),
    .D_N(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__nand2_2 _360_ (.A(net73),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _361_ (.A(_008_),
    ...
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__and3_1 _362_ (.A(_007_),
    .B(_006_),
    .C(_009_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a21oi_1 _363_ (.A1(_006_),
    .A2(_007_),
    .B1(_009_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__nor2_1 _364_ (.A(net55),
    .B(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__and3_1 _365_ (.A(_003_),
    .B(_012_),
    .C(_004_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a21oi_1 _366_ (.A1(_003_),
    .A2(_004_),
    .B1(_012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__or3b_4 _367_ (.A(_014_),
    .B(_013_),
    .C_N(_275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__o21bai_1 _368_ (.A1(_013_),
    .A2(_014_),
    .B1_N(_275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__nand4_1 _369_ (.A(net52),
    .B(net47),
    .C(net13),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _370_ (.A(net47),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__xor2_1 _371_ (.A(_281_),
    .B(_283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__a41o_1 _372_ (.A1(_237_),
    .A2(_246_),
    .A3(_247_),
    .A4(_260_),
    .B1(_261_),
 ...
 sky130_fd_sc_hd__xnor2_2 _373_ (.A(_019_),
    ...
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__nand4_1 _374_ (.A(net62),
    .B(net56),
    .C(net6),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__and3_1 _375_ (.A(net45),
    .B(net35),
    .C(_022_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__xor2_1 _376_ (.A(_021_),
    .B(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__a22o_1 _377_ (.A1(_018_),
    .A2(_021_),
    .B1(_023_),
    .B2(_024_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__and3_1 _378_ (.A(_015_),
    .B(_016_),
    .C(_025_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__a21o_1 _379_ (.A1(_016_),
    .A2(_015_),
    .B1(_025_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__and2b_1 _380_ (.A_N(_026_),
    .B(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__xnor2_1 _381_ (.A(_023_),
    .B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__o21ba_1 _382_ (.A1(_264_),
    .A2(_266_),
    .B1_N(_029_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _383_ (.A(_028_),
    ...
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__nand2b_1 _384_ (.A_N(_013_),
    .B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__and4_1 _385_ (.A(net64),
    .B(net45),
    .C(net8),
    .D(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__nand4_1 _386_ (.A(net87),
    .B(net45),
    .C(net8),
    .D(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__and3_1 _387_ (.A(net45),
    .B(net34),
    .C(_033_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nand4_1 _388_ (.A(net43),
    .B(net80),
    .C(net6),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__o2111a_1 _389_ (.A1(net87),
    .A2(net43),
    .B1(net6),
    .C1(net35),
    .D1(net45),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nand4_1 _390_ (.A(net81),
    .B(net35),
    .C(_035_),
    .D(_036_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__a31o_1 _391_ (.A1(net12),
    .A2(net35),
    .A3(_035_),
    .B1(_036_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__and3_1 _392_ (.A(_034_),
    .B(_037_),
    .C(_038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__a21o_1 _393_ (.A1(_037_),
    .A2(_038_),
    .B1(_034_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__and2b_1 _394_ (.A_N(_039_),
    .B(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_2 _395_ (.A_N(_039_),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__xnor2_2 _396_ (.A(net49),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__and4_1 _397_ (.A(net4),
    .B(net74),
    .C(net13),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__and3b_1 _398_ (.A_N(_044_),
    .B(net41),
    .C(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__nand4_2 _399_ (.A(net52),
    .B(net47),
    .C(net15),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__o2111a_1 _400_ (.A1(net13),
    .A2(net15),
    .B1(net41),
    .C1(net52),
    .D1(net47),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__nand4_1 _401_ (.A(net47),
    .B(net40),
    .C(_046_),
    .D(_047_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__a31o_1 _402_ (.A1(net47),
    .A2(net40),
    .A3(_046_),
    .B1(_047_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__and3_1 _403_ (.A(_045_),
    .B(_048_),
    .C(_049_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__a21oi_1 _404_ (.A1(_048_),
    .A2(_049_),
    .B1(_045_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor3b_2 _405_ (.A(_050_),
    ...
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__o21ba_1 _406_ (.A1(_050_),
    .A2(_051_),
    .B1_N(_010_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__or2_1 _407_ (.A(_052_),
    .B(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__a31oi_1 _408_ (.A1(_277_),
    .A2(_278_),
    .A3(_003_),
    .B1(_054_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__a31o_1 _409_ (.A1(_003_),
    .A2(_278_),
    .A3(_277_),
    .B1(_054_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__and4_1 _410_ (.A(_277_),
    .B(_278_),
    .C(_003_),
    .D(_054_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__nor2_1 _411_ (.A(_055_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__or3b_1 _412_ (.A(_057_),
    .B(_043_),
    .C_N(_056_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__xnor2_1 _413_ (.A(_043_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__and2_1 _414_ (.A(_031_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__nor2_1 _415_ (.A(_031_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__or2_4 _416_ (.A(_061_),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__a21oi_4 _417_ (.A1(_030_),
    .A2(_027_),
    .B1(_026_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _418_ (.A(_063_),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__nand2_1 _419_ (.A(net38),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__a32o_1 _420_ (.A1(net4),
    .A2(net41),
    .A3(_008_),
    .B1(net15),
    .B2(net38),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__or4b_4 _421_ (.A(_224_),
    .B(_226_),
    .C(_065_),
    .D_N(_008_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__o21ai_1 _422_ (.A1(_227_),
    .A2(_017_),
    .B1(_046_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _423_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__nand3_1 _424_ (.A(_066_),
    .B(_067_),
    .C(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__a21o_1 _425_ (.A1(_066_),
    .A2(_067_),
    .B1(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__and3_1 _426_ (.A(_050_),
    .B(_070_),
    .C(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__a21o_1 _427_ (.A1(_070_),
    .A2(_071_),
    .B1(_050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__nand2b_1 _428_ (.A_N(_072_),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__xnor2_1 _429_ (.A(_052_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__and2_1 _430_ (.A(net11),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__a31o_1 _431_ (.A1(net45),
    .A2(net8),
    .A3(_272_),
    .B1(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__nand4_1 _432_ (.A(net45),
    .B(net8),
    .C(_272_),
    .D(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o21ai_1 _433_ (.A1(_225_),
    .A2(_022_),
    .B1(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__and4_1 _434_ (.A(net12),
    .B(net6),
    .C(_269_),
    .D(_022_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__nand3_1 _435_ (.A(_077_),
    .B(_078_),
    .C(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__a21o_1 _436_ (.A1(_077_),
    .A2(_078_),
    .B1(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__and3_1 _437_ (.A(_039_),
    .B(_081_),
    .C(_082_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__a21o_1 _438_ (.A1(_081_),
    .A2(_082_),
    .B1(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__and2b_1 _439_ (.A_N(_083_),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__xnor2_2 _440_ (.A(net76),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _441_ (.A(_086_),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__nand2_1 _442_ (.A(_075_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__xor2_1 _443_ (.A(_075_),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__nand2_1 _444_ (.A(net13),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__or2_1 _445_ (.A(_089_),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__xnor2_1 _446_ (.A(_089_),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__a21o_1 _447_ (.A1(_056_),
    .A2(_059_),
    .B1(_092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__nand3_1 _448_ (.A(_056_),
    .B(_059_),
    .C(_092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__nand2_1 _449_ (.A(_093_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__o21bai_4 _450_ (.A1(_064_),
    .A2(_062_),
    .B1_N(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__nand2b_1 _451_ (.A_N(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__xnor2_1 _452_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net31));
 sky130_fd_sc_hd__a21oi_1 _453_ (.A1(_052_),
    .A2(_073_),
    .B1(_072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__nand4_2 _454_ (.A(net4),
    .B(net38),
    .C(net15),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__nand4_2 _455_ (.A(net38),
    .B(net40),
    .C(_044_),
    .D(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__a31o_1 _456_ (.A1(net38),
    .A2(net40),
    .A3(_099_),
    .B1(_044_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__nand3_1 _457_ (.A(_068_),
    .B(_100_),
    .C(_101_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _458_ (.A(_102_),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__a21o_1 _459_ (.A1(_100_),
    .A2(_101_),
    .B1(_068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__a21bo_1 _460_ (.A1(_066_),
    .A2(_069_),
    .B1_N(_067_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__and3_1 _461_ (.A(_102_),
    .B(_105_),
    .C(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__a21o_1 _462_ (.A1(_102_),
    .A2(_104_),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__and2b_1 _463_ (.A_N(_106_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__xnor2_1 _464_ (.A(_098_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _465_ (.A1(_042_),
    ...
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__nand4_1 _466_ (.A(net11),
    .B(net12),
    .C(net8),
    .D(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__or3b_1 _467_ (.A(_225_),
    .B(_033_),
    .C_N(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__a31o_1 _468_ (.A1(net12),
    .A2(net34),
    .A3(_111_),
    .B1(_032_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand3_2 _469_ (.A(_079_),
    ...
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__a21o_1 _470_ (.A1(_112_),
    .A2(_113_),
    .B1(_079_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__a21bo_1 _471_ (.A1(_077_),
    .A2(_080_),
    .B1_N(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__and3_1 _472_ (.A(_115_),
    .B(_114_),
    .C(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__a21o_1 _473_ (.A1(_114_),
    .A2(_115_),
    .B1(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__and2b_1 _474_ (.A_N(_117_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _476_ (.A(_120_),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__nand2_1 _477_ (.A(_109_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__xor2_1 _478_ (.A(_109_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__and4_1 _479_ (.A(net13),
    .B(net41),
    .C(net6),
    .D(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__and3b_1 _480_ (.A_N(_124_),
    .B(net36),
    .C(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nand2b_1 _481_ (.A_N(_123_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__xor2_1 _482_ (.A(_123_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__and3_1 _483_ (.A(_088_),
    .B(_091_),
    .C(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__a21o_1 _484_ (.A1(_088_),
    .A2(_091_),
    .B1(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__nand2b_1 _485_ (.A_N(_128_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _487_ (.A(_130_),
    ...
    .VPWR(VPWR),
    .Y(net32));
 sky130_fd_sc_hd__and3_1 _488_ (.A(net14),
    .B(net6),
    .C(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__and2_1 _489_ (.A(net36),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__xnor2_1 _490_ (.A(_132_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__nand2_1 _491_ (.A(net13),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__or2_1 _492_ (.A(_134_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__nand2_1 _493_ (.A(_134_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__and2_1 _494_ (.A(_136_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__a41o_1 _495_ (.A1(net4),
    .A2(net40),
    .A3(_065_),
    .A4(_100_),
    .B1(_103_),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__and3_1 _496_ (.A(_104_),
    .B(_102_),
    .C(_052_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__and3b_1 _497_ (.A_N(_106_),
    .B(_107_),
    .C(_072_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31ai_2 _498_ (.A1(_106_),
    ...
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__or4_4 _499_ (.A(_106_),
    .B(_139_),
    .C(_140_),
    .D(_141_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__and3b_1 _500_ (.A_N(_117_),
    .B(_118_),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__and3_1 _501_ (.A(_042_),
    .B(_114_),
    .C(_115_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31ai_2 _503_ (.A1(_117_),
    ...
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__or4_4 _504_ (.A(_117_),
    .B(_144_),
    .C(_145_),
    .D(_146_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__and4_1 _505_ (.A(_143_),
    .B(_142_),
    .C(_147_),
    .D(_148_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22oi_2 _506_ (.A1(_142_),
    ...
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__nor2_1 _507_ (.A(_149_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__and2_4 _508_ (.A(_138_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__nor2_1 _509_ (.A(_138_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _511_ (.A(_154_),
    ...
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__a211oi_1 _512_ (.A1(_122_),
    .A2(_126_),
    .B1(_152_),
    .C1(_153_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__or2_1 _513_ (.A(_155_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__nor2_1 _514_ (.A(_095_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_2 _515_ (.A1(_093_),
    ...
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__a21o_1 _516_ (.A1(_158_),
    .A2(_096_),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _517_ (.A(_157_),
    ...
    .VPWR(VPWR),
    .Y(net18));
 sky130_fd_sc_hd__or3_1 _518_ (.A(_226_),
    .B(_228_),
    .C(_135_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _519_ (.A(_161_),
    ...
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__and3_1 _520_ (.A(net14),
    .B(net34),
    .C(_161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__and3_1 _521_ (.A(net6),
    .B(net40),
    .C(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__and3b_1 _522_ (.A_N(_164_),
    .B(net16),
    .C(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__and2_1 _523_ (.A(_124_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__a211oi_1 _524_ (.A1(_132_),
    .A2(_133_),
    .B1(_165_),
    .C1(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__nor2_1 _525_ (.A(_166_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__and2_1 _526_ (.A(_163_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__xnor2_1 _527_ (.A(_163_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__nor2_1 _528_ (.A(_136_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__or2_1 _529_ (.A(_136_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__nand2_1 _530_ (.A(_136_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__nand2_1 _531_ (.A(_172_),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__and3_1 _532_ (.A(_099_),
    .B(_100_),
    .C(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__and3_1 _533_ (.A(_111_),
    .B(_112_),
    .C(_147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__nor2_1 _534_ (.A(_175_),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__xnor2_1 _535_ (.A(_175_),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__nor2_1 _536_ (.A(_174_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _537_ (.A(_174_),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__o21a_1 _538_ (.A1(net59),
    .A2(_152_),
    .B1(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__or3_4 _539_ (.A(net59),
    .B(_152_),
    .C(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__nand2b_1 _540_ (.A_N(_181_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__a21o_1 _541_ (.A1(_160_),
    .A2(_154_),
    .B1(_156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__xnor2_2 _542_ (.A(_184_),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net19));
 sky130_fd_sc_hd__nand2_1 _543_ (.A(net15),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__and3_1 _544_ (.A(net14),
    .B(net8),
    .C(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__and3_1 _545_ (.A(net15),
    .B(net7),
    .C(_186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__xnor2_1 _546_ (.A(_185_),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__and4bb_1 _547_ (.A_N(_133_),
    .B_N(_166_),
    .C(net6),
    .D(net16),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__xnor2_1 _548_ (.A(_188_),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _549_ (.A(_190_),
    ...
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__nand2_1 _550_ (.A(_169_),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__xnor2_1 _551_ (.A(_169_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__xnor2_1 _552_ (.A(_172_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__o21a_1 _553_ (.A1(_177_),
    .A2(_179_),
    .B1(_194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__or3_1 _554_ (.A(_177_),
    .B(_179_),
    .C(_194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__nand2b_1 _555_ (.A_N(_195_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__a211o_1 _556_ (.A1(_156_),
    .A2(_182_),
    .B1(_181_),
    .C1(_159_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__a21o_1 _557_ (.A1(_158_),
    .A2(_096_),
    .B1(_198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__o211a_4 _558_ (.A1(_154_),
    .A2(_181_),
    .B1(_182_),
    .C1(_199_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _559_ (.A(_197_),
    ...
    .VPWR(VPWR),
    .Y(net20));
 sky130_fd_sc_hd__or3_1 _560_ (.A(_227_),
    .B(_228_),
    .C(_185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__or3b_1 _561_ (.A(_227_),
    .B(_161_),
    .C_N(_201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__a31o_1 _562_ (.A1(net16),
    .A2(net7),
    .A3(_201_),
    .B1(_162_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__o211a_1 _563_ (.A1(_164_),
    .A2(_166_),
    .B1(_202_),
    .C1(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__a211oi_1 _564_ (.A1(_202_),
    .A2(_203_),
    .B1(_164_),
    .C1(_166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__or2_1 _565_ (.A(_204_),
    .B(_205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__a21oi_1 _566_ (.A1(_188_),
    .A2(_189_),
    .B1(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__nor2_1 _567_ (.A(_206_),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__xnor2_1 _568_ (.A(_206_),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__a21bo_1 _569_ (.A1(_171_),
    .A2(_193_),
    .B1_N(_192_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__xnor2_1 _570_ (.A(_209_),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__a211oi_1 _571_ (.A1(_196_),
    .A2(_200_),
    .B1(_211_),
    .C1(_195_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__o211a_1 _572_ (.A1(_195_),
    .A2(_200_),
    .B1(_211_),
    .C1(_196_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _574_ (.A(_192_),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__nor2_1 _575_ (.A(_172_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__a41o_1 _576_ (.A1(net16),
    .A2(net8),
    .A3(_185_),
    .A4(_202_),
    .B1(_204_),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__o31a_1 _577_ (.A1(_208_),
    .A2(_214_),
    .A3(_215_),
    .B1(_216_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__or4_1 _578_ (.A(_208_),
    .B(_214_),
    .C(_215_),
    .D(_216_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__and2b_1 _579_ (.A_N(_217_),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__o2111a_1 _580_ (.A1(_195_),
    .A2(_200_),
    .B1(_211_),
    .C1(_219_),
    .D1(_196_),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__xor2_1 _581_ (.A(_213_),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__nand2_1 _582_ (.A(_201_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__or3_4 _583_ (.A(_217_),
    .B(_222_),
    .C(_220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__or3b_1 _584_ (.A(_264_),
    .B(_266_),
    .C_N(_029_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__and2b_1 _585_ (.A_N(_030_),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout40 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__buf_6 fanout41 (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 fanout44 (.A(net10),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkbuf_2 fanout45 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 fanout46 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__clkbuf_2 fanout47 (.A(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer5 (.A(net68),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer6 (.A(net52),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(_282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer8 (.A(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__buf_2 rebuffer9 (.A(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer11 (.A(net56),
    ...
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer12 (.A(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_1 clone13 (.A(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__buf_6 rebuffer15 (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__buf_2 rebuffer16 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__buf_2 rebuffer17 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer18 (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer19 (.A(net67),
    ...
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__buf_2 rebuffer20 (.A(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__buf_4 rebuffer21 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer22 (.A(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__buf_1 rebuffer23 (.A(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer24 (.A(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer25 (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__buf_1 rebuffer26 (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer27 (.A(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer28 (.A(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer29 (.A(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer30 (.A(_284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer31 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer32 (.A(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer33 (.A(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer34 (.A(net80),
    ...
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer35 (.A(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer36 (.A(net82),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer37 (.A(net82),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer38 (.A(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer39 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer40 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__clkbuf_2 rebuffer41 (.A(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
