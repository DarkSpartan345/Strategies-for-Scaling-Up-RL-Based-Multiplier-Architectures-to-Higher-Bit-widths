module mult8_2bits_1op_e169662 (VPWR,
 ...
 sky130_fd_sc_hd__nand4_1 _284_ (.A(net33),
    ...
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__and2_1 _285_ (.A(net44),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _289_ (.A(net33),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__nand2_1 _290_ (.A(net33),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _294_ (.A(net44),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__and4_1 _295_ (.A(net33),
    .B(net44),
    .C(net4),
    .D(net36),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _297_ (.A(net38),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__o2111ai_1 _298_ (.A1(net33),
    .A2(net43),
    .B1(net46),
    .C1(net38),
    .D1(net44),
 ...
 sky130_fd_sc_hd__and4bb_1 _299_ (.A_N(_232_),
    ...
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__or4_1 _300_ (.A(_214_),
    .B(_215_),
    .C(_221_),
    .D(_232_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__o31ai_1 _301_ (.A1(_214_),
    .A2(_215_),
    .A3(_232_),
    .B1(_233_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__and3_1 _302_ (.A(_231_),
    .B(_235_),
    .C(_236_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__a21oi_1 _303_ (.A1(_235_),
    .A2(_236_),
    .B1(_231_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__or3_2 _304_ (.A(_228_),
    .B(_237_),
    .C(_238_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _306_ (.A(_239_),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__nand2_1 _307_ (.A(net33),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__nand2_1 _308_ (.A(net46),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _314_ (.A1(_245_),
    ...
    .VPWR(VPWR),
    .X(_248_));
 sky130_fd_sc_hd__and3_1 _315_ (.A(_237_),
    .B(_247_),
    .C(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__nand3_1 _316_ (.A(_237_),
    .B(_247_),
    .C(_248_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _318_ (.A(_249_),
    ...
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__xnor2_1 _319_ (.A(_239_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _323_ (.A(_241_),
    ...
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__and3_1 _324_ (.A(net44),
    .B(net6),
    .C(_241_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__nand2_1 _325_ (.A(net43),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _326_ (.A(_257_),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__nand2_1 _327_ (.A(net33),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _333_ (.A1(net36),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__o211a_1 _334_ (.A1(_232_),
    .A2(_234_),
    .B1(_265_),
    .C1(_266_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _340_ (.A1(_267_),
    ...
    .VPWR(VPWR),
    .Y(_273_));
 sky130_fd_sc_hd__o221a_1 _341_ (.A1(_239_),
    .A2(_269_),
    .B1(_272_),
    .B2(_250_),
    .C1(_271_),
 ...
 sky130_fd_sc_hd__nand2b_1 _343_ (.A_N(_274_),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__xor2_1 _344_ (.A(_274_),
    .B(_275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and3_1 _345_ (.A(net38),
    .B(net41),
    .C(_242_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__nand2_1 _346_ (.A(net46),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _352_ (.A(_001_),
    ...
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__xor2_1 _353_ (.A(_001_),
    .B(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__xnor2_1 _354_ (.A(_263_),
    .B(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__nand4_1 _355_ (.A(net38),
    .B(net1),
    .C(net13),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__and3_1 _356_ (.A(net1),
    .B(net41),
    .C(_012_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _358_ (.A1(_239_),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__xor2_1 _359_ (.A(_014_),
    .B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__nand4_1 _360_ (.A(net33),
    .B(net44),
    .C(net6),
    .D(net35),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _361_ (.A(net45),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__xor2_1 _362_ (.A(_013_),
    .B(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _364_ (.A(_011_),
    ...
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__xnor2_1 _365_ (.A(_011_),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _368_ (.A_N(_022_),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__xnor2_1 _369_ (.A(_022_),
    .B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _370_ (.A1(_263_),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__nand4_2 _371_ (.A(net33),
    .B(net45),
    .C(net8),
    .D(net34),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _372_ (.A(net45),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__nand2_1 _373_ (.A(net42),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _383_ (.A_N(_038_),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__and3_1 _384_ (.A(net1),
    .B(net40),
    .C(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__a211o_1 _385_ (.A1(net38),
    .A2(net40),
    .B1(_217_),
    .C1(_214_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _392_ (.A(_046_),
    ...
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__and3_1 _393_ (.A(_264_),
    .B(_265_),
    .C(_000_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _394_ (.A(_048_),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__xnor2_1 _395_ (.A(_048_),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__or2_1 _396_ (.A(_037_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _414_ (.A(net45),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__and3_1 _415_ (.A(net43),
    .B(net34),
    .C(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__xnor2_1 _416_ (.A(_068_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__o22a_1 _417_ (.A1(_215_),
    .A2(_017_),
    .B1(_029_),
    .B2(_258_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _418_ (.A(net12),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__xnor2_1 _419_ (.A(_071_),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _429_ (.A(_082_),
    ...
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__a21o_1 _430_ (.A1(_050_),
    .A2(_052_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _434_ (.A(_054_),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__and2_1 _435_ (.A(_088_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _450_ (.A(net12),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__a21bo_1 _451_ (.A1(_027_),
    .A2(_104_),
    .B1_N(_103_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _452_ (.A(_072_),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__xor2_1 _453_ (.A(_072_),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__a21oi_1 _454_ (.A1(_071_),
    .A2(_073_),
    .B1(_070_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _467_ (.A_N(_119_),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nand2_1 _468_ (.A(_085_),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__xor2_1 _469_ (.A(_121_),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _489_ (.A1(_133_),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__and3_1 _490_ (.A(_129_),
    .B(_141_),
    .C(_142_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _494_ (.A(_145_),
    ...
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__o211a_1 _495_ (.A1(_054_),
    .A2(_056_),
    .B1(_087_),
    .C1(_121_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__o21a_1 _496_ (.A1(_085_),
    .A2(_119_),
    .B1(_120_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _498_ (.A(_148_),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__xnor2_1 _499_ (.A(_147_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _519_ (.A(_165_),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__o21ai_1 _520_ (.A1(_140_),
    .A2(_143_),
    .B1(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__or3_1 _521_ (.A(_140_),
    .B(_143_),
    .C(_171_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _541_ (.A_N(_145_),
    ...
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__o311a_1 _542_ (.A1(_148_),
    .A2(_150_),
    .A3(_191_),
    .B1(_192_),
    .C1(_173_),
 ...
 sky130_fd_sc_hd__a211oi_1 _555_ (.A1(_189_),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__o211a_1 _556_ (.A1(_188_),
    .A2(_193_),
    .B1(_204_),
    .C1(_189_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _564_ (.A(_194_),
    ...
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__or3_1 _565_ (.A(_209_),
    .B(_211_),
    .C(_212_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 fanout41 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkbuf_4 fanout42 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__buf_2 fanout43 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
