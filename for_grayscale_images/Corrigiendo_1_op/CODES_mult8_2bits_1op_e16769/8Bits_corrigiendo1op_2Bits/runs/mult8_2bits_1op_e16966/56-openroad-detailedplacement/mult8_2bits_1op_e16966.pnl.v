module mult8_2bits_1op_e16966 (VPWR,
 ...
 sky130_fd_sc_hd__and2_1 _278_ (.A(net48),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__nand2_1 _279_ (.A(net34),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__and4_1 _280_ (.A(net34),
    .B(net48),
    .C(net2),
    .D(net49),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _281_ (.A_N(net17),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__and2_1 _282_ (.A(net49),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__and3_1 _283_ (.A(_216_),
    .B(_217_),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _284_ (.A1(_216_),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__nand2_1 _285_ (.A(net34),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__o21a_1 _286_ (.A1(_219_),
    .A2(_220_),
    .B1(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__nor3_2 _287_ (.A(_219_),
    .B(_220_),
    .C(_221_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _290_ (.A(net34),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__and3b_1 _291_ (.A_N(_225_),
    .B(net39),
    .C(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__nand4_1 _292_ (.A(net2),
    .B(net49),
    .C(net11),
    .D(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__nand4_1 _293_ (.A(net49),
    .B(net45),
    .C(net17),
    .D(_227_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__a31o_1 _294_ (.A1(net49),
    .A2(net45),
    .A3(_227_),
    .B1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__a21o_1 _295_ (.A1(_228_),
    .A2(_229_),
    .B1(_219_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _297_ (.A(_226_),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__xor2_1 _298_ (.A(_226_),
    .B(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__nand2_1 _299_ (.A(_223_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _301_ (.A(_234_),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__nand2_1 _302_ (.A(net34),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__nand2_1 _303_ (.A(net49),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__a2111oi_1 _304_ (.A1(net49),
    .A2(net17),
    .B1(_218_),
    .C1(_214_),
    .D1(_213_),
 ...
 sky130_fd_sc_hd__nor3b_1 _306_ (.A(_224_),
    ...
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__or3b_1 _307_ (.A(_224_),
    .B(_239_),
    .C_N(_221_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a32o_1 _308_ (.A1(net48),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__and3_1 _309_ (.A(_238_),
    .B(_241_),
    .C(_242_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _313_ (.A(_231_),
    ...
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__xnor2_1 _314_ (.A(_234_),
    .B(_247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__and3_1 _315_ (.A(net49),
    .B(net13),
    .C(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__xnor2_1 _316_ (.A(_237_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_250_));
 sky130_fd_sc_hd__and3_1 _317_ (.A(net34),
    .B(net37),
    .C(_250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__a21oi_1 _318_ (.A1(net34),
    .A2(net37),
    .B1(_250_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _322_ (.A(_253_),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nand2_1 _323_ (.A(net34),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_2 _328_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_261_));
 sky130_fd_sc_hd__nand4_2 _329_ (.A(net39),
    .B(net45),
    .C(_225_),
    .D(_261_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _330_ (.A1(net39),
    ...
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__nand2_1 _331_ (.A(_262_),
    .B(_263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_264_));
 sky130_fd_sc_hd__xnor2_2 _332_ (.A(_260_),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _333_ (.A(_223_),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__nor2_1 _334_ (.A(_240_),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_1 _339_ (.A1(_266_),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__or4_1 _340_ (.A(_266_),
    .B(_268_),
    .C(_269_),
    .D(_271_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _349_ (.A1(_272_),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__or3b_1 _350_ (.A(_006_),
    .B(_007_),
    .C_N(_259_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _353_ (.A(net50),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__xor2_1 _354_ (.A(_265_),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _356_ (.A(_012_),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__and4_1 _357_ (.A(net34),
    .B(net47),
    .C(net6),
    .D(net37),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _364_ (.A(_016_),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__o21ba_1 _365_ (.A1(_249_),
    .A2(_251_),
    .B1_N(_022_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__xor2_1 _366_ (.A(_021_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__nand2b_1 _367_ (.A_N(_006_),
    .B(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__and4_1 _368_ (.A(net34),
    .B(net47),
    .C(net8),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nand4_1 _369_ (.A(net9),
    .B(net47),
    .C(net8),
    .D(net35),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand4_1 _371_ (.A(net11),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__o2111a_1 _372_ (.A1(net9),
    .A2(net11),
    .B1(net6),
    .C1(net37),
    .D1(net47),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nand4_1 _373_ (.A(net45),
    .B(net37),
    .C(_028_),
    .D(_029_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _396_ (.A(_024_),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__xor2_1 _397_ (.A(_024_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _412_ (.A1(net47),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__nand4_1 _413_ (.A(net48),
    .B(net8),
    .C(_256_),
    .D(_067_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _414_ (.A(_068_),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__a21boi_2 _415_ (.A1(net46),
    .A2(_015_),
    .B1_N(_028_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _431_ (.A(_084_),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__a21oi_2 _432_ (.A1(_054_),
    .A2(_055_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__xor2_1 _433_ (.A(_087_),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _434_ (.A1(_047_),
    ...
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__nand4_1 _435_ (.A(net4),
    .B(net40),
    .C(net43),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__nand4_1 _436_ (.A(net40),
    .B(net41),
    .C(_038_),
    .D(_090_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _449_ (.A(_102_),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__xor2_1 _450_ (.A(_071_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_1 _483_ (.A1(_107_),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__or4_1 _484_ (.A(_107_),
    .B(_133_),
    .C(_134_),
    .D(_136_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _487_ (.A1(_131_),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__and3_1 _488_ (.A(_127_),
    .B(_140_),
    .C(_141_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _492_ (.A_N(_144_),
    ...
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__or3b_2 _493_ (.A(_087_),
    .B(_088_),
    .C_N(_119_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _494_ (.A1(_086_),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__and3_1 _495_ (.A(_146_),
    .B(_147_),
    .C(_148_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _516_ (.A(_163_),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__o21ai_2 _517_ (.A1(_139_),
    .A2(_142_),
    .B1(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__nor3_1 _518_ (.A(_139_),
    .B(_142_),
    .C(_169_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _521_ (.A(_145_),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__or2_1 _522_ (.A(_173_),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _537_ (.A1(_144_),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a41oi_4 _538_ (.A1(_145_),
    .A2(_147_),
    .A3(_148_),
    .A4(_170_),
    .B1(_189_),
 ...
 sky130_fd_sc_hd__o211a_1 _552_ (.A1(_186_),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__nor2_1 _553_ (.A(_202_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _560_ (.A(_208_),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__o2111a_1 _561_ (.A1(_186_),
    .A2(_190_),
    .B1(_201_),
    .C1(_210_),
    .D1(_187_),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__xor2_1 _562_ (.A(_203_),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout38 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_4 fanout39 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout44 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkbuf_4 fanout45 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
