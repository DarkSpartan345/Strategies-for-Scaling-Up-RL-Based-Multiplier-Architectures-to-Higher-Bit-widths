module mult4_SarsaNada_e8_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__and4_1 _048_ (.A(net6),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__and2b_1 _049_ (.A_N(net9),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _052_ (.A(net1),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a31o_1 _053_ (.A1(net6),
    .A2(net2),
    .A3(_000_),
    .B1(_003_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _055_ (.A(net6),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__nor2_1 _056_ (.A(_005_),
    .B(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__xnor2_1 _057_ (.A(_002_),
    .B(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4b_2 _061_ (.A(_001_),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__a2bb2o_1 _062_ (.A1_N(_003_),
    .A2_N(_009_),
    .B1(_010_),
    .B2(_002_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _066_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__or3b_1 _067_ (.A(_015_),
    .B(_016_),
    .C_N(net9),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _069_ (.A_N(_018_),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__o21bai_1 _070_ (.A1(_015_),
    .A2(_016_),
    .B1_N(net9),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _076_ (.A1(_017_),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__a21o_1 _077_ (.A1(_001_),
    .A2(_004_),
    .B1(_006_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__decap_8 FILLER_3_73 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_4_10 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_4_62 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_4_69 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_7_20 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_7_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
