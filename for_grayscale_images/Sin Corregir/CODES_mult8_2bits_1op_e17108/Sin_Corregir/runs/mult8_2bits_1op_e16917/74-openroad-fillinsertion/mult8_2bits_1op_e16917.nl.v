module mult8_2bits_1op_e16917 (A,
 ...
 sky130_fd_sc_hd__nand4_2 _234_ (.A(net47),
    ...
    .D(net6),
    .Y(_167_));
 sky130_fd_sc_hd__a22o_1 _235_ (.A1(net66),
    .A2(net35),
    .B1(net6),
    .B2(net60),
    .X(_168_));
 ...
 sky130_fd_sc_hd__and4_1 _239_ (.A(net41),
    ...
    .D(net2),
    .X(_172_));
 sky130_fd_sc_hd__nand4_4 _240_ (.A(net41),
    .B(net59),
    .C(net42),
    .D(net2),
    .Y(_173_));
 ...
 sky130_fd_sc_hd__and4_1 _246_ (.A(net50),
    ...
    .D(net49),
    .X(_179_));
 sky130_fd_sc_hd__nand4_4 _247_ (.A(net50),
    .B(net2),
    .C(net47),
    .D(net48),
    .Y(_180_));
 sky130_fd_sc_hd__nand2_1 _248_ (.A(net59),
    .B(net45),
    .Y(_181_));
 sky130_fd_sc_hd__mux2_4 _249_ (.A0(net45),
    .A1(_181_),
    .S(_180_),
    .X(_182_));
 ...
 sky130_fd_sc_hd__a22o_1 _263_ (.A1(net38),
    ...
    .B2(net4),
    .X(_196_));
 sky130_fd_sc_hd__and4_1 _264_ (.A(net73),
    .B(_194_),
    .C(_195_),
    .D(_196_),
    .X(_197_));
 sky130_fd_sc_hd__a311oi_2 _265_ (.A1(_192_),
    .A2(_191_),
    .A3(net45),
    .B1(_193_),
    .C1(net74),
 ...
 sky130_fd_sc_hd__o2111a_1 _266_ (.A1(_193_),
    ...
    .D1(_192_),
    .X(_199_));
 sky130_fd_sc_hd__a22oi_1 _267_ (.A1(net73),
    .A2(_195_),
    .B1(_196_),
    .B2(_194_),
    .Y(_200_));
 sky130_fd_sc_hd__or2_1 _268_ (.A(_197_),
    .B(_200_),
    .X(_201_));
 sky130_fd_sc_hd__or4_4 _269_ (.A(_178_),
    .B(_197_),
    .C(_182_),
    .D(_200_),
    .X(_202_));
 ...
 sky130_fd_sc_hd__o31ai_2 _276_ (.A1(_190_),
    ...
    .B1(_207_),
    .Y(_209_));
 sky130_fd_sc_hd__or4_4 _277_ (.A(_190_),
    .B(_199_),
    .C(_204_),
    .D(_207_),
    .X(_210_));
 ...
 sky130_fd_sc_hd__nand2_1 _289_ (.A(net10),
    .B(net35),
    .Y(_222_));
 sky130_fd_sc_hd__xnor2_2 _290_ (.A(_220_),
    .B(_217_),
    .Y(_223_));
 ...
 sky130_fd_sc_hd__o21ai_1 _300_ (.A1(_230_),
    ...
    .B1(_227_),
    .Y(_000_));
 sky130_fd_sc_hd__or3_4 _301_ (.A(_225_),
    .B(_226_),
    .C(_000_),
    .X(_001_));
 ...
 sky130_fd_sc_hd__nor2_1 _304_ (.A(net45),
    .B(_167_),
    .Y(_003_));
 sky130_fd_sc_hd__and3_4 _305_ (.A(net46),
    .B(net36),
    .C(_167_),
    .X(_004_));
 ...
 sky130_fd_sc_hd__nor2_1 _312_ (.A(net39),
    .B(_173_),
    .Y(_011_));
 sky130_fd_sc_hd__and3_1 _313_ (.A(_173_),
    .B(net39),
    .C(net50),
    .X(_012_));
 ...
 sky130_fd_sc_hd__o21ai_2 _315_ (.A1(_011_),
    ...
    .B1(_013_),
    .Y(_014_));
 sky130_fd_sc_hd__or3_4 _316_ (.A(_011_),
    .B(_012_),
    .C(_013_),
    .X(_015_));
 ...
 sky130_fd_sc_hd__a22oi_2 _330_ (.A1(net37),
    ...
    .B2(net4),
    .Y(_028_));
 sky130_fd_sc_hd__and4_1 _331_ (.A(net42),
    .B(net41),
    .C(net37),
    .D(net4),
    .X(_029_));
 sky130_fd_sc_hd__nand4_1 _332_ (.A(net37),
    ...
    .D(net4),
    .Y(_030_));
 sky130_fd_sc_hd__or4_4 _333_ (.A(_029_),
    .B(_027_),
    .C(_028_),
    .D(_172_),
    .X(_031_));
 ...
 sky130_fd_sc_hd__and3_1 _339_ (.A(net46),
    ...
    .C(_167_),
    .X(_037_));
 sky130_fd_sc_hd__and4_1 _340_ (.A(net66),
    .B(net49),
    .C(net34),
    .D(net8),
    .X(_038_));
 ...
 sky130_fd_sc_hd__o211a_1 _363_ (.A1(_173_),
    ...
    .C1(net39),
    .X(_060_));
 sky130_fd_sc_hd__o31a_1 _364_ (.A1(_027_),
    .A2(net52),
    .A3(_028_),
    .B1(_030_),
    .X(_061_));
 ...
 sky130_fd_sc_hd__and3_1 _375_ (.A(_042_),
    ...
    .C(_070_),
    .X(_072_));
 sky130_fd_sc_hd__or3_4 _376_ (.A(_064_),
    .B(_071_),
    .C(_072_),
    .X(_073_));
 sky130_fd_sc_hd__o21ai_1 _377_ (.A1(_071_),
    ...
    .B1(_064_),
    .Y(_074_));
 sky130_fd_sc_hd__nand4_2 _378_ (.A(net58),
    .B(net36),
    .C(_073_),
    .D(_074_),
    .Y(_075_));
 sky130_fd_sc_hd__a22o_1 _379_ (.A1(net58),
    .A2(net36),
    .B1(_073_),
    .B2(_074_),
    .X(_076_));
 ...
 sky130_fd_sc_hd__and2b_1 _383_ (.A_N(_078_),
    .B(_079_),
    .X(_080_));
 sky130_fd_sc_hd__xnor2_2 _384_ (.A(_080_),
    .B(_056_),
    .Y(net32));
 ...
 sky130_fd_sc_hd__and4_1 _391_ (.A(net39),
    ...
    .D(_015_),
    .X(_087_));
 sky130_fd_sc_hd__and2_4 _392_ (.A(_034_),
    .B(_063_),
    .X(_088_));
 sky130_fd_sc_hd__a21o_1 _393_ (.A1(net37),
    ...
    .B1(net4),
    .X(_089_));
 sky130_fd_sc_hd__and4_1 _394_ (.A(net53),
    .B(net4),
    .C(net39),
    .D(net37),
    .X(_090_));
 ...
 sky130_fd_sc_hd__or4_1 _403_ (.A(_069_),
    ...
    .D(_097_),
    .X(_099_));
 sky130_fd_sc_hd__or4bb_4 _404_ (.A(_093_),
    .B(_092_),
    .C_N(_098_),
    .D_N(_099_),
    .X(_100_));
 sky130_fd_sc_hd__a2bb2o_2 _405_ (.A1_N(net55),
    .A2_N(_093_),
    .B1(_098_),
    .B2(_099_),
    .X(_101_));
 ...
 sky130_fd_sc_hd__a211o_1 _409_ (.A1(_073_),
    ...
    .C1(_103_),
    .X(_105_));
 sky130_fd_sc_hd__o211a_1 _410_ (.A1(_103_),
    .A2(_102_),
    .B1(_073_),
    .C1(_075_),
    .X(_106_));
 sky130_fd_sc_hd__or2_4 _411_ (.A(_106_),
    .B(_104_),
    .X(_107_));
 ...
 sky130_fd_sc_hd__a21boi_1 _414_ (.A1(_054_),
    ...
    .B1_N(_109_),
    .Y(_110_));
 sky130_fd_sc_hd__xor2_1 _415_ (.A(_110_),
    .B(_107_),
    .X(net18));
 ...
 sky130_fd_sc_hd__or2_1 _450_ (.A(_105_),
    .B(_125_),
    .X(_144_));
 sky130_fd_sc_hd__o311ai_4 _451_ (.A1(_127_),
    .A2(_109_),
    .A3(_107_),
    .B1(_144_),
    .C1(_126_),
    .Y(_145_));
 sky130_fd_sc_hd__a31o_4 _452_ (.A1(_054_),
    .A2(_108_),
    .A3(_143_),
    .B1(_145_),
    .X(_146_));
 ...
 sky130_fd_sc_hd__a211oi_1 _462_ (.A1(_139_),
    ...
    .C1(_140_),
    .Y(_155_));
 sky130_fd_sc_hd__o211a_4 _463_ (.A1(_140_),
    .A2(_146_),
    .B1(_154_),
    .C1(_139_),
    .X(_156_));
 ...
 sky130_fd_sc_hd__and2_1 _474_ (.A(net51),
    .B(net9),
    .X(\mul_ll.mul_ll.pp1 ));
 sky130_fd_sc_hd__and2_1 _475_ (.A(net59),
    .B(net60),
    .X(\mul_ll.mul_ll.pp2 ));
 ...
 sky130_fd_sc_hd__buf_6 fanout41 (.A(net15),
    .X(net41));
 sky130_fd_sc_hd__buf_8 fanout42 (.A(net44),
    .X(net42));
 sky130_fd_sc_hd__buf_1 fanout43 (.A(net57),
    .X(net43));
 ...
 sky130_fd_sc_hd__buf_2 fanout49 (.A(net10),
    .X(net49));
 sky130_fd_sc_hd__buf_6 fanout50 (.A(net1),
    .X(net50));
 sky130_fd_sc_hd__buf_1 fanout51 (.A(net1),
    .X(net51));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer1 (.A(_172_),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(net52),
    .X(net53));
 sky130_fd_sc_hd__buf_1 rebuffer3 (.A(net53),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(net56),
    .X(net55));
 sky130_fd_sc_hd__buf_1 rebuffer5 (.A(net61),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(net44),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(net44),
    .X(net58));
 sky130_fd_sc_hd__buf_4 clone8 (.A(net1),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_1 clone9 (.A(net10),
    .X(net60));
 sky130_fd_sc_hd__buf_1 rebuffer10 (.A(_092_),
    .X(net61));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(net42),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer12 (.A(net62),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(net63),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(net64),
    .X(net65));
 sky130_fd_sc_hd__buf_6 clone15 (.A(net11),
    .X(net66));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer16 (.A(_146_),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer21 (.A(_182_),
    .X(net72));
 sky130_fd_sc_hd__buf_1 rebuffer22 (.A(_180_),
    .X(net73));
 sky130_fd_sc_hd__clkbuf_2 rebuffer23 (.A(_197_),
    .X(net74));
 sky130_fd_sc_hd__buf_2 rebuffer24 (.A(_202_),
    .X(net75));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_145 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_20_368 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_22_150 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_22_322 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_26_133 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_27_239 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_27_340 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_29_255 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_35_116 ();
 sky130_fd_sc_hd__fill_1 FILLER_35_120 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_39_156 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_40_18 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_40_210 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_41_98 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_41_292 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_44_324 ();
 sky130_ef_sc_hd__decap_12 FILLER_44_336 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_47_239 ();
