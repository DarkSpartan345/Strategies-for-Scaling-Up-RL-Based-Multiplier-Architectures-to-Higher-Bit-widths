			...
			for(i = 0;i<ksize;i=i+1)
    			begin
    				...
    				begin
						...
						//$isplay("3  sigma",SigmaMatrix[i][j]);
				end
			end
            				...
            				begin
                				...
                				begin
                    					...
                    					begin
											...
											////$isplay("3  i=%0d A=%0d B=%0d P=%0d",i, mult_A, mult_B, mult_P);
                    					end
                				end
            				end

            				result[i][j] = sum_g/256;                       //storing new pixel values
