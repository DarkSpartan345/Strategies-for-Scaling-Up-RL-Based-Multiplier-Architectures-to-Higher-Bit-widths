module mult4_SarsaNada_e10_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__inv_2 _25_ (.A(A[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\mul_ll.pp2 ));
 sky130_fd_sc_hd__and2_2 _26_ (.A(B[1]),
    .B(A[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _27_ (.A(B[0]),
    ...
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__and3_2 _28_ (.A(A[1]),
    .B(B[1]),
    .C(A[0]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_01_));
 sky130_fd_sc_hd__a22o_2 _29_ (.A1(A[1]),
    .A2(B[1]),
    .B1(A[0]),
    .B2(B[2]),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _32_ (.A(B[3]),
    ...
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__nand4_2 _33_ (.A(A[1]),
    .B(B[1]),
    .C(B[3]),
    .D(A[3]),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _35_ (.A(_05_),
    ...
    .VPWR(VPWR),
    .Y(_07_));
 sky130_fd_sc_hd__and2_2 _36_ (.A(B[2]),
    .B(A[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_08_));
 sky130_fd_sc_hd__xnor2_2 _37_ (.A(_07_),
    .B(_08_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_09_));
 sky130_fd_sc_hd__nand2_2 _38_ (.A(A[2]),
    .B(B[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__and4_2 _39_ (.A(B[1]),
    .B(A[0]),
    .C(A[2]),
    .D(B[3]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_11_));
 sky130_fd_sc_hd__a22oi_2 _40_ (.A1(B[1]),
    .A2(A[2]),
    .B1(B[3]),
    .B2(A[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_12_));
 sky130_fd_sc_hd__nor2_2 _41_ (.A(_11_),
    .B(_12_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_13_));
 sky130_fd_sc_hd__a32o_2 _42_ (.A1(B[0]),
    .A2(A[2]),
    .A3(_02_),
    .B1(_01_),
    .B2(B[2]),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__and2_2 _43_ (.A(_13_),
    .B(_14_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_15_));
 sky130_fd_sc_hd__nor2_2 _44_ (.A(_11_),
    .B(_15_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_16_));
 sky130_fd_sc_hd__xnor2_2 _45_ (.A(_09_),
    .B(_16_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[4]));
 sky130_fd_sc_hd__a21boi_2 _46_ (.A1(_06_),
    .A2(_08_),
    .B1_N(_05_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_17_));
 sky130_fd_sc_hd__and2_2 _47_ (.A(_10_),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_18_));
 sky130_fd_sc_hd__nor2_2 _48_ (.A(_10_),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_19_));
 sky130_fd_sc_hd__or2_2 _49_ (.A(_18_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__o21a_2 _50_ (.A1(_11_),
    .A2(_15_),
    .B1(_09_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_21_));
 sky130_fd_sc_hd__xnor2_2 _51_ (.A(_20_),
    .B(_21_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[5]));
 sky130_fd_sc_hd__and3b_2 _52_ (.A_N(_10_),
    .B(_13_),
    .C(_14_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_22_));
 sky130_fd_sc_hd__a211oi_2 _53_ (.A1(_09_),
    .A2(_11_),
    .B1(_19_),
    .C1(_22_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_23_));
 sky130_fd_sc_hd__nor2_2 _54_ (.A(_04_),
    .B(_23_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[7]));
 sky130_fd_sc_hd__xor2_2 _55_ (.A(_04_),
    .B(_23_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(P[6]));
 sky130_fd_sc_hd__nor2_2 _56_ (.A(_13_),
    .B(_14_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_24_));
 sky130_fd_sc_hd__nor2_2 _57_ (.A(_15_),
    .B(_24_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[3]));
 sky130_fd_sc_hd__buf_2 _58_ (.A(\mul_ll.pp2 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(P[0]));
 sky130_fd_sc_hd__buf_2 _59_ (.A(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
