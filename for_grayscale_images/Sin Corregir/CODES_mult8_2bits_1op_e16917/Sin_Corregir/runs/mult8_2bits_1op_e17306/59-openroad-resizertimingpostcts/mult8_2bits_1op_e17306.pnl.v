module mult8_2bits_1op_e17306 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__and4_1 _230_ (.A(net61),
    .B(net55),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__nand4_4 _231_ (.A(net59),
    .B(net54),
    .C(net34),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__a22o_1 _232_ (.A1(net60),
    .A2(net34),
    .B1(net6),
    .B2(net56),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__and4_1 _233_ (.A(_163_),
    .B(net32),
    .C(_162_),
    .D(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__a22oi_1 _234_ (.A1(net9),
    .A2(net33),
    .B1(_162_),
    .B2(_163_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__nor2_1 _235_ (.A(_164_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__inv_2 _236_ (.A(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__and4_1 _237_ (.A(net40),
    .B(net41),
    .C(net66),
    .D(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__nand4_4 _238_ (.A(net40),
    .B(net49),
    .C(net41),
    .D(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__a22o_1 _239_ (.A1(net40),
    .A2(net68),
    .B1(net41),
    .B2(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__and4_1 _240_ (.A(net13),
    .B(net36),
    .C(_169_),
    .D(_170_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__a22oi_1 _241_ (.A1(net13),
    .A2(net36),
    .B1(_169_),
    .B2(_170_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__nor2_1 _242_ (.A(_171_),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__nand2_1 _243_ (.A(net37),
    .B(net53),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__and4_1 _244_ (.A(net49),
    .B(net2),
    .C(net46),
    .D(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__nand4_4 _245_ (.A(net49),
    .B(net2),
    .C(net46),
    .D(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__nand2_1 _246_ (.A(net49),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__mux2_4 _247_ (.A0(net44),
    .A1(_177_),
    .S(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__nor2_1 _248_ (.A(_174_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__and2_1 _249_ (.A(_174_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__xor2_1 _250_ (.A(_174_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__a22o_1 _251_ (.A1(net68),
    .A2(net62),
    .B1(net52),
    .B2(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__and4_1 _252_ (.A(net37),
    .B(net9),
    .C(_176_),
    .D(_182_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__inv_2 _253_ (.A(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__nand2_1 _254_ (.A(_181_),
    .B(net107),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__and3_1 _255_ (.A(_181_),
    .B(net44),
    .C(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__nand3_1 _256_ (.A(net37),
    .B(net44),
    .C(_175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__or2_4 _257_ (.A(net37),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and4_1 _258_ (.A(net37),
    .B(net4),
    .C(net58),
    .D(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__nand4_1 _259_ (.A(net37),
    .B(net4),
    .C(net57),
    .D(net51),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _260_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__a22o_1 _261_ (.A1(net37),
    .A2(net46),
    .B1(net51),
    .B2(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__and4_1 _262_ (.A(_176_),
    .B(_190_),
    .C(_191_),
    .D(_192_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__a311oi_2 _263_ (.A1(net44),
    .A2(_188_),
    .A3(_187_),
    .B1(_189_),
    .C1(_193_),
    ...
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__o2111a_1 _264_ (.A1(_189_),
    .A2(_193_),
    .B1(net44),
    .C1(_187_),
    .D1(_188_),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__a22oi_1 _265_ (.A1(_176_),
    .A2(_191_),
    .B1(_192_),
    .B2(_190_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__or2_1 _266_ (.A(_193_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__or4_4 _267_ (.A(_174_),
    .B(_178_),
    .C(_193_),
    .D(_196_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__nor2_1 _268_ (.A(net87),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__nor2_2 _269_ (.A(_194_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__and4_1 _270_ (.A(net37),
    .B(net4),
    .C(net44),
    .D(_175_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__nand2_1 _271_ (.A(net4),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__a21oi_1 _272_ (.A1(_187_),
    .A2(_202_),
    .B1(_201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__o31a_1 _273_ (.A1(net86),
    .A2(_195_),
    .A3(_200_),
    .B1(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__o31ai_1 _274_ (.A1(net86),
    .A2(_195_),
    .A3(_200_),
    .B1(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__or4_4 _275_ (.A(_186_),
    .B(_195_),
    .C(_200_),
    .D(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__and3_4 _276_ (.A(_206_),
    .B(_205_),
    .C(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__a21oi_1 _277_ (.A1(_205_),
    .A2(net109),
    .B1(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__nor3_1 _278_ (.A(_167_),
    .B(_207_),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__or3_4 _279_ (.A(_167_),
    .B(_207_),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__o21ai_1 _280_ (.A1(_207_),
    .A2(_208_),
    .B1(_167_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__nand2_1 _281_ (.A(net1),
    .B(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__xnor2_1 _282_ (.A(_179_),
    .B(_197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__o41a_1 _283_ (.A1(_179_),
    .A2(_180_),
    .A3(_184_),
    .A4(_197_),
    .B1(_198_),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__xnor2_1 _284_ (.A(_199_),
    .B(_214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _286_ (.A(net48),
    ...
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__xnor2_1 _287_ (.A(_212_),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__and3_1 _288_ (.A(net48),
    .B(net34),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__o211a_1 _289_ (.A1(_216_),
    .A2(_219_),
    .B1(_210_),
    .C1(_211_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__inv_2 _290_ (.A(net65),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__a211o_1 _291_ (.A1(_210_),
    .A2(_211_),
    .B1(_216_),
    .C1(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__xnor2_1 _292_ (.A(_217_),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__nand2_1 _293_ (.A(net13),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__xnor2_1 _294_ (.A(_185_),
    .B(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__and3_1 _295_ (.A(net13),
    .B(net1),
    .C(_225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__xnor2_1 _296_ (.A(_224_),
    .B(_225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__and3_1 _297_ (.A(net9),
    .B(net34),
    .C(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__o21ai_1 _298_ (.A1(_226_),
    .A2(_228_),
    .B1(_223_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__or3b_4 _299_ (.A(_220_),
    .B(_229_),
    .C_N(_222_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__a21bo_1 _300_ (.A1(_221_),
    .A2(_222_),
    .B1_N(_229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and2_4 _301_ (.A(_000_),
    .B(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__nor2_1 _302_ (.A(net44),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__and3_1 _303_ (.A(net45),
    .B(_162_),
    .C(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__o211a_1 _304_ (.A1(_002_),
    .A2(_003_),
    .B1(net48),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__a211o_1 _305_ (.A1(net48),
    .A2(net33),
    .B1(_002_),
    .C1(_003_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__nand2b_1 _306_ (.A_N(_004_),
    .B(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__xnor2_1 _307_ (.A(_164_),
    .B(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__nor2_1 _308_ (.A(net38),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _309_ (.A(_169_),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and2_1 _310_ (.A(net36),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__o21ai_2 _311_ (.A1(_008_),
    .A2(net64),
    .B1(_010_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__or3_4 _312_ (.A(_008_),
    .B(_009_),
    .C(_010_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__and3_1 _313_ (.A(_171_),
    .B(_011_),
    .C(_012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a21oi_1 _314_ (.A1(_011_),
    .A2(_012_),
    .B1(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__nor2_1 _315_ (.A(_013_),
    .B(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__o21ai_1 _316_ (.A1(_201_),
    .A2(_204_),
    .B1(_015_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__or3_1 _317_ (.A(_201_),
    .B(_204_),
    .C(_015_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__nand3_1 _318_ (.A(_007_),
    .B(_016_),
    .C(_017_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__a21o_1 _319_ (.A1(_016_),
    .A2(_017_),
    .B1(_007_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__o211ai_1 _320_ (.A1(_207_),
    .A2(_209_),
    .B1(_018_),
    .C1(_019_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__a211o_1 _321_ (.A1(_018_),
    .A2(_019_),
    .B1(_207_),
    .C1(_209_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__nand2_1 _322_ (.A(_020_),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nand2_2 _323_ (.A(_221_),
    .B(net108),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xnor2_2 _324_ (.A(_022_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net29));
 sky130_fd_sc_hd__nand2_1 _325_ (.A(net2),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_2 _326_ (.A1(net36),
    ...
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__and4_1 _327_ (.A(net41),
    .B(net40),
    .C(net36),
    .D(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__nand4_1 _328_ (.A(net36),
    .B(net40),
    .C(net83),
    .D(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__or4_4 _329_ (.A(_026_),
    .B(_024_),
    .C(_025_),
    .D(_168_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__o22ai_1 _330_ (.A1(_168_),
    .A2(_024_),
    .B1(_025_),
    .B2(_026_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__and2_1 _331_ (.A(_028_),
    .B(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__o2111a_1 _332_ (.A1(_008_),
    .A2(net64),
    .B1(_010_),
    .C1(_028_),
    .D1(_029_),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__xnor2_1 _333_ (.A(_011_),
    .B(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__xnor2_1 _334_ (.A(_013_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__and3_1 _335_ (.A(net45),
    .B(net6),
    .C(_162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__and4_1 _336_ (.A(net61),
    .B(net48),
    .C(net33),
    .D(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__a22o_1 _337_ (.A1(net11),
    .A2(net33),
    .B1(net8),
    .B2(net48),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nand2b_4 _338_ (.A_N(_035_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__xnor2_2 _339_ (.A(_037_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__a21o_1 _340_ (.A1(_164_),
    .A2(_005_),
    .B1(_004_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__xnor2_1 _341_ (.A(net74),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__nor2_1 _342_ (.A(_033_),
    .B(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__xor2_1 _343_ (.A(_033_),
    .B(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__nand2_1 _344_ (.A(net13),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__xor2_1 _345_ (.A(_042_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__a21boi_1 _346_ (.A1(_007_),
    .A2(_017_),
    .B1_N(_016_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__nor2_1 _347_ (.A(_044_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__and2_1 _348_ (.A(_044_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__or2_1 _349_ (.A(_046_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__nand2_1 _350_ (.A(net65),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__o211a_4 _351_ (.A1(_022_),
    .A2(_000_),
    .B1(_049_),
    .C1(_020_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__xor2_2 _352_ (.A(_048_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__o21ba_1 _353_ (.A1(_048_),
    .A2(_050_),
    .B1_N(_046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__a41o_1 _354_ (.A1(_171_),
    .A2(_011_),
    .A3(_012_),
    .A4(_030_),
    .B1(_031_),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__a41o_1 _355_ (.A1(net40),
    .A2(net67),
    .A3(net41),
    .A4(net2),
    .B1(net36),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__nand2_1 _356_ (.A(net36),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__o211a_1 _357_ (.A1(_169_),
    .A2(_054_),
    .B1(_053_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__o31a_1 _358_ (.A1(_024_),
    .A2(net69),
    .A3(_025_),
    .B1(_027_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__and2b_1 _359_ (.A_N(_056_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__xnor2_2 _360_ (.A(_056_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__xnor2_1 _361_ (.A(_052_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__a21o_1 _362_ (.A1(_034_),
    .A2(_036_),
    .B1(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__a21boi_1 _363_ (.A1(net33),
    .A2(_161_),
    .B1_N(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__o21a_1 _364_ (.A1(_161_),
    .A2(net33),
    .B1(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__and2_1 _365_ (.A(_060_),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__xor2_1 _366_ (.A(_060_),
    .B(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__and3_1 _367_ (.A(_038_),
    .B(_039_),
    .C(_064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__a21oi_1 _368_ (.A1(_038_),
    .A2(_039_),
    .B1(_064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__or3_4 _369_ (.A(_059_),
    .B(_065_),
    .C(_066_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__o21ai_1 _370_ (.A1(_065_),
    .A2(_066_),
    .B1(_059_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__nand4_2 _371_ (.A(net78),
    .B(net34),
    .C(_067_),
    .D(_068_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__a22o_1 _372_ (.A1(net78),
    .A2(net34),
    .B1(_067_),
    .B2(_068_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__a31o_1 _373_ (.A1(net13),
    .A2(net34),
    .A3(_042_),
    .B1(_041_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__and3_1 _374_ (.A(_069_),
    .B(_070_),
    .C(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__a21o_1 _375_ (.A1(_069_),
    .A2(_070_),
    .B1(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__nand2b_1 _376_ (.A_N(_072_),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__xor2_1 _377_ (.A(_051_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__and4_1 _378_ (.A(net40),
    .B(net85),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__nand4_2 _379_ (.A(net40),
    .B(net84),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__a22o_1 _380_ (.A1(net40),
    .A2(net35),
    .B1(net6),
    .B2(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__and4_1 _381_ (.A(net13),
    .B(net33),
    .C(_076_),
    .D(_077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__a22oi_1 _382_ (.A1(net13),
    .A2(net33),
    .B1(_076_),
    .B2(_077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__nor2_1 _383_ (.A(_078_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__and4_1 _384_ (.A(net38),
    .B(_171_),
    .C(_011_),
    .D(_012_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__and2_4 _385_ (.A(_031_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__a21o_1 _386_ (.A1(net36),
    .A2(net71),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__and4_1 _387_ (.A(net36),
    .B(net4),
    .C(net38),
    .D(net70),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__and3b_1 _388_ (.A_N(_084_),
    .B(net38),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__o31a_1 _389_ (.A1(_082_),
    .A2(_081_),
    .A3(_057_),
    .B1(_085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__nor4_1 _390_ (.A(_057_),
    .B(_081_),
    .C(_082_),
    .D(_085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__and4b_1 _391_ (.A_N(_004_),
    .B(_164_),
    .C(net45),
    .D(_005_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__o211a_1 _392_ (.A1(_062_),
    .A2(_060_),
    .B1(_004_),
    .C1(_038_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__and4_1 _393_ (.A(net45),
    .B(net32),
    .C(net8),
    .D(net80),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__a21o_1 _394_ (.A1(net32),
    .A2(net76),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _395_ (.A_N(_090_),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o31a_1 _396_ (.A1(_063_),
    .A2(_089_),
    .A3(_088_),
    .B1(_092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__o31ai_1 _397_ (.A1(_063_),
    .A2(_088_),
    .A3(_089_),
    .B1(_092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__or4_4 _398_ (.A(_063_),
    .B(_088_),
    .C(_089_),
    .D(_092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__or4b_4 _399_ (.A(_093_),
    .B(_087_),
    .C(_086_),
    .D_N(_095_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__a2bb2o_4 _400_ (.A1_N(net73),
    .A2_N(_087_),
    .B1(_094_),
    .B2(_095_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__and3_1 _401_ (.A(_080_),
    .B(_097_),
    .C(_096_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__a21oi_2 _402_ (.A1(_096_),
    .A2(_097_),
    .B1(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__a211o_4 _403_ (.A1(_067_),
    .A2(_069_),
    .B1(_099_),
    .C1(_098_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__o211ai_2 _404_ (.A1(_099_),
    .A2(_098_),
    .B1(_067_),
    .C1(_069_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__nand2_4 _405_ (.A(_101_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__or2_4 _406_ (.A(_048_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__a21oi_1 _407_ (.A1(_046_),
    .A2(_073_),
    .B1(_072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__o21a_1 _408_ (.A1(_050_),
    .A2(_103_),
    .B1(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__xor2_1 _409_ (.A(_102_),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__nor2_1 _410_ (.A(net38),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__nand2_1 _411_ (.A(net38),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _412_ (.A(net35),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__o211a_1 _413_ (.A1(_106_),
    .A2(_108_),
    .B1(net42),
    .C1(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__a211oi_1 _414_ (.A1(net42),
    .A2(net32),
    .B1(_106_),
    .C1(_108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__nor2_1 _415_ (.A(_109_),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__and2_1 _416_ (.A(_078_),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nor2_1 _417_ (.A(_078_),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__nor2_1 _418_ (.A(_112_),
    .B(_113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__o22ai_4 _419_ (.A1(_084_),
    .A2(net63),
    .B1(_090_),
    .B2(net72),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__or4_4 _420_ (.A(_084_),
    .B(net72),
    .C(_090_),
    .D(net63),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__nand3_4 _421_ (.A(_114_),
    .B(_115_),
    .C(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__a21o_1 _422_ (.A1(_116_),
    .A2(_115_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__a21bo_1 _423_ (.A1(_080_),
    .A2(_097_),
    .B1_N(_096_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a21oi_1 _424_ (.A1(_117_),
    .A2(_118_),
    .B1(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__nand3_4 _425_ (.A(_117_),
    .B(_118_),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__nand2b_4 _426_ (.A_N(_120_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__o21ai_1 _427_ (.A1(_102_),
    .A2(_105_),
    .B1(_100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__xnor2_1 _428_ (.A(_122_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net18));
 sky130_fd_sc_hd__a22o_1 _429_ (.A1(net15),
    .A2(net32),
    .B1(net8),
    .B2(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__and4_1 _430_ (.A(net15),
    .B(net42),
    .C(net32),
    .D(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__inv_2 _431_ (.A(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__and4bb_1 _432_ (.A_N(_125_),
    .B_N(_107_),
    .C(net6),
    .D(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__or4bb_1 _433_ (.A(_125_),
    .B(_107_),
    .C_N(net6),
    .D_N(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__a32o_1 _434_ (.A1(net6),
    .A2(net39),
    .A3(_076_),
    .B1(_124_),
    .B2(_126_),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__and3_1 _435_ (.A(_109_),
    .B(_128_),
    .C(_129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__a21oi_1 _436_ (.A1(_128_),
    .A2(_129_),
    .B1(_109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__nor2_1 _437_ (.A(_130_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__xnor2_1 _438_ (.A(_112_),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__nand3_1 _439_ (.A(_115_),
    .B(_117_),
    .C(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__a21oi_1 _440_ (.A1(_115_),
    .A2(_117_),
    .B1(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__inv_2 _441_ (.A(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__nand2_1 _442_ (.A(_134_),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__or2_4 _443_ (.A(_122_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__or2_1 _444_ (.A(_100_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__o311a_4 _445_ (.A1(_102_),
    .A2(_104_),
    .A3(_122_),
    .B1(_139_),
    .C1(_121_),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__o31ai_4 _446_ (.A1(_138_),
    .A2(_103_),
    .A3(_050_),
    .B1(_140_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__xnor2_2 _447_ (.A(_137_),
    .B(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net19));
 sky130_fd_sc_hd__or2_1 _448_ (.A(net32),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__and2_1 _449_ (.A(net32),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__nand2_1 _450_ (.A(net32),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__o2111a_1 _451_ (.A1(_125_),
    .A2(_127_),
    .B1(_142_),
    .C1(_144_),
    .D1(net39),
 ...
 sky130_fd_sc_hd__a311o_1 _452_ (.A1(net39),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__and2b_1 _453_ (.A_N(_145_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__a21oi_1 _454_ (.A1(_112_),
    .A2(_132_),
    .B1(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__xnor2_1 _455_ (.A(_147_),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__a211oi_1 _456_ (.A1(_134_),
    .A2(_141_),
    .B1(_149_),
    .C1(_135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__o211a_4 _457_ (.A1(_135_),
    .A2(_141_),
    .B1(_149_),
    .C1(_134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__nor2_2 _458_ (.A(_150_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _461_ (.A1(net8),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__xor2_1 _462_ (.A(_152_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__xor2_2 _463_ (.A(_151_),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__a21bo_1 _464_ (.A1(_152_),
    .A2(_154_),
    .B1_N(_153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__a21o_1 _465_ (.A1(_155_),
    .A2(_151_),
    .B1(_156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__or3_1 _466_ (.A(_223_),
    .B(_226_),
    .C(_228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__and2_1 _467_ (.A(_229_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__a22o_1 _468_ (.A1(net37),
    .A2(net9),
    .B1(_176_),
    .B2(_182_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__and2_1 _469_ (.A(_184_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__or2_1 _470_ (.A(_181_),
    .B(net107),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__and2_1 _471_ (.A(_185_),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__a21oi_1 _472_ (.A1(net9),
    .A2(net35),
    .B1(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__nor2_1 _473_ (.A(_228_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net26));
 sky130_fd_sc_hd__clkbuf_1 rebuffer1 (.A(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__clkbuf_1 _475_ (.A(net68),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 output31 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(P[9]));
 sky130_fd_sc_hd__buf_2 fanout32 (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout35 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__buf_6 fanout36 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout38 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_2 fanout39 (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__buf_4 fanout40 (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__buf_8 fanout41 (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout42 (.A(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__buf_6 fanout43 (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout44 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__buf_1 fanout45 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 fanout46 (.A(net11),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__buf_6 fanout47 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_2 fanout48 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 fanout49 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__conb_1 mult8_2bits_1op_e17306_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net50));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer2 (.A(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer4 (.A(net47),
    ...
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer5 (.A(net54),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer6 (.A(net54),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer7 (.A(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer8 (.A(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__buf_6 rebuffer9 (.A(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__buf_2 rebuffer10 (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__buf_1 rebuffer12 (.A(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__clkbuf_2 rebuffer13 (.A(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer15 (.A(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__buf_1 rebuffer16 (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer17 (.A(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__clkbuf_1 clone18 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__clkbuf_2 rebuffer19 (.A(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer20 (.A(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer21 (.A(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__clkbuf_2 rebuffer22 (.A(_093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer23 (.A(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer24 (.A(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer25 (.A(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer26 (.A(net80),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer27 (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer28 (.A(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer29 (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__buf_1 rebuffer30 (.A(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer31 (.A(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer32 (.A(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer33 (.A(net82),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer35 (.A(net84),
    ...
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer36 (.A(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer37 (.A(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer38 (.A(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer57 (.A(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__clkbuf_2 rebuffer58 (.A(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__buf_1 rebuffer59 (.A(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
