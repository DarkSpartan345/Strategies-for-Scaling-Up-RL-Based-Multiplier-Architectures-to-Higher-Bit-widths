module SarsaNada_e10_1 (VPWR,
 ...
 sky130_fd_sc_hd__and4_2 _2_ (.A(B[0]),
    ...
    .VPWR(VPWR),
    .X(P[3]));
 sky130_fd_sc_hd__nor2_2 _3_ (.A(A[1]),
    .B(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__a22o_2 _4_ (.A1(B[0]),
    .A2(A[1]),
    .B1(B[1]),
    .B2(A[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__o21ba_2 _5_ (.A1(_0_),
    .A2(_1_),
    .B1_N(P[3]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(P[1]));
 sky130_fd_sc_hd__and3b_2 _6_ (.A_N(P[3]),
    .B(B[1]),
    .C(A[1]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(P[2]));
 sky130_fd_sc_hd__xor2_2 _7_ (.A(B[1]),
    .B(A[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
