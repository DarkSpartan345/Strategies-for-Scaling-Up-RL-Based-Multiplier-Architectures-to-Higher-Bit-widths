module mult8_2bits_1op_e17109 (VPWR,
 ...
 sky130_fd_sc_hd__and4_1 _231_ (.A(net45),
    .B(net46),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__nand4_2 _232_ (.A(net45),
    .B(net46),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__a22o_1 _233_ (.A1(net45),
    .A2(net35),
    .B1(net6),
    .B2(net47),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _237_ (.A(_168_),
    ...
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__and4_1 _238_ (.A(net15),
    .B(net48),
    .C(net41),
    .D(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _245_ (.A(net48),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__nand4_2 _246_ (.A(net48),
    .B(net2),
    .C(net45),
    .D(net46),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _247_ (.A(net48),
    ...
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__mux2_1 _248_ (.A0(net43),
    .A1(_179_),
    .S(_178_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _250_ (.A(_176_),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__xor2_1 _251_ (.A(_176_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _255_ (.A(_183_),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__and3_1 _256_ (.A(net43),
    .B(_183_),
    .C(_185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__nand3_1 _257_ (.A(net38),
    .B(net43),
    .C(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__or2_1 _258_ (.A(net38),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _263_ (.A(_178_),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__a311oi_2 _264_ (.A1(net43),
    .A2(_189_),
    .A3(_190_),
    .B1(_191_),
    .C1(_195_),
 ...
 sky130_fd_sc_hd__or2_1 _267_ (.A(_195_),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__or4_1 _268_ (.A(_176_),
    .B(_180_),
    .C(_195_),
    .D(_198_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _269_ (.A(_196_),
    ...
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__nor2_1 _270_ (.A(_196_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_2 _275_ (.A1(_188_),
    ...
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__or4_1 _276_ (.A(_188_),
    .B(_197_),
    .C(_202_),
    .D(_205_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__and3_1 _277_ (.A(_175_),
    .B(_207_),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211ai_4 _290_ (.A1(_218_),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__a211o_1 _291_ (.A1(_212_),
    .A2(_213_),
    .B1(_218_),
    .C1(_221_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand3b_2 _299_ (.A_N(_230_),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__a21bo_1 _300_ (.A1(_222_),
    .A2(_223_),
    .B1_N(_230_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _310_ (.A(net39),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__and3_1 _311_ (.A(net48),
    .B(net39),
    .C(_171_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _322_ (.A(_009_),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__a211o_1 _323_ (.A1(_210_),
    .A2(_212_),
    .B1(_021_),
    .C1(_022_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _327_ (.A1(_222_),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__nand2b_1 _328_ (.A_N(_026_),
    .B(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _331_ (.A(net37),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__or4_1 _332_ (.A(_170_),
    .B(_028_),
    .C(_029_),
    .D(_030_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o22ai_1 _333_ (.A1(_170_),
    ...
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__and2_1 _334_ (.A(_031_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _338_ (.A(net44),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__and4_1 _339_ (.A(net45),
    .B(net47),
    .C(net33),
    .D(net8),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _354_ (.A(_051_),
    ...
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__o21ba_1 _355_ (.A1(_051_),
    .A2(_052_),
    .B1_N(_050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__nand2_1 _356_ (.A(net42),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__a41o_1 _357_ (.A1(_173_),
    .A2(_013_),
    .A3(_014_),
    .A4(_033_),
    .B1(_034_),
 ...
 sky130_fd_sc_hd__and2b_1 _361_ (.A_N(_058_),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__xnor2_1 _362_ (.A(_057_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__xor2_1 _363_ (.A(_055_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _370_ (.A1(_042_),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__and3_1 _371_ (.A(_061_),
    .B(_067_),
    .C(_068_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _372_ (.A1(_067_),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__or3_1 _373_ (.A(_054_),
    .B(_069_),
    .C(_070_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _375_ (.A1(net13),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__a21oi_1 _376_ (.A1(_071_),
    .A2(_072_),
    .B1(_073_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__and3_1 _377_ (.A(_071_),
    .B(_072_),
    .C(_073_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _378_ (.A(_074_),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__xnor2_1 _379_ (.A(_053_),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _403_ (.A_N(_098_),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__or3_1 _404_ (.A(_051_),
    .B(_074_),
    .C(_075_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _408_ (.A(_102_),
    ...
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__xnor2_1 _409_ (.A(_100_),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _430_ (.A1(_099_),
    ...
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__xnor2_1 _431_ (.A(_125_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _447_ (.A1(_099_),
    ...
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__a31oi_4 _448_ (.A1(_102_),
    .A2(_104_),
    .A3(_141_),
    .B1(_142_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _458_ (.A1(_137_),
    ...
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__o211a_1 _459_ (.A1(_138_),
    .A2(_143_),
    .B1(_151_),
    .C1(_137_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__nor2_1 _460_ (.A(_152_),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _464_ (.A(_154_),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__xor2_1 _465_ (.A(_153_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _466_ (.A1(_154_),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__a21o_1 _467_ (.A1(_153_),
    .A2(_157_),
    .B1(_158_),
    .VGND(VGND),
    .VNB(VGND),
