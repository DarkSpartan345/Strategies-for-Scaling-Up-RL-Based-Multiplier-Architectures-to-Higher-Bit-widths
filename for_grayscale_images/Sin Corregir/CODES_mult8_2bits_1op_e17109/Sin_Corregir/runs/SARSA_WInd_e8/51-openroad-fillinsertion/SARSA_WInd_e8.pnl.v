module SARSA_WInd_e8 (VPWR,
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_3 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__clkbuf_1 _4_ (.A(pp0),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output7 (.A(net7),
    ...
    .VPWR(VPWR),
    .X(P[2]));
 sky130_fd_sc_hd__conb_1 SARSA_WInd_e8_8 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net8));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_3_25 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_3_31 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_3_43 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
