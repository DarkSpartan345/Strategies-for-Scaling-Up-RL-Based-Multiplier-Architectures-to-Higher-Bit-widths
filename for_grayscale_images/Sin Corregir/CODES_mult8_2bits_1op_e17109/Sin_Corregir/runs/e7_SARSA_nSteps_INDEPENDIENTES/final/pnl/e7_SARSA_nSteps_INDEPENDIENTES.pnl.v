module e7_SARSA_nSteps_INDEPENDIENTES (VPWR,
 ...
 sky130_fd_sc_hd__nor2_1 _0_ (.A(net1),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(pp2));
 sky130_fd_sc_hd__or2_1 _1_ (.A(net1),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__and2_1 _2_ (.A(net1),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output5 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(P[2]));
 sky130_fd_sc_hd__conb_1 e7_SARSA_nSteps_INDEPENDIENTES_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net6));
