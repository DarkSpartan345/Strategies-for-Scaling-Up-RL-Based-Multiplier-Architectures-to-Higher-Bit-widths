module SarsaNada_e6 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_1 _3_ (.A(net3),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_2_));
 sky130_fd_sc_hd__and4_1 _4_ (.A(net3),
    .B(net2),
    .C(net4),
    .D(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__o21ba_1 _5_ (.A1(net4),
    .A2(net1),
    .B1_N(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0_));
 sky130_fd_sc_hd__a21o_1 _6_ (.A1(net3),
    .A2(_0_),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__a22oi_1 _7_ (.A1(net3),
    .A2(net2),
    .B1(net4),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1_));
 sky130_fd_sc_hd__nor2_1 _8_ (.A(net8),
    .B(_1_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net6));
 sky130_fd_sc_hd__and3_1 _9_ (.A(net2),
    .B(net4),
    .C(_2_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_ef_sc_hd__decap_12 FILLER_8_38 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_8_50 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
