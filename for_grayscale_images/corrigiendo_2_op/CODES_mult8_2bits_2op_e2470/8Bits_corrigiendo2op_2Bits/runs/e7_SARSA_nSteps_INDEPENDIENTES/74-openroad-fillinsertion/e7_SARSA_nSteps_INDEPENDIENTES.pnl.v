module e7_SARSA_nSteps_INDEPENDIENTES (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__nand2_1 _3_ (.A(net3),
    ...
    .VPWR(VPWR),
    .Y(_2_));
 sky130_fd_sc_hd__nand4_2 _4_ (.A(net2),
    .B(net4),
    .C(net3),
    .D(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__inv_2 _5_ (.A(_0_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net8));
 sky130_fd_sc_hd__o21ai_1 _6_ (.A1(net2),
    .A2(net4),
    .B1(_0_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__or4bb_1 _7_ (.A(net4),
    .B(net3),
    .C_N(net1),
    .D_N(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__o211a_1 _8_ (.A1(net2),
    .A2(net4),
    .B1(_0_),
    .C1(_1_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 input3 (.A(B[0]),
    ...
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_2 input4 (.A(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
