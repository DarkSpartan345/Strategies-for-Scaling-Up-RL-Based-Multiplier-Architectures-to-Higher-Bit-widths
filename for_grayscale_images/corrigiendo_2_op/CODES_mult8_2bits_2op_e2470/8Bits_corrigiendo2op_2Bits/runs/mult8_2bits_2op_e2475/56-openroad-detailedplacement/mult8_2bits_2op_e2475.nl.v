module mult8_2bits_2op_e2475 (A,
 ...
 sky130_fd_sc_hd__nor3_1 _279_ (.A(_212_),
    ...
    .C(_214_),
    .Y(net23));
 sky130_fd_sc_hd__and4_1 _280_ (.A(net40),
    .B(net33),
    .C(net53),
    .D(net50),
    .X(_215_));
 sky130_fd_sc_hd__a21oi_1 _281_ (.A1(net40),
    ...
    .B1(_212_),
    .Y(_216_));
 sky130_fd_sc_hd__nor2_1 _282_ (.A(_215_),
    .B(_216_),
    .Y(net24));
 ...
 sky130_fd_sc_hd__or3b_1 _289_ (.A(_220_),
    ...
    .C_N(_222_),
    .X(_223_));
 sky130_fd_sc_hd__or4bb_1 _290_ (.A(_220_),
    .B(_221_),
    .C_N(_222_),
    .D_N(_215_),
    .X(_224_));
 sky130_fd_sc_hd__xor2_1 _291_ (.A(_215_),
    .B(_223_),
    .X(_225_));
 ...
 sky130_fd_sc_hd__nand2_1 _295_ (.A(net33),
    .B(net37),
    .Y(_228_));
 sky130_fd_sc_hd__nand2_1 _296_ (.A(net52),
    .B(net46),
    .Y(_229_));
 ...
 sky130_fd_sc_hd__nand2_1 _303_ (.A(net48),
    .B(_220_),
    .Y(_236_));
 sky130_fd_sc_hd__nand2_1 _304_ (.A(_224_),
    .B(_236_),
    .Y(_237_));
 sky130_fd_sc_hd__and3_1 _305_ (.A(_224_),
    .B(_235_),
    .C(_236_),
    .X(_238_));
 sky130_fd_sc_hd__xnor2_1 _306_ (.A(_234_),
    .B(_238_),
    .Y(_239_));
 sky130_fd_sc_hd__or2_1 _307_ (.A(_226_),
    .B(_239_),
    .X(_240_));
 ...
 sky130_fd_sc_hd__and2_1 _309_ (.A(_240_),
    .B(_241_),
    .X(_242_));
 sky130_fd_sc_hd__and3_1 _310_ (.A(net52),
    .B(net46),
    .C(_242_),
    .X(_243_));
 sky130_fd_sc_hd__a21oi_1 _311_ (.A1(net52),
    .A2(net46),
    .B1(_242_),
    .Y(_244_));
 ...
 sky130_fd_sc_hd__and4_1 _315_ (.A(net38),
    ...
    .D(net48),
    .X(_247_));
 sky130_fd_sc_hd__or4bb_1 _316_ (.A(net39),
    .B(net48),
    .C_N(net49),
    .D_N(net38),
    .X(_248_));
 sky130_fd_sc_hd__nand2_1 _317_ (.A(net39),
    .B(net48),
    .Y(_249_));
 sky130_fd_sc_hd__a21oi_1 _318_ (.A1(_248_),
    .A2(_249_),
    .B1(_247_),
    .Y(_250_));
 sky130_fd_sc_hd__and3_1 _319_ (.A(net50),
    .B(_217_),
    .C(_250_),
    .X(_251_));
 sky130_fd_sc_hd__xor2_1 _320_ (.A(_231_),
    .B(_250_),
    .X(_252_));
 sky130_fd_sc_hd__inv_2 _321_ (.A(_252_),
    .Y(_253_));
 sky130_fd_sc_hd__xor2_1 _322_ (.A(_237_),
    .B(_252_),
    .X(_254_));
 sky130_fd_sc_hd__a2bb2oi_1 _323_ (.A1_N(_230_),
    .A2_N(_233_),
    .B1(_234_),
    .B2(_238_),
    .Y(_255_));
 sky130_fd_sc_hd__or2_1 _324_ (.A(_254_),
    .B(_255_),
    .X(_256_));
 sky130_fd_sc_hd__xnor2_1 _325_ (.A(_254_),
    .B(_255_),
    .Y(_257_));
 sky130_fd_sc_hd__o21ai_1 _326_ (.A1(_240_),
    .A2(_257_),
    .B1(_256_),
    .Y(_258_));
 ...
 sky130_fd_sc_hd__a21o_1 _328_ (.A1(_237_),
    ...
    .B1(_259_),
    .X(_260_));
 sky130_fd_sc_hd__and2_1 _329_ (.A(_258_),
    .B(_260_),
    .X(_261_));
 ...
 sky130_fd_sc_hd__xnor2_1 _336_ (.A(_246_),
    .B(_267_),
    .Y(_268_));
 sky130_fd_sc_hd__and4bb_1 _337_ (.A_N(net52),
    .B_N(net45),
    .C(net46),
    .D(net41),
    .X(_269_));
 sky130_fd_sc_hd__a21o_1 _338_ (.A1(net52),
    .A2(net45),
    .B1(_269_),
    .X(_270_));
 ...
 sky130_fd_sc_hd__nand2b_1 _373_ (.A_N(net42),
    .B(net43),
    .Y(_031_));
 sky130_fd_sc_hd__or4bb_1 _374_ (.A(net52),
    .B(net42),
    .C_N(net43),
    .D_N(net40),
    .X(_032_));
 ...
 sky130_fd_sc_hd__and4_1 _376_ (.A(net40),
    ...
    .D(net42),
    .X(_034_));
 sky130_fd_sc_hd__a21oi_1 _377_ (.A1(_032_),
    .A2(_033_),
    .B1(_034_),
    .Y(_035_));
 sky130_fd_sc_hd__a211o_1 _378_ (.A1(_032_),
    .A2(_033_),
    .B1(_034_),
    .C1(_271_),
    .X(_036_));
 ...
 sky130_fd_sc_hd__o31a_1 _383_ (.A1(_247_),
    ...
    .B1(_040_),
    .X(_041_));
 sky130_fd_sc_hd__or4_1 _384_ (.A(_247_),
    .B(_251_),
    .C(_261_),
    .D(_040_),
    .X(_042_));
 ...
 sky130_fd_sc_hd__and3b_1 _386_ (.A_N(_041_),
    ...
    .C(_026_),
    .X(_044_));
 sky130_fd_sc_hd__xor2_1 _387_ (.A(_026_),
    .B(_043_),
    .X(_045_));
 sky130_fd_sc_hd__and2b_1 _388_ (.A_N(_014_),
    .B(_045_),
    .X(_046_));
 sky130_fd_sc_hd__xnor2_1 _389_ (.A(_014_),
    .B(_045_),
    .Y(_047_));
 ...
 sky130_fd_sc_hd__xor2_1 _397_ (.A(_050_),
    .B(_053_),
    .X(_054_));
 sky130_fd_sc_hd__and4_1 _398_ (.A(net41),
    .B(net42),
    .C(_264_),
    .D(_036_),
    .X(_055_));
 sky130_fd_sc_hd__xnor2_1 _399_ (.A(_054_),
    .B(_055_),
    .Y(_056_));
 sky130_fd_sc_hd__or3_1 _400_ (.A(_030_),
    .B(_039_),
    .C(_056_),
    .X(_057_));
 ...
 sky130_fd_sc_hd__xor2_1 _414_ (.A(_066_),
    .B(_070_),
    .X(_071_));
 sky130_fd_sc_hd__or2_1 _415_ (.A(_024_),
    .B(_071_),
    .X(_072_));
 ...
 sky130_fd_sc_hd__o21ai_1 _423_ (.A1(_041_),
    ...
    .B1(_079_),
    .Y(_080_));
 sky130_fd_sc_hd__or3_1 _424_ (.A(_041_),
    .B(_044_),
    .C(_079_),
    .X(_081_));
 sky130_fd_sc_hd__nand2_1 _425_ (.A(_080_),
    .B(_081_),
    .Y(_082_));
 sky130_fd_sc_hd__a21o_1 _426_ (.A1(_047_),
    .A2(_048_),
    .B1(_046_),
    .X(_083_));
 ...
 sky130_fd_sc_hd__nand2b_1 _439_ (.A_N(_094_),
    .B(_089_),
    .Y(_095_));
 sky130_fd_sc_hd__xnor2_1 _440_ (.A(_089_),
    .B(_094_),
    .Y(_096_));
 sky130_fd_sc_hd__a2bb2o_1 _441_ (.A1_N(_050_),
    .A2_N(_053_),
    .B1(_054_),
    .B2(_055_),
    .X(_097_));
 sky130_fd_sc_hd__nand2_1 _442_ (.A(_096_),
    .B(_097_),
    .Y(_098_));
 sky130_fd_sc_hd__xor2_1 _443_ (.A(_096_),
    .B(_097_),
    .X(_099_));
 sky130_fd_sc_hd__nand2b_1 _444_ (.A_N(_057_),
    .B(_099_),
    .Y(_100_));
 sky130_fd_sc_hd__xnor2_1 _445_ (.A(_057_),
    .B(_099_),
    .Y(_101_));
 ...
 sky130_fd_sc_hd__nand2b_1 _457_ (.A_N(_072_),
    .B(_112_),
    .Y(_113_));
 sky130_fd_sc_hd__xnor2_1 _458_ (.A(_072_),
    .B(_112_),
    .Y(_114_));
 ...
 sky130_fd_sc_hd__xnor2_1 _460_ (.A(_101_),
    .B(_114_),
    .Y(_116_));
 sky130_fd_sc_hd__or2_1 _461_ (.A(_088_),
    .B(_116_),
    .X(_117_));
 sky130_fd_sc_hd__nand2_1 _462_ (.A(_088_),
    .B(_116_),
    .Y(_118_));
 sky130_fd_sc_hd__and2_1 _463_ (.A(_117_),
    .B(_118_),
    .X(_119_));
 sky130_fd_sc_hd__nor3_1 _464_ (.A(_075_),
    .B(_078_),
    .C(_119_),
    .Y(_120_));
 ...
 sky130_fd_sc_hd__o21a_1 _471_ (.A1(_093_),
    ...
    .B1(_095_),
    .X(_126_));
 sky130_fd_sc_hd__a21oi_1 _472_ (.A1(_098_),
    .A2(_100_),
    .B1(_126_),
    .Y(_127_));
 sky130_fd_sc_hd__and3_1 _473_ (.A(_098_),
    ...
    .C(_126_),
    .X(_128_));
 sky130_fd_sc_hd__nor2_1 _474_ (.A(_127_),
    .B(_128_),
    .Y(_129_));
 ...
 sky130_fd_sc_hd__nand2_1 _479_ (.A(_129_),
    .B(_133_),
    .Y(_134_));
 sky130_fd_sc_hd__xor2_1 _480_ (.A(_129_),
    .B(_133_),
    .X(_135_));
 sky130_fd_sc_hd__nand2_1 _481_ (.A(_124_),
    .B(_135_),
    .Y(_136_));
 sky130_fd_sc_hd__xnor2_1 _482_ (.A(_124_),
    .B(_135_),
    .Y(_137_));
 sky130_fd_sc_hd__nand3_1 _483_ (.A(_115_),
    ...
    .C(_137_),
    .Y(_138_));
 sky130_fd_sc_hd__a21oi_1 _484_ (.A1(_115_),
    .A2(_117_),
    .B1(_137_),
    .Y(_139_));
 ...
 sky130_fd_sc_hd__o21ai_1 _488_ (.A1(_080_),
    ...
    .B1(_121_),
    .Y(_143_));
 sky130_fd_sc_hd__a21o_1 _489_ (.A1(_083_),
    .A2(_142_),
    .B1(_143_),
    .X(_144_));
 ...
 sky130_fd_sc_hd__xnor2_1 _508_ (.A(_155_),
    .B(_160_),
    .Y(_162_));
 sky130_fd_sc_hd__a21oi_1 _509_ (.A1(_134_),
    .A2(_136_),
    .B1(_162_),
    .Y(_163_));
 sky130_fd_sc_hd__nand3_1 _510_ (.A(_134_),
    .B(_136_),
    .C(_162_),
    .Y(_164_));
 sky130_fd_sc_hd__and2b_1 _511_ (.A_N(_163_),
    .B(_164_),
    .X(_165_));
 sky130_fd_sc_hd__a21oi_1 _512_ (.A1(_138_),
    .A2(_144_),
    .B1(_139_),
    .Y(_166_));
 sky130_fd_sc_hd__xnor2_1 _513_ (.A(_165_),
    .B(_166_),
    .Y(net18));
 ...
 sky130_fd_sc_hd__nand2_1 _531_ (.A(_181_),
    .B(_183_),
    .Y(_184_));
 sky130_fd_sc_hd__a211o_1 _532_ (.A1(_139_),
    .A2(_164_),
    .B1(_163_),
    .C1(_143_),
    .X(_185_));
 ...
 sky130_fd_sc_hd__nor2_1 _535_ (.A(_186_),
    .B(_187_),
    .Y(_188_));
 sky130_fd_sc_hd__xnor2_1 _536_ (.A(_184_),
    .B(_188_),
    .Y(net19));
 ...
 sky130_fd_sc_hd__xor2_1 _555_ (.A(_203_),
    .B(_205_),
    .X(_206_));
 sky130_fd_sc_hd__xor2_1 _556_ (.A(_202_),
    .B(_206_),
    .X(net21));
 ...
 sky130_fd_sc_hd__a41o_1 _558_ (.A1(net15),
    ...
    .B1(_207_),
    .X(_208_));
 sky130_fd_sc_hd__a21o_1 _559_ (.A1(_202_),
    .A2(_206_),
    .B1(_208_),
    .X(net22));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout37 (.A(net5),
    .X(net37));
 sky130_fd_sc_hd__buf_2 fanout38 (.A(net4),
    .X(net38));
 ...
 sky130_fd_sc_hd__buf_1 fanout47 (.A(net13),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_4 fanout48 (.A(net12),
    .X(net48));
