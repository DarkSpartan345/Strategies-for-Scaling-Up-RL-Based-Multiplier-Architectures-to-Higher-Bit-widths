module mult8_2bits_2op_e24963 (A,
    B,
    P);
 input [7:0] A;
 input [7:0] B;
 ...
 sky130_fd_sc_hd__inv_2 _263_ (.A(net49),
    .Y(_201_));
 sky130_fd_sc_hd__inv_2 _264_ (.A(net40),
    .Y(_202_));
 ...
 sky130_fd_sc_hd__a31oi_1 _268_ (.A1(_201_),
    ...
    .B1(net48),
    .Y(_205_));
 sky130_fd_sc_hd__and4_1 _269_ (.A(net49),
    .B(net34),
    .C(net48),
    .D(net41),
    .X(_206_));
 ...
 sky130_fd_sc_hd__or3_1 _275_ (.A(_207_),
    ...
    .C(_209_),
    .X(_210_));
 sky130_fd_sc_hd__and3_1 _276_ (.A(net49),
    .B(net41),
    .C(net47),
    .X(_211_));
 sky130_fd_sc_hd__nor2_1 _277_ (.A(net47),
    .B(net46),
    .Y(_212_));
 sky130_fd_sc_hd__a21o_1 _278_ (.A1(net41),
    ...
    .B1(net49),
    .X(_213_));
 sky130_fd_sc_hd__or3b_1 _279_ (.A(_211_),
    .B(_212_),
    .C_N(_213_),
    .X(_214_));
 sky130_fd_sc_hd__and4bb_1 _280_ (.A_N(_211_),
    ...
    .D(_206_),
    .X(_215_));
 sky130_fd_sc_hd__xor2_1 _281_ (.A(_206_),
    .B(_214_),
    .X(_216_));
 ...
 sky130_fd_sc_hd__nand2_1 _288_ (.A(net48),
    .B(net39),
    .Y(_222_));
 sky130_fd_sc_hd__mux2_1 _289_ (.A0(_222_),
    .A1(net48),
    .S(_207_),
    .X(_223_));
 sky130_fd_sc_hd__xor2_1 _290_ (.A(_220_),
    .B(_223_),
    .X(_224_));
 sky130_fd_sc_hd__a21oi_1 _291_ (.A1(net41),
    ...
    .B1(_211_),
    .Y(_225_));
 sky130_fd_sc_hd__a21o_1 _292_ (.A1(net46),
    .A2(_211_),
    .B1(_215_),
    .X(_226_));
 sky130_fd_sc_hd__a211oi_2 _293_ (.A1(net46),
    .A2(_211_),
    .B1(_215_),
    .C1(_225_),
    .Y(_227_));
 sky130_fd_sc_hd__xnor2_1 _294_ (.A(_224_),
    .B(_227_),
    .Y(_228_));
 sky130_fd_sc_hd__or2_1 _295_ (.A(_217_),
    .B(_228_),
    .X(_229_));
 ...
 sky130_fd_sc_hd__and4_1 _305_ (.A(net39),
    ...
    .D(net46),
    .X(_238_));
 sky130_fd_sc_hd__or4bb_1 _306_ (.A(net40),
    .B(net46),
    .C_N(net47),
    .D_N(net39),
    .X(_239_));
 sky130_fd_sc_hd__nand2_1 _307_ (.A(net40),
    .B(net46),
    .Y(_240_));
 sky130_fd_sc_hd__a21oi_1 _308_ (.A1(_239_),
    .A2(_240_),
    .B1(_238_),
    .Y(_241_));
 sky130_fd_sc_hd__and3_1 _309_ (.A(net10),
    ...
    .C(_241_),
    .X(_242_));
 sky130_fd_sc_hd__xnor2_1 _310_ (.A(_221_),
    .B(_241_),
    .Y(_243_));
 sky130_fd_sc_hd__xnor2_1 _311_ (.A(_226_),
    .B(_243_),
    .Y(_244_));
 sky130_fd_sc_hd__a2bb2oi_1 _312_ (.A1_N(_220_),
    .A2_N(_223_),
    .B1(_224_),
    .B2(_227_),
    .Y(_245_));
 sky130_fd_sc_hd__or2_1 _313_ (.A(_244_),
    .B(_245_),
    .X(_246_));
 sky130_fd_sc_hd__xnor2_1 _314_ (.A(_244_),
    .B(_245_),
    .Y(_247_));
 sky130_fd_sc_hd__o21a_1 _315_ (.A1(_229_),
    .A2(_247_),
    .B1(_246_),
    .X(_248_));
 ...
 sky130_fd_sc_hd__and2b_1 _318_ (.A_N(_248_),
    .B(_250_),
    .X(_251_));
 sky130_fd_sc_hd__xnor2_1 _319_ (.A(_248_),
    .B(_250_),
    .Y(_252_));
 ...
 sky130_fd_sc_hd__nand2_1 _324_ (.A(_255_),
    .B(_256_),
    .Y(_257_));
 sky130_fd_sc_hd__xnor2_1 _325_ (.A(_252_),
    .B(_257_),
    .Y(_258_));
 sky130_fd_sc_hd__and2b_1 _326_ (.A_N(_237_),
    .B(_258_),
    .X(_259_));
 sky130_fd_sc_hd__xnor2_1 _327_ (.A(_237_),
    .B(_258_),
    .Y(_260_));
 ...
 sky130_fd_sc_hd__and2b_1 _338_ (.A_N(_007_),
    .B(_260_),
    .X(_008_));
 sky130_fd_sc_hd__xnor2_1 _339_ (.A(_260_),
    .B(_007_),
    .Y(_009_));
 ...
 sky130_fd_sc_hd__nand2_1 _341_ (.A(_232_),
    .B(_010_),
    .Y(_011_));
 sky130_fd_sc_hd__xnor2_1 _342_ (.A(_009_),
    .B(_011_),
    .Y(net29));
 sky130_fd_sc_hd__a31oi_1 _343_ (.A1(_252_),
    .A2(_255_),
    .A3(_256_),
    .B1(_259_),
    .Y(_012_));
 ...
 sky130_fd_sc_hd__or3_1 _346_ (.A(_208_),
    ...
    .C(_014_),
    .X(_015_));
 sky130_fd_sc_hd__and3_1 _347_ (.A(net47),
    .B(net37),
    .C(net38),
    .X(_016_));
 sky130_fd_sc_hd__a21oi_1 _348_ (.A1(net47),
    .A2(net37),
    .B1(net38),
    .Y(_017_));
 ...
 sky130_fd_sc_hd__o31a_1 _367_ (.A1(_238_),
    ...
    .B1(_035_),
    .X(_036_));
 sky130_fd_sc_hd__or4_1 _368_ (.A(_238_),
    .B(_242_),
    .C(_251_),
    .D(_035_),
    .X(_037_));
 sky130_fd_sc_hd__and2b_1 _369_ (.A_N(_036_),
    .B(_037_),
    .X(_038_));
 sky130_fd_sc_hd__and2_1 _370_ (.A(_022_),
    .B(_038_),
    .X(_039_));
 sky130_fd_sc_hd__xor2_1 _371_ (.A(_022_),
    .B(_038_),
    .X(_040_));
 sky130_fd_sc_hd__and2b_1 _372_ (.A_N(_012_),
    .B(_040_),
    .X(_041_));
 sky130_fd_sc_hd__xnor2_1 _373_ (.A(_012_),
    .B(_040_),
    .Y(_042_));
 sky130_fd_sc_hd__a31o_1 _374_ (.A1(_232_),
    .A2(_009_),
    .A3(_010_),
    .B1(_008_),
    .X(_043_));
 sky130_fd_sc_hd__xor2_1 _375_ (.A(_042_),
    .B(_043_),
    .X(net30));
 sky130_fd_sc_hd__nand2_1 _376_ (.A(net45),
    .B(net38),
    .Y(_044_));
 sky130_fd_sc_hd__nand2_1 _377_ (.A(net40),
    .B(net43),
    .Y(_045_));
 ...
 sky130_fd_sc_hd__nand2_1 _386_ (.A(_052_),
    .B(_053_),
    .Y(_054_));
 sky130_fd_sc_hd__nand2_1 _387_ (.A(net47),
    .B(net36),
    .Y(_055_));
 ...
 sky130_fd_sc_hd__xnor2_1 _393_ (.A(_056_),
    .B(_059_),
    .Y(_061_));
 sky130_fd_sc_hd__and2_1 _394_ (.A(net46),
    .B(_016_),
    .X(_062_));
 sky130_fd_sc_hd__nor2_1 _395_ (.A(net33),
    .B(_062_),
    .Y(_063_));
 sky130_fd_sc_hd__a21o_1 _396_ (.A1(net46),
    .A2(net37),
    .B1(_016_),
    .X(_064_));
 ...
 sky130_fd_sc_hd__xnor2_1 _406_ (.A(_044_),
    .B(_072_),
    .Y(_074_));
 sky130_fd_sc_hd__o21a_1 _407_ (.A1(_036_),
    .A2(_039_),
    .B1(_074_),
    .X(_075_));
 sky130_fd_sc_hd__nor3_1 _408_ (.A(_036_),
    ...
    .C(_074_),
    .Y(_076_));
 sky130_fd_sc_hd__or2_2 _409_ (.A(_075_),
    .B(_076_),
    .X(_077_));
 sky130_fd_sc_hd__a21oi_2 _410_ (.A1(_042_),
    .A2(_043_),
    .B1(_041_),
    .Y(_078_));
 ...
 sky130_fd_sc_hd__xnor2_1 _427_ (.A(_052_),
    .B(_092_),
    .Y(_094_));
 sky130_fd_sc_hd__and4bb_1 _428_ (.A_N(net12),
    .B_N(net36),
    .C(net35),
    .D(net47),
    .X(_095_));
 sky130_fd_sc_hd__nand2_1 _429_ (.A(net12),
    .B(net35),
    .Y(_096_));
 sky130_fd_sc_hd__nand4_1 _430_ (.A(net11),
    ...
    .D(net36),
    .Y(_097_));
 sky130_fd_sc_hd__a31o_1 _431_ (.A1(net12),
    .A2(net36),
    .A3(_097_),
    .B1(_095_),
    .X(_098_));
 ...
 sky130_fd_sc_hd__o21ai_1 _467_ (.A1(_075_),
    ...
    .B1(_112_),
    .Y(_133_));
 sky130_fd_sc_hd__o31ai_4 _468_ (.A1(_077_),
    .A2(_078_),
    .A3(_113_),
    .B1(_133_),
    .Y(_134_));
 ...
 sky130_fd_sc_hd__nor2_1 _479_ (.A(_142_),
    .B(_143_),
    .Y(_144_));
 sky130_fd_sc_hd__or3_1 _480_ (.A(_084_),
    .B(_086_),
    .C(_118_),
    .X(_145_));
 ...
 sky130_fd_sc_hd__o21ai_1 _483_ (.A1(_099_),
    ...
    .B1(_145_),
    .Y(_148_));
 sky130_fd_sc_hd__xnor2_1 _484_ (.A(_145_),
    .B(_147_),
    .Y(_149_));
 sky130_fd_sc_hd__nand2_1 _485_ (.A(_144_),
    .B(_149_),
    .Y(_150_));
 sky130_fd_sc_hd__xnor2_1 _486_ (.A(_144_),
    .B(_149_),
    .Y(_151_));
 sky130_fd_sc_hd__nand3_1 _487_ (.A(_125_),
    .B(_127_),
    .C(_151_),
    .Y(_152_));
 ...
 sky130_fd_sc_hd__a21oi_1 _491_ (.A1(_131_),
    ...
    .B1(_130_),
    .Y(_156_));
 sky130_fd_sc_hd__xnor2_1 _492_ (.A(_155_),
    .B(_156_),
    .Y(net19));
 ...
 sky130_fd_sc_hd__o21a_1 _515_ (.A1(_134_),
    ...
    .B1(_178_),
    .X(_179_));
 sky130_fd_sc_hd__o211ai_2 _516_ (.A1(_134_),
    .A2(_176_),
    .B1(_178_),
    .C1(_175_),
    .Y(_180_));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout39 (.A(net4),
    .X(net39));
 sky130_fd_sc_hd__buf_2 fanout40 (.A(net3),
    .X(net40));
