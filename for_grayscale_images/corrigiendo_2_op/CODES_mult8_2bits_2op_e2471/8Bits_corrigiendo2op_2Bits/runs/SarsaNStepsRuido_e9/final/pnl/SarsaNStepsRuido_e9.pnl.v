module SarsaNStepsRuido_e9 (VPWR,
 ...
 sky130_fd_sc_hd__nand3_1 _3_ (.A(net1),
    .B(net3),
    .C(net2),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4_ (.A1(net3),
    ...
    .VPWR(VPWR),
    .X(_2_));
 sky130_fd_sc_hd__o211a_1 _5_ (.A1(net3),
    .A2(net4),
    .B1(_1_),
    .C1(_2_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _6_ (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__nand2_1 _7_ (.A(net2),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__a21oi_1 _8_ (.A1(_1_),
    .A2(_0_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__fill_2 FILLER_6_26 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_6_37 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
