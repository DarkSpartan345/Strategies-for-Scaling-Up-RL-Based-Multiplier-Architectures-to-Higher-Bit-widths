module SarsanstepsNada_e8 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_3 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__conb_1 SarsanstepsNada_e8_5 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net5));
 sky130_fd_sc_hd__conb_1 SarsanstepsNada_e8_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net6));
 ...
 sky130_fd_sc_hd__clkbuf_1 input1 (.A(A[1]),
    ...
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output3 (.A(net3),
    ...
    .VPWR(VPWR),
    .X(P[2]));
 sky130_fd_sc_hd__conb_1 SarsanstepsNada_e8_4 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net4));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_3_15 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_3_22 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
