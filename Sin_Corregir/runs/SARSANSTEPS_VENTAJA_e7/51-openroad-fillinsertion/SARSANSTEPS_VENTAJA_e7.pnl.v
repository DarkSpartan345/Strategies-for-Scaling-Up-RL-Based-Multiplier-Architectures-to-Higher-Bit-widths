module SARSANSTEPS_VENTAJA_e7 (VPWR,
 ...
 sky130_fd_sc_hd__mux2_1 _0_ (.A0(net1),
    .A1(net2),
    .S(net3),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _1_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__xnor2_1 _2_ (.A(net1),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output7 (.A(net7),
    ...
    .VPWR(VPWR),
    .X(P[2]));
 sky130_fd_sc_hd__conb_1 SARSANSTEPS_VENTAJA_e7_8 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net8));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_3_17 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_3_29 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
