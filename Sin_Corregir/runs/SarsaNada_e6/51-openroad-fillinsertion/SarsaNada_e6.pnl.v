module SarsaNada_e6 (VPWR,
 ...
 sky130_fd_sc_hd__and2b_1 _2_ (.A_N(net2),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(pp1));
 sky130_fd_sc_hd__nand4_1 _3_ (.A(net3),
    .B(net2),
    .C(net4),
    .D(net1),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _4_ (.A(_0_),
    ...
    .VPWR(VPWR),
    .Y(net8));
 sky130_fd_sc_hd__a22o_1 _5_ (.A1(net3),
    .A2(net2),
    .B1(net4),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__and2_1 _6_ (.A(_0_),
    .B(_1_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _7_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_1 _8_ (.A(pp1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
