module mult4_SARSA_WInd_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
 ...
 sky130_fd_sc_hd__and2_2 _23_ (.A(B[0]),
    .B(A[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\mul_ll.pp0 ));
 sky130_fd_sc_hd__and4_2 _24_ (.A(A[0]),
    .B(B[1]),
    .C(A[1]),
    .D(B[2]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_00_));
 sky130_fd_sc_hd__a22oi_2 _25_ (.A1(B[1]),
    .A2(A[1]),
    .B1(B[2]),
    .B2(A[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__and4bb_2 _26_ (.A_N(_00_),
    .B_N(_01_),
    .C(B[0]),
    .D(A[2]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_02_));
 sky130_fd_sc_hd__o2bb2a_2 _27_ (.A1_N(B[0]),
    .A2_N(A[2]),
    .B1(_00_),
    .B2(_01_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__nor2_2 _28_ (.A(_02_),
    .B(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[2]));
 sky130_fd_sc_hd__nand2_2 _29_ (.A(B[2]),
    .B(A[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__nand2_2 _30_ (.A(B[3]),
    .B(A[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_05_));
 sky130_fd_sc_hd__and3_2 _31_ (.A(B[1]),
    .B(A[1]),
    .C(B[3]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__a22o_2 _32_ (.A1(A[1]),
    .A2(B[3]),
    .B1(A[3]),
    .B2(B[1]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__a21bo_2 _33_ (.A1(A[3]),
    .A2(_06_),
    .B1_N(_07_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_08_));
 sky130_fd_sc_hd__xor2_2 _34_ (.A(_04_),
    .B(_08_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_09_));
 sky130_fd_sc_hd__and4_2 _35_ (.A(A[0]),
    .B(B[1]),
    .C(A[2]),
    .D(B[3]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_10_));
 sky130_fd_sc_hd__nand4_2 _36_ (.A(A[0]),
    .B(B[1]),
    .C(A[2]),
    .D(B[3]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_11_));
 sky130_fd_sc_hd__a22o_2 _37_ (.A1(B[1]),
    .A2(A[2]),
    .B1(B[3]),
    .B2(A[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__o211a_2 _38_ (.A1(_00_),
    .A2(_02_),
    .B1(_11_),
    .C1(_12_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_2 _39_ (.A1(_10_),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__nor2_2 _40_ (.A(_09_),
    .B(_13_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_15_));
 sky130_fd_sc_hd__a21oi_2 _41_ (.A1(_11_),
    .A2(_15_),
    .B1(_14_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(P[4]));
 sky130_fd_sc_hd__and2_2 _42_ (.A(A[2]),
    .B(B[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_16_));
 sky130_fd_sc_hd__a32o_2 _43_ (.A1(B[2]),
    .A2(A[2]),
    .A3(_07_),
    .B1(_06_),
    .B2(A[3]),
    ...
    .VPWR(VPWR),
    .X(_17_));
 sky130_fd_sc_hd__nor2_2 _44_ (.A(_16_),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _45_ (.A(_16_),
    ...
    .VPWR(VPWR),
    .X(_19_));
 sky130_fd_sc_hd__or2_2 _46_ (.A(_18_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__xnor2_2 _47_ (.A(_14_),
    .B(_20_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[5]));
 sky130_fd_sc_hd__a221o_2 _48_ (.A1(_09_),
    .A2(_10_),
    .B1(_13_),
    .B2(_16_),
    .C1(_19_),
    ...
    .VPWR(VPWR),
    .X(_21_));
 sky130_fd_sc_hd__and3_2 _49_ (.A(B[3]),
    .B(A[3]),
    .C(_21_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(P[7]));
 sky130_fd_sc_hd__xnor2_2 _50_ (.A(_05_),
    .B(_21_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[6]));
 sky130_fd_sc_hd__a211oi_2 _51_ (.A1(_11_),
    .A2(_12_),
    .B1(_00_),
    .C1(_02_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_22_));
 sky130_fd_sc_hd__nor2_2 _52_ (.A(_13_),
    .B(_22_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[3]));
 sky130_fd_sc_hd__buf_2 _53_ (.A(\mul_ll.pp0 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(P[0]));
 sky130_fd_sc_hd__buf_2 _54_ (.A(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
