module e9_SARSA_nSteps_INDEPENDIENTES (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__and2_1 _1_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(pp2));
 sky130_fd_sc_hd__clkbuf_1 _3_ (.A(pp0),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(B[0]),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__buf_1 input3 (.A(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output6 (.A(net6),
    ...
    .VPWR(VPWR),
    .X(P[2]));
 sky130_fd_sc_hd__conb_1 e9_SARSA_nSteps_INDEPENDIENTES_7 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net7));
