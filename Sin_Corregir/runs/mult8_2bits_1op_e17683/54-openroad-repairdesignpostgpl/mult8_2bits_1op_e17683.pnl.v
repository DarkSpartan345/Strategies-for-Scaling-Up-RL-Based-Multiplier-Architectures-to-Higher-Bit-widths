module mult8_2bits_1op_e17683 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_1 _229_ (.A(net13),
    ...
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__and4_1 _230_ (.A(net49),
    .B(net11),
    .C(net47),
    .D(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__and3b_1 _231_ (.A_N(_164_),
    .B(net45),
    .C(net2),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _233_ (.A(net38),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__nand4_2 _234_ (.A(net39),
    .B(net47),
    .C(net37),
    .D(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__and4_1 _235_ (.A(net47),
    .B(net37),
    .C(_166_),
    .D(_168_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__a31o_1 _236_ (.A1(net47),
    .A2(net37),
    .A3(_168_),
    .B1(_166_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _238_ (.A(_165_),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__a22o_1 _239_ (.A1(net39),
    .A2(net47),
    .B1(net37),
    .B2(net9),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _241_ (.A(net45),
    ...
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__nand2_1 _242_ (.A(net49),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _245_ (.A(_178_),
    ...
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__a22oi_1 _246_ (.A1(net49),
    .A2(net11),
    .B1(net47),
    .B2(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _260_ (.A(net11),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__nand4_2 _261_ (.A(net11),
    .B(net47),
    .C(net35),
    .D(net6),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _266_ (.A(net49),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__nand4_2 _267_ (.A(net49),
    .B(net2),
    .C(net42),
    .D(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__a22o_1 _268_ (.A1(net49),
    .A2(net42),
    .B1(net44),
    .B2(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _271_ (.A(_202_),
    ...
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__nand2_1 _272_ (.A(net39),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__mux2_1 _273_ (.A0(net45),
    .A1(_205_),
    .S(_168_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _274_ (.A(_175_),
    ...
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__xor2_1 _275_ (.A(_175_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _277_ (.A(_208_),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__xnor2_1 _278_ (.A(_208_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__or3_1 _279_ (.A(_183_),
    .B(_184_),
    .C(_205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__o311a_1 _280_ (.A1(_172_),
    .A2(_179_),
    .A3(_211_),
    .B1(_212_),
    .C1(_210_),
 ...
 sky130_fd_sc_hd__nor2_1 _283_ (.A(_214_),
    ...
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__xnor2_1 _284_ (.A(_213_),
    .B(_216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__xor2_1 _285_ (.A(_204_),
    .B(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__xnor2_1 _286_ (.A(_198_),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _298_ (.A(_000_),
    ...
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__a22o_1 _299_ (.A1(_204_),
    .A2(_217_),
    .B1(_218_),
    .B2(_198_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _300_ (.A(net45),
    ...
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__and3_1 _301_ (.A(net45),
    .B(net36),
    .C(_194_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _317_ (.A(_018_),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__xnor2_1 _318_ (.A(_018_),
    .B(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__xor2_1 _319_ (.A(_010_),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__or2_1 _320_ (.A(_002_),
    .B(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__xor2_1 _321_ (.A(_002_),
    .B(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _322_ (.A1(_219_),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__xnor2_1 _323_ (.A(_024_),
    .B(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_1 _327_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__or4_1 _328_ (.A(_199_),
    .B(_026_),
    .C(_027_),
    .D(_028_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__o22ai_1 _329_ (.A1(_199_),
    .A2(_026_),
    .B1(_027_),
    .B2(_028_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _350_ (.A(_048_),
    ...
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__a2bb2o_1 _351_ (.A1_N(_219_),
    .A2_N(_225_),
    .B1(_002_),
    .B2(_022_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _360_ (.A_N(_060_),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__xnor2_1 _361_ (.A(_059_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _363_ (.A1(_036_),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__or2_1 _364_ (.A(net34),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _378_ (.A1(_074_),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__or2_1 _379_ (.A(_077_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__xnor2_1 _380_ (.A(_055_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net32));
 sky130_fd_sc_hd__and4_1 _381_ (.A(net35),
    .B(net42),
    .C(net43),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nand4_2 _382_ (.A(net35),
    .B(net42),
    .C(net43),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__a22o_1 _383_ (.A1(net35),
    .A2(net15),
    .B1(net43),
    .B2(net6),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _386_ (.A(_084_),
    ...
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__nand4_1 _387_ (.A(net41),
    .B(_202_),
    .C(_014_),
    .D(_015_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _390_ (.A(net38),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__or3b_1 _391_ (.A(_089_),
    .B(_090_),
    .C_N(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31oi_2 _392_ (.A1(_061_),
    ...
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__and4_1 _393_ (.A(_061_),
    .B(_087_),
    .C(_088_),
    .D(_091_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__and4_1 _394_ (.A(net46),
    .B(_196_),
    .C(_006_),
    .D(_007_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__o211a_1 _395_ (.A1(_064_),
    .A2(_067_),
    .B1(_005_),
    .C1(_040_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31ai_2 _398_ (.A1(_068_),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__or4_1 _399_ (.A(_068_),
    .B(_094_),
    .C(_095_),
    .D(_097_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__or4bb_1 _400_ (.A(_092_),
    .B(_093_),
    .C_N(_098_),
    .D_N(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__a2bb2o_1 _401_ (.A1_N(_092_),
    .A2_N(_093_),
    .B1(_098_),
    .B2(_099_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _402_ (.A(_086_),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__a21oi_1 _403_ (.A1(_100_),
    .A2(_101_),
    .B1(_086_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _406_ (.A(_104_),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__nor2_1 _407_ (.A(_052_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_1 _408_ (.A1(_048_),
    ...
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__a21o_1 _409_ (.A1(_054_),
    .A2(_107_),
    .B1(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__xor2_1 _410_ (.A(_106_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _412_ (.A(net40),
    ...
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__and3_1 _413_ (.A(net35),
    .B(net40),
    .C(_082_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _414_ (.A1(_110_),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__a211oi_1 _415_ (.A1(net43),
    .A2(net33),
    .B1(_110_),
    .C1(_112_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_1 _420_ (.A1_N(_090_),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__or4bb_1 _421_ (.A(_090_),
    .B(_092_),
    .C_N(_096_),
    .D_N(_098_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _428_ (.A(_124_),
    ...
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a21o_1 _429_ (.A1(_106_),
    .A2(_109_),
    .B1(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__xnor2_1 _430_ (.A(_127_),
    .B(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _431_ (.A1(net42),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__and4_1 _432_ (.A(net42),
    .B(net43),
    .C(net33),
    .D(net8),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _444_ (.A(_139_),
    ...
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__and4bb_1 _445_ (.A_N(_104_),
    .B_N(_105_),
    .C(_124_),
    .D(_125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__a221o_1 _446_ (.A1(_104_),
    .A2(_124_),
    .B1(_143_),
    .B2(_108_),
    .C1(_126_),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__a31o_1 _447_ (.A1(_054_),
    .A2(_107_),
    .A3(_143_),
    .B1(_144_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _469_ (.A(net1),
    ...
    .VPWR(VPWR),
    .X(\mul_ll.mul_ll.pp1 ));
 sky130_fd_sc_hd__and2_1 _470_ (.A(net49),
    .B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout46 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__clkbuf_4 fanout47 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
