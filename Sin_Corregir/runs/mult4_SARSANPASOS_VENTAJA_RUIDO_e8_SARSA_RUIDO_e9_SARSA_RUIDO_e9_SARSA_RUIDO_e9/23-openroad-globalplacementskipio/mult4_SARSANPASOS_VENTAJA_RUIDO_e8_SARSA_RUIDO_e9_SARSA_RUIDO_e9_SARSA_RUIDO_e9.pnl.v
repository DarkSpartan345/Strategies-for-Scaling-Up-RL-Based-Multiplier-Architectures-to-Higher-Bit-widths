module mult4_SARSANPASOS_VENTAJA_RUIDO_e8_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
 ...
 sky130_fd_sc_hd__and2_2 _26_ (.A(A[0]),
    .B(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\mul_ll.pp1 ));
 sky130_fd_sc_hd__nand2_2 _27_ (.A(B[0]),
    .B(A[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__and3_2 _28_ (.A(A[0]),
    .B(B[1]),
    .C(A[1]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_01_));
 sky130_fd_sc_hd__a22o_2 _29_ (.A1(B[1]),
    .A2(A[1]),
    .B1(B[2]),
    .B2(A[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_02_));
 sky130_fd_sc_hd__a21bo_2 _30_ (.A1(B[2]),
    .A2(_01_),
    .B1_N(_02_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__xor2_2 _31_ (.A(_00_),
    .B(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _32_ (.A(B[3]),
    ...
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__nand4_2 _33_ (.A(B[1]),
    .B(A[1]),
    .C(B[3]),
    .D(A[3]),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_2 _34_ (.A1(A[1]),
    ...
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__and2_2 _35_ (.A(B[2]),
    .B(A[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__a21oi_2 _36_ (.A1(_05_),
    .A2(_06_),
    .B1(_07_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_08_));
 sky130_fd_sc_hd__and3_2 _37_ (.A(_05_),
    .B(_06_),
    .C(_07_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_09_));
 sky130_fd_sc_hd__nor2_2 _38_ (.A(_08_),
    .B(_09_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__nand2_2 _39_ (.A(A[2]),
    .B(B[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_11_));
 sky130_fd_sc_hd__and3_2 _40_ (.A(A[2]),
    .B(B[3]),
    .C(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__nand3_2 _41_ (.A(A[2]),
    .B(B[3]),
    .C(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_13_));
 sky130_fd_sc_hd__a22o_2 _42_ (.A1(B[1]),
    .A2(A[2]),
    .B1(B[3]),
    .B2(A[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__a32o_2 _43_ (.A1(B[0]),
    .A2(A[2]),
    .A3(_02_),
    .B1(_01_),
    .B2(B[2]),
    ...
    .VPWR(VPWR),
    .X(_15_));
 sky130_fd_sc_hd__and3_2 _44_ (.A(_13_),
    .B(_14_),
    .C(_15_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_16_));
 sky130_fd_sc_hd__nor2_2 _45_ (.A(_12_),
    .B(_16_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_17_));
 sky130_fd_sc_hd__nor3_2 _46_ (.A(_08_),
    .B(_09_),
    .C(_13_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_18_));
 sky130_fd_sc_hd__xnor2_2 _47_ (.A(_10_),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[4]));
 sky130_fd_sc_hd__a21boi_2 _48_ (.A1(_06_),
    .A2(_07_),
    .B1_N(_05_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_19_));
 sky130_fd_sc_hd__and2_2 _49_ (.A(_11_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__nor2_2 _50_ (.A(_11_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_21_));
 sky130_fd_sc_hd__or2_2 _51_ (.A(_20_),
    .B(_21_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_22_));
 sky130_fd_sc_hd__o21a_2 _52_ (.A1(_12_),
    .A2(_16_),
    .B1(_10_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_23_));
 sky130_fd_sc_hd__xnor2_2 _53_ (.A(_22_),
    .B(_23_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[5]));
 sky130_fd_sc_hd__a311o_2 _54_ (.A1(A[2]),
    .A2(B[3]),
    .A3(_16_),
    .B1(_18_),
    .C1(_21_),
    ...
    .VPWR(VPWR),
    .X(_24_));
 sky130_fd_sc_hd__and3_2 _55_ (.A(B[3]),
    .B(A[3]),
    .C(_24_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(P[7]));
 sky130_fd_sc_hd__xnor2_2 _56_ (.A(_04_),
    .B(_24_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[6]));
 sky130_fd_sc_hd__a21oi_2 _57_ (.A1(_13_),
    .A2(_14_),
    .B1(_15_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_25_));
 sky130_fd_sc_hd__nor2_2 _58_ (.A(_16_),
    .B(_25_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(P[3]));
 sky130_fd_sc_hd__buf_2 _59_ (.A(B[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(P[0]));
 sky130_fd_sc_hd__buf_2 _60_ (.A(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
