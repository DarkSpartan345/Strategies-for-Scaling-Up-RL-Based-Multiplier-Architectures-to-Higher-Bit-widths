module SarsaNStepsRuido_e9 (VPWR,
 ...
 sky130_fd_sc_hd__and3_1 _3_ (.A(net1),
    .B(net3),
    .C(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__a21oi_1 _4_ (.A1(net3),
    .A2(net2),
    .B1(net1),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _5_ (.A(_1_),
    ...
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__and4_1 _6_ (.A(net1),
    .B(net3),
    .C(net2),
    .D(net4),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _7_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_0_));
 sky130_fd_sc_hd__o21ba_1 _8_ (.A1(_1_),
    .A2(_0_),
    .B1_N(net7),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__fill_2 FILLER_31_405 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_32_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_35_405 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_36_6 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
