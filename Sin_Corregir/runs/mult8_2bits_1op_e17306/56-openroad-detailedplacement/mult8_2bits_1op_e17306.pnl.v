module mult8_2bits_1op_e17306 (VPWR,
 ...
 sky130_fd_sc_hd__and4_1 _230_ (.A(net46),
    .B(net47),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__nand4_2 _231_ (.A(net46),
    .B(net47),
    .C(net34),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__a22o_1 _232_ (.A1(net46),
    .A2(net34),
    .B1(net6),
    .B2(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__and4_1 _233_ (.A(net9),
    .B(net32),
    .C(_162_),
    .D(_163_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _237_ (.A(net40),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__nand4_2 _238_ (.A(net40),
    .B(net49),
    .C(net41),
    .D(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _244_ (.A(net49),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__nand4_2 _245_ (.A(net49),
    .B(net2),
    .C(net46),
    .D(net47),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _246_ (.A(net49),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__mux2_1 _247_ (.A0(net44),
    .A1(_177_),
    .S(_176_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _250_ (.A(_174_),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__a22o_1 _251_ (.A1(net49),
    .A2(net46),
    .B1(net47),
    .B2(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _254_ (.A(_181_),
    ...
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__and3_1 _255_ (.A(net44),
    .B(_181_),
    .C(_183_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _256_ (.A(net37),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__or2_1 _257_ (.A(net37),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _266_ (.A(_193_),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__or4_1 _267_ (.A(_174_),
    .B(_178_),
    .C(_193_),
    .D(_196_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__nor2_1 _268_ (.A(_194_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__nor2_1 _269_ (.A(_194_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _272_ (.A1(_187_),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__o31a_1 _273_ (.A1(_186_),
    .A2(_195_),
    .A3(_200_),
    .B1(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__o31ai_1 _274_ (.A1(_186_),
    .A2(_195_),
    .A3(_200_),
    .B1(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__or4_1 _275_ (.A(_186_),
    .B(_195_),
    .C(_200_),
    .D(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__and3_1 _276_ (.A(_173_),
    .B(_205_),
    .C(_206_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor3_1 _278_ (.A(_167_),
    ...
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__or3_1 _279_ (.A(_167_),
    .B(_207_),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _289_ (.A1(_216_),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__inv_2 _290_ (.A(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _298_ (.A1(_226_),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__or3b_1 _299_ (.A(_220_),
    .B(_229_),
    .C_N(_222_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _300_ (.A1(_221_),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and2_1 _301_ (.A(_000_),
    .B(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _308_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__and3_1 _309_ (.A(net49),
    .B(net38),
    .C(_169_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _311_ (.A1(_008_),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__or3_1 _312_ (.A(_008_),
    .B(_009_),
    .C(_010_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _322_ (.A(_020_),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nand2_1 _323_ (.A(_221_),
    .B(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xnor2_1 _324_ (.A(_022_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_2 _326_ (.A1(net36),
    ...
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__and4_1 _327_ (.A(net36),
    .B(net40),
    .C(net41),
    .D(net4),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand4_1 _328_ (.A(net36),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__or4_1 _329_ (.A(_168_),
    .B(_024_),
    .C(_025_),
    .D(_026_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _335_ (.A(net45),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__and4_1 _336_ (.A(net46),
    .B(net48),
    .C(net33),
    .D(net8),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _337_ (.A1(net11),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nand2b_1 _338_ (.A_N(_035_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__xnor2_2 _339_ (.A(_034_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _340_ (.A1(_164_),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__xnor2_1 _341_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _349_ (.A(_046_),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__nand2_1 _350_ (.A(_220_),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__o211a_2 _351_ (.A1(_000_),
    .A2(_022_),
    .B1(_049_),
    .C1(_020_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__xor2_1 _352_ (.A(_048_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _357_ (.A1(_169_),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__o31a_1 _358_ (.A1(_168_),
    .A2(_024_),
    .A3(_025_),
    .B1(_027_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _359_ (.A_N(_056_),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__xnor2_1 _360_ (.A(_055_),
    .B(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21boi_1 _363_ (.A1(net33),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__o21a_1 _364_ (.A1(net33),
    .A2(_161_),
    .B1(_061_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _368_ (.A1(_038_),
    ...
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__or3_2 _369_ (.A(_059_),
    .B(_065_),
    .C(_066_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _370_ (.A1(_065_),
    ...
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__nand4_2 _371_ (.A(net43),
    .B(net34),
    .C(_067_),
    .D(_068_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__a22o_1 _372_ (.A1(net43),
    .A2(net34),
    .B1(_067_),
    .B2(_068_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _384_ (.A(net38),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__and2_1 _385_ (.A(_031_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _388_ (.A_N(_084_),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__o31a_1 _389_ (.A1(_057_),
    .A2(_081_),
    .A3(_082_),
    .B1(_085_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4b_1 _391_ (.A_N(_004_),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__o211a_1 _392_ (.A1(_060_),
    .A2(_062_),
    .B1(_004_),
    .C1(_038_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31ai_1 _397_ (.A1(_063_),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__or4_1 _398_ (.A(_063_),
    .B(_088_),
    .C(_089_),
    .D(_092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__or4b_1 _399_ (.A(_086_),
    .B(_087_),
    .C(_093_),
    .D_N(_095_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__a2bb2o_1 _400_ (.A1_N(_086_),
    .A2_N(_087_),
    .B1(_094_),
    .B2(_095_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _401_ (.A(_080_),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__a21oi_1 _402_ (.A1(_096_),
    .A2(_097_),
    .B1(_080_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _403_ (.A1(_067_),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__o211ai_1 _404_ (.A1(_098_),
    .A2(_099_),
    .B1(_067_),
    .C1(_069_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__nand2_1 _405_ (.A(_100_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__or2_1 _406_ (.A(_048_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_4 _419_ (.A1(_084_),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__or4_1 _420_ (.A(_084_),
    .B(_086_),
    .C(_090_),
    .D(_093_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__nand3_1 _421_ (.A(_114_),
    .B(_115_),
    .C(_116_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _424_ (.A1(_117_),
    ...
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__nand3_1 _425_ (.A(_117_),
    .B(_118_),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__nand2b_1 _426_ (.A_N(_120_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _442_ (.A(_134_),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__or2_1 _443_ (.A(_102_),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _444_ (.A(_100_),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__o311a_1 _445_ (.A1(_102_),
    .A2(_104_),
    .A3(_122_),
    .B1(_139_),
    .C1(_121_),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__o31ai_2 _446_ (.A1(_050_),
    .A2(_103_),
    .A3(_138_),
    .B1(_140_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__xnor2_1 _447_ (.A(_137_),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_1 _456_ (.A1(_134_),
    ...
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__o211a_1 _457_ (.A1(_135_),
    .A2(_141_),
    .B1(_149_),
    .C1(_134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__nor2_1 _458_ (.A(_150_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _462_ (.A(_152_),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__xor2_1 _463_ (.A(_151_),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _464_ (.A1(_152_),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__a21o_1 _465_ (.A1(_151_),
    .A2(_155_),
    .B1(_156_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _473_ (.A(_228_),
    ...
    .VPWR(VPWR),
    .Y(net26));
 sky130_fd_sc_hd__clkbuf_1 _475_ (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout39 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkbuf_4 fanout40 (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
