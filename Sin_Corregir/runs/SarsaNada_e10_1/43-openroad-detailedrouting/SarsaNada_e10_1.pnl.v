module SarsaNada_e10_1 (VPWR,
 ...
 sky130_fd_sc_hd__and4_1 _2_ (.A(net3),
    .B(net2),
    .C(net4),
    .D(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__nor2_1 _3_ (.A(net2),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__a22o_1 _4_ (.A1(net3),
    .A2(net2),
    .B1(net4),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__o21ba_1 _5_ (.A1(_0_),
    .A2(_1_),
    .B1_N(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__and3b_1 _6_ (.A_N(net8),
    .B(net4),
    .C(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__xor2_1 _7_ (.A(net4),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(B[0]),
    ...
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__dlymetal6s2s_1 input4 (.A(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
