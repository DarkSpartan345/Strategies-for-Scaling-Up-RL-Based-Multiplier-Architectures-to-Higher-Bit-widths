module mult4_SARSA_RUIDO_e9_SARSANPASOS_VENTAJA_RUIDO_e8_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_2 _26_ (.A(B[0]),
    ...
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__a21oi_2 _27_ (.A1(B[1]),
    .A2(A[1]),
    .B1(B[2]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__and3_2 _28_ (.A(B[1]),
    .B(B[2]),
    .C(A[1]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_02_));
 sky130_fd_sc_hd__nor2_2 _29_ (.A(_01_),
    .B(_02_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_03_));
 sky130_fd_sc_hd__xnor2_2 _30_ (.A(_00_),
    .B(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_2 _40_ (.A1(B[1]),
    ...
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__o21bai_2 _41_ (.A1(_00_),
    .A2(_01_),
    .B1_N(_02_),
    .VGND(VGND),
    .VNB(VGND),
