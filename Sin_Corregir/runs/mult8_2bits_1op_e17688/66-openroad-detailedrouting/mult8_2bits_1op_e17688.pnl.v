module mult8_2bits_1op_e17688 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__inv_2 _220_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_154_));
 sky130_fd_sc_hd__inv_2 _221_ (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__and4_1 _222_ (.A(net44),
    .B(net11),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__nand4_2 _223_ (.A(net44),
    .B(net11),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__a22o_1 _224_ (.A1(net11),
    .A2(net35),
    .B1(net6),
    .B2(net44),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__and4_1 _225_ (.A(net9),
    .B(net33),
    .C(_157_),
    .D(_158_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__inv_2 _226_ (.A(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__a22o_1 _227_ (.A1(net9),
    .A2(net33),
    .B1(_157_),
    .B2(_158_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__and2_1 _228_ (.A(_160_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__inv_2 _229_ (.A(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__and4_1 _230_ (.A(net41),
    .B(net46),
    .C(net15),
    .D(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__nand4_2 _231_ (.A(net15),
    .B(net46),
    .C(net41),
    .D(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__a22o_1 _232_ (.A1(net15),
    .A2(net46),
    .B1(net41),
    .B2(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__and4_1 _233_ (.A(net13),
    .B(net37),
    .C(_165_),
    .D(_166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__a22oi_1 _234_ (.A1(net13),
    .A2(net37),
    .B1(_165_),
    .B2(_166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__or2_1 _235_ (.A(_167_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__and3_2 _236_ (.A(net2),
    .B(net44),
    .C(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__nand3_1 _237_ (.A(net46),
    .B(net43),
    .C(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__a21o_1 _238_ (.A1(net46),
    .A2(net43),
    .B1(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__nand4_2 _239_ (.A(net37),
    .B(net44),
    .C(_171_),
    .D(_172_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__a211oi_2 _240_ (.A1(net46),
    .A2(_170_),
    .B1(_155_),
    .C1(_154_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__and4_1 _241_ (.A(net37),
    .B(net4),
    .C(net44),
    .D(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__a22o_1 _242_ (.A1(net4),
    .A2(net44),
    .B1(net11),
    .B2(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__and2b_1 _243_ (.A_N(_175_),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__xnor2_2 _244_ (.A(_174_),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__nor2_1 _245_ (.A(_173_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__and4_1 _246_ (.A(net37),
    .B(net46),
    .C(net43),
    .D(_170_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _248_ (.A1(_171_),
    ...
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__a21oi_1 _249_ (.A1(_174_),
    .A2(_176_),
    .B1(_175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__and2b_1 _250_ (.A_N(_183_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__xnor2_1 _251_ (.A(_182_),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__a22o_1 _252_ (.A1(net37),
    .A2(net44),
    .B1(_171_),
    .B2(_172_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__a21oi_1 _253_ (.A1(net2),
    .A2(net44),
    .B1(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__or4bb_4 _254_ (.A(_170_),
    .B(_187_),
    .C_N(net37),
    .D_N(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and3b_2 _255_ (.A_N(_188_),
    .B(_186_),
    .C(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a221o_1 _256_ (.A1(_179_),
    .A2(_185_),
    .B1(_189_),
    .B2(net43),
    .C1(_184_),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__and3_1 _257_ (.A(net4),
    .B(net43),
    .C(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__a21o_1 _258_ (.A1(net4),
    .A2(net43),
    .B1(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__nand2b_1 _259_ (.A_N(_191_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__xor2_2 _260_ (.A(_190_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__or2_1 _261_ (.A(_169_),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__xnor2_2 _262_ (.A(_169_),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__xnor2_2 _263_ (.A(_163_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__nand2_1 _264_ (.A(net46),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__nand2_1 _265_ (.A(_173_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__xnor2_1 _266_ (.A(_173_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__a21o_1 _267_ (.A1(_189_),
    .A2(_199_),
    .B1(_179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__xor2_2 _268_ (.A(_185_),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__and3_1 _269_ (.A(net1),
    .B(net42),
    .C(_202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__nand2_1 _270_ (.A(net45),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__xnor2_2 _271_ (.A(_198_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__a31oi_2 _272_ (.A1(net45),
    .A2(net36),
    .A3(_205_),
    .B1(_203_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_206_));
 sky130_fd_sc_hd__or2_1 _273_ (.A(_197_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__xnor2_2 _274_ (.A(_197_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__xnor2_1 _275_ (.A(_204_),
    .B(_205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__nand2_1 _276_ (.A(net13),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__xnor2_1 _277_ (.A(_189_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__xnor2_1 _278_ (.A(_210_),
    .B(_211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__and3_1 _279_ (.A(net9),
    .B(net36),
    .C(_212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__a31oi_1 _280_ (.A1(net13),
    .A2(net1),
    .A3(_211_),
    .B1(_213_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__nand2b_1 _281_ (.A_N(_214_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__xor2_1 _282_ (.A(_208_),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__o21ai_1 _283_ (.A1(_163_),
    .A2(_196_),
    .B1(_195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__nor2_1 _284_ (.A(net43),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__and3_1 _285_ (.A(net43),
    .B(_157_),
    .C(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__o211ai_4 _286_ (.A1(_217_),
    .A2(_218_),
    .B1(net45),
    .C1(net57),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__a211o_1 _287_ (.A1(net45),
    .A2(net57),
    .B1(_217_),
    .C1(_218_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__nand3_2 _288_ (.A(_159_),
    .B(_219_),
    .C(_000_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__a21o_1 _289_ (.A1(_219_),
    .A2(_000_),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__nand2_1 _290_ (.A(_001_),
    .B(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__nor2_1 _291_ (.A(net39),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _292_ (.A(_165_),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and2_1 _293_ (.A(net38),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__o21ai_2 _294_ (.A1(_004_),
    .A2(_005_),
    .B1(_006_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__or3_1 _295_ (.A(_004_),
    .B(_005_),
    .C(_006_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__and3_1 _296_ (.A(_008_),
    .B(_007_),
    .C(_167_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a21oi_1 _297_ (.A1(_007_),
    .A2(_008_),
    .B1(_167_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__nor2_1 _298_ (.A(_009_),
    .B(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__a21o_1 _299_ (.A1(_190_),
    .A2(_192_),
    .B1(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nand2_1 _300_ (.A(_011_),
    .B(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_013_));
 sky130_fd_sc_hd__xnor2_2 _301_ (.A(_011_),
    .B(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__xor2_2 _302_ (.A(_003_),
    .B(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__nor2_1 _303_ (.A(_216_),
    .B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__xnor2_1 _304_ (.A(_216_),
    .B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__o21ai_1 _305_ (.A1(_208_),
    .A2(_215_),
    .B1(_207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__xnor2_1 _306_ (.A(_017_),
    .B(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net30));
 sky130_fd_sc_hd__nand2_1 _307_ (.A(net2),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__a22oi_1 _308_ (.A1(net38),
    .A2(net15),
    .B1(net60),
    .B2(net4),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _309_ (.A(net38),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__or4_4 _310_ (.A(_019_),
    .B(_164_),
    .C(_020_),
    .D(_021_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__o22ai_1 _311_ (.A1(net49),
    .A2(_019_),
    .B1(_020_),
    .B2(_021_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__and2_4 _312_ (.A(_022_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__o2111a_1 _313_ (.A1(_004_),
    .A2(_005_),
    .B1(_006_),
    .C1(_022_),
    .D1(_023_),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__xnor2_1 _314_ (.A(_007_),
    .B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__xnor2_1 _315_ (.A(_009_),
    .B(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__and3_1 _316_ (.A(_157_),
    .B(net6),
    .C(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__and4_1 _317_ (.A(net45),
    .B(net11),
    .C(net33),
    .D(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a22o_1 _318_ (.A1(net11),
    .A2(net33),
    .B1(net8),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__and2b_1 _319_ (.A_N(_029_),
    .B(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__xnor2_2 _320_ (.A(_028_),
    .B(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__or2_1 _321_ (.A(_219_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__xnor2_1 _322_ (.A(_219_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__or4bb_4 _323_ (.A(_160_),
    .B(_032_),
    .C_N(_000_),
    .D_N(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__xnor2_1 _324_ (.A(_001_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__nor2_1 _325_ (.A(_027_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__xor2_1 _326_ (.A(_027_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nand2_1 _327_ (.A(net13),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__xor2_1 _328_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__o21a_1 _329_ (.A1(_003_),
    .A2(_014_),
    .B1(_013_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__or2_1 _330_ (.A(_040_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__xnor2_1 _331_ (.A(_040_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__o2bb2a_1 _332_ (.A1_N(_216_),
    .A2_N(_015_),
    .B1(_197_),
    .B2(_206_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__o32a_4 _333_ (.A1(_208_),
    .A2(_215_),
    .A3(_017_),
    .B1(_044_),
    .B2(_016_),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__xor2_2 _334_ (.A(_043_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__o21ai_1 _335_ (.A1(_043_),
    .A2(_045_),
    .B1(_042_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__a41o_1 _336_ (.A1(_167_),
    .A2(_007_),
    .A3(_008_),
    .A4(_024_),
    .B1(_025_),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__o21ai_1 _337_ (.A1(net38),
    .A2(net52),
    .B1(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__a21oi_1 _338_ (.A1(net38),
    .A2(net48),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__and2b_1 _339_ (.A_N(_021_),
    .B(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__and2b_1 _340_ (.A_N(_050_),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__xnor2_2 _341_ (.A(_049_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__xnor2_1 _342_ (.A(_047_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__a21o_1 _343_ (.A1(_028_),
    .A2(_030_),
    .B1(_029_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__a21oi_1 _344_ (.A1(net33),
    .A2(_156_),
    .B1(_155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__o21a_1 _345_ (.A1(net33),
    .A2(_156_),
    .B1(_055_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _346_ (.A(_054_),
    ...
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__xnor2_2 _347_ (.A(_054_),
    .B(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__a21oi_1 _348_ (.A1(_033_),
    .A2(_035_),
    .B1(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__and3_1 _349_ (.A(_035_),
    .B(_033_),
    .C(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__or3_4 _350_ (.A(_053_),
    .B(_059_),
    .C(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__o21ai_1 _351_ (.A1(_059_),
    .A2(_060_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__nand4_1 _352_ (.A(net53),
    .B(net35),
    .C(_061_),
    .D(_062_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__a22o_1 _353_ (.A1(net54),
    .A2(net36),
    .B1(_061_),
    .B2(_062_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__a31o_1 _354_ (.A1(net13),
    .A2(net36),
    .A3(_038_),
    .B1(_037_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__and3_1 _355_ (.A(_063_),
    .B(_064_),
    .C(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__nand3_1 _356_ (.A(_063_),
    .B(_064_),
    .C(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__a21oi_1 _357_ (.A1(_063_),
    .A2(_064_),
    .B1(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__or2_1 _358_ (.A(_066_),
    .B(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__xnor2_1 _359_ (.A(_046_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net32));
 sky130_fd_sc_hd__and4_1 _360_ (.A(net15),
    .B(net60),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__nand4_4 _361_ (.A(net15),
    .B(net60),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__a22o_1 _362_ (.A1(net15),
    .A2(net35),
    .B1(net6),
    .B2(net60),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__and4_1 _363_ (.A(net13),
    .B(net33),
    .C(_071_),
    .D(_072_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__a22oi_2 _364_ (.A1(net13),
    .A2(net33),
    .B1(_071_),
    .B2(_072_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__nor2_1 _365_ (.A(_073_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__a221o_1 _366_ (.A1(_009_),
    .A2(net39),
    .B1(_025_),
    .B2(_052_),
    .C1(_051_),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__a21o_1 _367_ (.A1(net38),
    .A2(net47),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__and4_1 _368_ (.A(net38),
    .B(net4),
    .C(net39),
    .D(net50),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__and3b_1 _369_ (.A_N(_078_),
    .B(net39),
    .C(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__xor2_2 _370_ (.A(_079_),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__o221ai_4 _371_ (.A1(_155_),
    .A2(_001_),
    .B1(_033_),
    .B2(_058_),
    .C1(_057_),
    ...
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__and4_1 _372_ (.A(net12),
    .B(net33),
    .C(net8),
    .D(_156_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__a21o_1 _373_ (.A1(net33),
    .A2(_156_),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__or3b_1 _374_ (.A(_155_),
    .B(_082_),
    .C_N(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__xnor2_2 _375_ (.A(_081_),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _376_ (.A(_080_),
    ...
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__xnor2_2 _377_ (.A(_085_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__xor2_2 _378_ (.A(_075_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__and2_1 _379_ (.A(_061_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__nor2_1 _380_ (.A(_088_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__xnor2_2 _381_ (.A(_088_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__inv_2 _382_ (.A(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__or2_4 _383_ (.A(_069_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__o31a_1 _384_ (.A1(_040_),
    .A2(_041_),
    .A3(_068_),
    .B1(_067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__o21ai_4 _385_ (.A1(_045_),
    .A2(_093_),
    .B1(_094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__xnor2_2 _386_ (.A(_091_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net18));
 sky130_fd_sc_hd__nor2_1 _387_ (.A(net39),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__nand2_1 _388_ (.A(net40),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__and3_1 _389_ (.A(net35),
    .B(net39),
    .C(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__o211a_1 _390_ (.A1(_096_),
    .A2(_098_),
    .B1(net60),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__a211oi_1 _391_ (.A1(net53),
    .A2(net34),
    .B1(_096_),
    .C1(_098_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__nor2_1 _392_ (.A(_099_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__and2_1 _393_ (.A(_073_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__nor2_1 _394_ (.A(_073_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__or2_1 _395_ (.A(_102_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__a31o_1 _396_ (.A1(net39),
    .A2(_076_),
    .A3(_077_),
    .B1(_078_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__a31o_1 _397_ (.A1(net12),
    .A2(_081_),
    .A3(_083_),
    .B1(_082_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__nand2_1 _398_ (.A(_105_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__xnor2_1 _399_ (.A(_105_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__or2_1 _400_ (.A(_104_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__xnor2_2 _401_ (.A(_104_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__o31a_1 _402_ (.A1(_073_),
    .A2(_087_),
    .A3(_074_),
    .B1(_086_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__or2_4 _403_ (.A(_110_),
    .B(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__xnor2_2 _404_ (.A(_111_),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__a21o_1 _405_ (.A1(_095_),
    .A2(_092_),
    .B1(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__xnor2_1 _406_ (.A(_113_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net19));
 sky130_fd_sc_hd__a22o_1 _407_ (.A1(net15),
    .A2(net56),
    .B1(net8),
    .B2(net53),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__and4_1 _408_ (.A(net15),
    .B(net53),
    .C(net55),
    .D(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__inv_2 _409_ (.A(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__and4bb_1 _410_ (.A_N(_116_),
    .B_N(_097_),
    .C(net6),
    .D(_115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__or4bb_1 _411_ (.A(_116_),
    .B(_097_),
    .C_N(net6),
    .D_N(_115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a32o_1 _412_ (.A1(net6),
    .A2(net40),
    .A3(_071_),
    .B1(_115_),
    .B2(_117_),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__and3_1 _413_ (.A(_099_),
    .B(_119_),
    .C(_120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__a21oi_1 _414_ (.A1(_119_),
    .A2(_120_),
    .B1(_099_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__nor2_1 _415_ (.A(_121_),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__xnor2_1 _416_ (.A(_102_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__nand3_1 _417_ (.A(_107_),
    .B(_109_),
    .C(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__a21oi_2 _418_ (.A1(_107_),
    .A2(_109_),
    .B1(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__inv_2 _419_ (.A(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__nand2_1 _420_ (.A(_125_),
    .B(_127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__or2_4 _421_ (.A(_113_),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__a211o_1 _422_ (.A1(_110_),
    .A2(net58),
    .B1(_088_),
    .C1(_089_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__o311a_4 _423_ (.A1(_091_),
    .A2(_094_),
    .A3(_113_),
    .B1(_130_),
    .C1(_112_),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__o31ai_4 _424_ (.A1(_045_),
    .A2(_129_),
    .A3(_093_),
    .B1(_131_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__xnor2_1 _425_ (.A(_128_),
    .B(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net20));
 sky130_fd_sc_hd__or2_1 _426_ (.A(net55),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__and2_1 _427_ (.A(net55),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__nand2_1 _428_ (.A(net55),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__o2111a_1 _429_ (.A1(_116_),
    .A2(_118_),
    .B1(_133_),
    .C1(_135_),
    .D1(net40),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__a311o_1 _430_ (.A1(net40),
    .A2(_133_),
    .A3(_135_),
    .B1(_116_),
    .C1(_118_),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__and2b_1 _431_ (.A_N(_136_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__a21oi_1 _432_ (.A1(_102_),
    .A2(_123_),
    .B1(_121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__xnor2_1 _433_ (.A(_138_),
    .B(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__a211oi_1 _434_ (.A1(_125_),
    .A2(net61),
    .B1(_140_),
    .C1(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__o211a_1 _435_ (.A1(_126_),
    .A2(_132_),
    .B1(_140_),
    .C1(_125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__nor2_2 _436_ (.A(_141_),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net21));
 sky130_fd_sc_hd__and3_1 _437_ (.A(net40),
    .B(_073_),
    .C(_101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__and2_1 _438_ (.A(_121_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__nand3_1 _439_ (.A(net40),
    .B(net8),
    .C(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__o211a_1 _440_ (.A1(net8),
    .A2(_134_),
    .B1(_145_),
    .C1(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__o31a_1 _441_ (.A1(_136_),
    .A2(_143_),
    .A3(_144_),
    .B1(_146_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__or4_1 _442_ (.A(_136_),
    .B(_143_),
    .C(_144_),
    .D(_146_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__and2b_1 _443_ (.A_N(_147_),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__o2111a_1 _444_ (.A1(_126_),
    .A2(_132_),
    .B1(_140_),
    .C1(_149_),
    .D1(_125_),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__xor2_2 _445_ (.A(_149_),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__a311o_1 _446_ (.A1(net40),
    .A2(net8),
    .A3(_134_),
    .B1(_147_),
    .C1(_150_),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__xnor2_1 _447_ (.A(_209_),
    .B(_214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net28));
 sky130_fd_sc_hd__and2_1 _448_ (.A(net1),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\mul_ll.mul_ll.pp1 ));
 sky130_fd_sc_hd__and2_1 _449_ (.A(net46),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\mul_ll.mul_ll.pp2 ));
 sky130_fd_sc_hd__a2bb2o_1 _450_ (.A1_N(_170_),
    .A2_N(_187_),
    .B1(net37),
    .B2(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__and2_1 _451_ (.A(_188_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__a21boi_1 _452_ (.A1(_173_),
    .A2(_186_),
    .B1_N(_188_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__nor2_1 _453_ (.A(_189_),
    .B(_152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net26));
 sky130_fd_sc_hd__a21oi_1 _454_ (.A1(net9),
    .A2(net36),
    .B1(_212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__nor2_1 _455_ (.A(_213_),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__clkbuf_1 _456_ (.A(\mul_ll.mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkbuf_1 _457_ (.A(\mul_ll.mul_ll.pp2 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout44 (.A(net10),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__buf_4 fanout45 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 fanout46 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(net49),
    ...
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer5 (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(net34),
    ...
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer10 (.A(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer11 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__clkbuf_1 rebuffer12 (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__clkbuf_1 rebuffer13 (.A(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_2 clone14 (.A(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__buf_2 rebuffer15 (.A(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
