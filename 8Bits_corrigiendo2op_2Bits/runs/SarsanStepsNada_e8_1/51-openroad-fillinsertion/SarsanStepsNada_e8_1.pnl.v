module SarsanStepsNada_e8_1 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__inv_2 _4_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__and4_1 _5_ (.A(net3),
    .B(net4),
    .C(net2),
    .D(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__o21a_1 _6_ (.A1(net3),
    .A2(_0_),
    .B1(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__o21ba_1 _7_ (.A1(net4),
    .A2(_1_),
    .B1_N(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__o211a_1 _8_ (.A1(_2_),
    .A2(_0_),
    .B1(net2),
    .C1(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__and4_1 _9_ (.A(net3),
    .B(net4),
    .C(net2),
    .D(net1),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__fill_1 FILLER_3_55 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_3_60 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_5_57 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_5_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
