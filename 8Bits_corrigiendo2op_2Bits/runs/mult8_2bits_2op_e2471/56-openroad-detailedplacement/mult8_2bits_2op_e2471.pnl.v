module mult8_2bits_2op_e2471 (VPWR,
 ...
 sky130_fd_sc_hd__and3b_1 _275_ (.A_N(net17),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__and3_1 _276_ (.A(net34),
    .B(net40),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _278_ (.A1(net34),
    ...
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__or3_1 _279_ (.A(_211_),
    .B(_212_),
    .C(_213_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _281_ (.A(net54),
    ...
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__nor2_1 _282_ (.A(net50),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3b_1 _285_ (.A(_215_),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__xnor2_1 _286_ (.A(_209_),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__nand2b_1 _287_ (.A_N(_214_),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _293_ (.A(net52),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__mux2_1 _294_ (.A0(_227_),
    .A1(net52),
    .S(_211_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _297_ (.A(net54),
    ...
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__a41o_1 _298_ (.A1(_209_),
    .A2(_216_),
    .A3(_218_),
    .A4(_219_),
    .B1(_231_),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__nor2_1 _299_ (.A(_230_),
    .B(_232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__xnor2_1 _300_ (.A(_229_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _309_ (.A(net40),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__or4bb_1 _310_ (.A(net41),
    .B(net49),
    .C_N(net50),
    .D_N(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__nand2_1 _311_ (.A(net41),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__a21oi_1 _312_ (.A1(_243_),
    .A2(_244_),
    .B1(_242_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _313_ (.A(net52),
    ...
    .VPWR(VPWR),
    .X(_246_));
 sky130_fd_sc_hd__xnor2_1 _314_ (.A(_226_),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _315_ (.A(_232_),
    ...
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__xnor2_1 _316_ (.A(_232_),
    .B(_247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__a2bb2oi_1 _317_ (.A1_N(_225_),
    .A2_N(_228_),
    .B1(_229_),
    .B2(_233_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _318_ (.A(_249_),
    ...
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__xnor2_1 _319_ (.A(_249_),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__o31ai_2 _320_ (.A1(_222_),
    .A2(_234_),
    .A3(_252_),
    .B1(_251_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _322_ (.A(_248_),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__a21boi_1 _323_ (.A1(_248_),
    .A2(_254_),
    .B1_N(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_256_));
 sky130_fd_sc_hd__xor2_1 _324_ (.A(_253_),
    .B(_255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _326_ (.A(net42),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__nand2_1 _327_ (.A(net55),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _356_ (.A(net34),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__and3_1 _357_ (.A(net51),
    .B(net38),
    .C(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__a21oi_1 _358_ (.A1(net50),
    .A2(net37),
    .B1(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _369_ (.A(net55),
    ...
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__or4bb_1 _370_ (.A(net55),
    .B(net43),
    .C_N(net45),
    .D_N(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__and4_1 _371_ (.A(net55),
    .B(net2),
    .C(net45),
    .D(net43),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _372_ (.A1(_031_),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__a2111o_1 _373_ (.A1(_031_),
    .A2(_032_),
    .B1(_033_),
    .C1(_258_),
    .D1(_224_),
 ...
 sky130_fd_sc_hd__o31a_1 _378_ (.A1(_242_),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__or4_1 _379_ (.A(_242_),
    .B(_246_),
    .C(_256_),
    .D(_039_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _381_ (.A_N(_040_),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__xor2_1 _382_ (.A(_026_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _383_ (.A_N(_014_),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__xnor2_1 _384_ (.A(_014_),
    .B(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _385_ (.A1(_008_),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__xor2_1 _386_ (.A(_046_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _387_ (.A(net48),
    ...
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__nand2_1 _388_ (.A(net41),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _393_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__xnor2_1 _394_ (.A(_053_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__or3_1 _395_ (.A(_030_),
    .B(_038_),
    .C(_055_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _397_ (.A(_056_),
    ...
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__nand2_1 _398_ (.A(net51),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _419_ (.A(_040_),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__nand2_1 _420_ (.A(_079_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _421_ (.A1(_046_),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__xnor2_1 _422_ (.A(_081_),
    .B(_082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _427_ (.A_N(_033_),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__or4bb_1 _428_ (.A(net41),
    .B(net43),
    .C_N(net45),
    .D_N(net40),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _429_ (.A(net4),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__nand2_1 _430_ (.A(net3),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _435_ (.A(_087_),
    ...
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__a2bb2o_1 _436_ (.A1_N(_049_),
    .A2_N(_052_),
    .B1(_053_),
    .B2(_054_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _437_ (.A(_095_),
    ...
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__xor2_1 _438_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _439_ (.A_N(_056_),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__xnor2_1 _440_ (.A(_056_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _442_ (.A(net12),
    ...
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__nand4_1 _443_ (.A(net51),
    .B(net12),
    .C(net35),
    .D(net36),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _453_ (.A_N(_071_),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__xnor2_1 _454_ (.A(_071_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _455_ (.A(_100_),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__xnor2_1 _456_ (.A(_100_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__or2_1 _457_ (.A(_086_),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _458_ (.A(_086_),
    ...
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__and2_1 _459_ (.A(_117_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__nor3_1 _460_ (.A(_074_),
    .B(_077_),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _467_ (.A1(_092_),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__a21oi_1 _468_ (.A1(_097_),
    .A2(_099_),
    .B1(_126_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _469_ (.A(_097_),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__nor2_1 _470_ (.A(_127_),
    .B(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _475_ (.A(_129_),
    ...
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__xor2_1 _476_ (.A(_129_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _477_ (.A(_124_),
    ...
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__xnor2_1 _478_ (.A(_124_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _497_ (.A(_153_),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__or3_1 _498_ (.A(_089_),
    .B(_092_),
    .C(_127_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _499_ (.A(_103_),
    ...
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__and3_1 _500_ (.A(_103_),
    .B(_106_),
    .C(_131_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _501_ (.A1(_105_),
    ...
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__xnor2_1 _502_ (.A(_156_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _503_ (.A(_155_),
    ...
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__xnor2_1 _504_ (.A(_155_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _505_ (.A1(_134_),
    ...
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__nand3_1 _506_ (.A(_134_),
    .B(_136_),
    .C(_162_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _507_ (.A_N(_163_),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__a21oi_1 _508_ (.A1(_138_),
    .A2(_144_),
    .B1(_139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__xnor2_1 _509_ (.A(_165_),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _527_ (.A1(_139_),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__a21o_1 _528_ (.A1(_082_),
    .A2(_142_),
    .B1(_184_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22oi_1 _531_ (.A1(_181_),
    ...
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__nor2_1 _532_ (.A(_187_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _544_ (.A(_178_),
    ...
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__a41o_1 _545_ (.A1(_183_),
    .A2(_185_),
    .A3(_186_),
    .A4(_200_),
    .B1(_199_),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__a311o_1 _546_ (.A1(_183_),
    .A2(_185_),
    .A3(_186_),
    .B1(_200_),
    .C1(_182_),
