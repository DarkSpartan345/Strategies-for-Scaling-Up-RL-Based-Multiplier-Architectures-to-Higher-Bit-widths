module mult8_2bits_2op_e2493 (VPWR,
 ...
 sky130_fd_sc_hd__and3_1 _281_ (.A(net49),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__nor2_1 _282_ (.A(net32),
    .B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__a21oi_1 _283_ (.A1(net32),
    .A2(net39),
    .B1(net49),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _285_ (.A(net49),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__nand2_1 _286_ (.A(net49),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _291_ (.A(_220_),
    ...
    .VPWR(VPWR),
    .Y(net24));
 sky130_fd_sc_hd__and3_1 _292_ (.A(net32),
    .B(net37),
    .C(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__a21oi_1 _293_ (.A1(net32),
    .A2(net37),
    .B1(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _295_ (.A(net49),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__or4bb_1 _296_ (.A(net49),
    .B(net44),
    .C_N(net46),
    .D_N(net39),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _299_ (.A1(_221_),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__or3_1 _300_ (.A(_228_),
    .B(_232_),
    .C(_233_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _302_ (.A(_234_),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__nand2_2 _303_ (.A(net32),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__nand2_1 _304_ (.A(net46),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _307_ (.A0(_239_),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__o2111ai_1 _308_ (.A1(net32),
    .A2(net47),
    .B1(net46),
    .C1(net37),
    .D1(net38),
 ...
 sky130_fd_sc_hd__nor2_1 _312_ (.A(_234_),
    ...
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__or2_1 _313_ (.A(_234_),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _321_ (.A(net44),
    ...
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__or4bb_1 _322_ (.A(net44),
    .B(net38),
    .C_N(net37),
    .D_N(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__and4_1 _323_ (.A(net46),
    .B(net44),
    .C(net37),
    .D(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__a21oi_1 _324_ (.A1(_253_),
    .A2(_254_),
    .B1(_255_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _325_ (.A(_238_),
    ...
    .VPWR(VPWR),
    .Y(_257_));
 sky130_fd_sc_hd__xor2_1 _326_ (.A(_238_),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__xnor2_1 _327_ (.A(_252_),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__a2bb2o_1 _328_ (.A1_N(_238_),
    .A2_N(_241_),
    .B1(_242_),
    .B2(_243_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _329_ (.A_N(_259_),
    ...
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__xor2_1 _330_ (.A(_259_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__o21ba_1 _331_ (.A1(_246_),
    .A2(_262_),
    .B1_N(_261_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _334_ (.A(_263_),
    ...
    .VPWR(VPWR),
    .Y(_266_));
 sky130_fd_sc_hd__xor2_1 _335_ (.A(_263_),
    .B(_265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _339_ (.A0(_268_),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__nand2_2 _340_ (.A(net49),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_2 _341_ (.A(_271_),
    ...
    .VPWR(VPWR),
    .X(_273_));
 sky130_fd_sc_hd__xnor2_1 _342_ (.A(_267_),
    .B(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_274_));
 sky130_fd_sc_hd__or3b_1 _343_ (.A(_250_),
    .B(_274_),
    .C_N(_236_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _359_ (.A(_010_),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__a21bo_1 _360_ (.A1(_267_),
    .A2(_273_),
    .B1_N(_275_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _365_ (.A(_236_),
    ...
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__and3_1 _366_ (.A(net46),
    .B(net36),
    .C(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__nor2_1 _367_ (.A(net46),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__a21oi_1 _368_ (.A1(net46),
    .A2(net35),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _377_ (.A(_001_),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__or4bb_1 _378_ (.A(net1),
    .B(net41),
    .C_N(net42),
    .D_N(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__nand2_1 _379_ (.A(net1),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _380_ (.A(net40),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__and4_1 _381_ (.A(net1),
    .B(net40),
    .C(net42),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _384_ (.A1(_271_),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__or2_1 _385_ (.A(_037_),
    .B(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _393_ (.A(_014_),
    ...
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__xor2_1 _394_ (.A(_014_),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _395_ (.A1(_010_),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__xor2_1 _396_ (.A(_048_),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _400_ (.A0(_052_),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__xnor2_1 _401_ (.A(_050_),
    .B(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor3_1 _428_ (.A(_043_),
    ...
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__or2_1 _429_ (.A(_080_),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _443_ (.A_N(_094_),
    ...
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__xnor2_1 _444_ (.A(_093_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__xnor2_1 _445_ (.A(_058_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_1 _451_ (.A1(net34),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__nor3_1 _452_ (.A(_069_),
    .B(_101_),
    .C(_103_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _474_ (.A1(_082_),
    ...
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__xnor2_1 _475_ (.A(_125_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _517_ (.A_N(_165_),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__o21a_1 _518_ (.A1(_144_),
    .A2(_146_),
    .B1(_143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__xnor2_1 _519_ (.A(_167_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _540_ (.A1(_146_),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a211o_1 _541_ (.A1(_146_),
    .A2(_187_),
    .B1(_188_),
    .C1(_186_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _554_ (.A(_181_),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__o2bb2a_1 _555_ (.A1_N(_184_),
    .A2_N(_201_),
    .B1(_202_),
    .B2(_190_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _563_ (.A(_209_),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__xnor2_1 _564_ (.A(_203_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o311a_1 _565_ (.A1(_215_),
    ...
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__o21ai_1 _566_ (.A1(_203_),
    .A2(_210_),
    .B1(_212_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 fanout41 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__buf_2 fanout42 (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout45 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__buf_2 fanout46 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
