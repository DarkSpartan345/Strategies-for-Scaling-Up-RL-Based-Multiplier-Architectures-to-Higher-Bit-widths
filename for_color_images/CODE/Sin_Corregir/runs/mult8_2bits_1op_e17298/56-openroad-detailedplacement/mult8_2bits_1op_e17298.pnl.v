module mult8_2bits_1op_e17298 (VPWR,
 ...
 sky130_fd_sc_hd__and3_1 _237_ (.A(net46),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__a22o_1 _238_ (.A1(net46),
    .A2(net11),
    .B1(net45),
    .B2(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__and4_1 _239_ (.A(net46),
    .B(net11),
    .C(net45),
    .D(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _241_ (.A(_170_),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__a21oi_1 _242_ (.A1(_171_),
    .A2(_173_),
    .B1(_170_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _244_ (.A(net37),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__a21o_1 _245_ (.A1(_170_),
    .A2(_171_),
    .B1(_172_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _246_ (.A(net46),
    ...
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__and3_1 _247_ (.A(net46),
    .B(net43),
    .C(_178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__xnor2_1 _248_ (.A(_178_),
    .B(_179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__nand2b_1 _249_ (.A_N(_177_),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _256_ (.A(net2),
    ...
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__a31o_1 _257_ (.A1(net46),
    .A2(net43),
    .A3(_178_),
    .B1(_189_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__xnor2_1 _258_ (.A(_188_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _260_ (.A(_182_),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__or4b_1 _261_ (.A(_176_),
    .B(_191_),
    .C(_183_),
    .D_N(_182_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _262_ (.A1(_192_),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__and2_1 _263_ (.A(_194_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _265_ (.A1(net13),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__nor2_1 _266_ (.A(_197_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__xnor2_1 _267_ (.A(_169_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _272_ (.A(_202_),
    ...
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__a22o_1 _273_ (.A1(net46),
    .A2(net15),
    .B1(net42),
    .B2(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__nand4_4 _274_ (.A(net46),
    .B(net2),
    .C(net15),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _282_ (.A0(_213_),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__nor4b_1 _283_ (.A(_176_),
    .B(_214_),
    .C(_183_),
    .D_N(_182_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31ai_2 _287_ (.A1(net32),
    ...
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__or4_1 _288_ (.A(_212_),
    .B(net33),
    .C(_217_),
    .D(_218_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _293_ (.A(_214_),
    ...
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__a21o_1 _294_ (.A1(_192_),
    .A2(_194_),
    .B1(_225_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _295_ (.A(_192_),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__and4_1 _296_ (.A(net1),
    .B(net42),
    .C(_226_),
    .D(_227_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__nand2_1 _297_ (.A(net45),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__a22o_1 _298_ (.A1(net1),
    .A2(net42),
    .B1(_226_),
    .B2(_227_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__nand2b_1 _299_ (.A_N(_228_),
    .B(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__a31o_1 _300_ (.A1(net45),
    .A2(net36),
    .A3(_230_),
    .B1(_228_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _304_ (.A(_233_),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__xor2_1 _305_ (.A(_229_),
    .B(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__o21ba_1 _306_ (.A1(_169_),
    .A2(_198_),
    .B1_N(_197_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _307_ (.A_N(_004_),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__or4b_1 _308_ (.A(_233_),
    .B(_001_),
    .C(_004_),
    .D_N(_003_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__xor2_1 _309_ (.A(_002_),
    .B(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211ai_2 _312_ (.A1(_007_),
    ...
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__a211o_1 _313_ (.A1(net10),
    .A2(net35),
    .B1(_007_),
    .C1(_008_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _317_ (.A(net39),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__and3_1 _318_ (.A(net46),
    .B(net39),
    .C(_206_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _333_ (.A(_000_),
    ...
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__xor2_1 _334_ (.A(_029_),
    .B(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _362_ (.A1(_000_),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__xor2_1 _363_ (.A(_057_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _390_ (.A1(_057_),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__xnor2_1 _391_ (.A(_084_),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _419_ (.A(_108_),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__and2_1 _420_ (.A(_112_),
    .B(_113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _438_ (.A_N(_129_),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__nand2_1 _439_ (.A(_106_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__xnor2_1 _440_ (.A(_131_),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _455_ (.A1(_108_),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__a31oi_4 _456_ (.A1(_110_),
    .A2(_111_),
    .A3(_146_),
    .B1(_147_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _466_ (.A1(_144_),
    ...
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__o211a_1 _467_ (.A1(_143_),
    .A2(_148_),
    .B1(_156_),
    .C1(_144_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__nor2_1 _468_ (.A(_157_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _474_ (.A1(_159_),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__a21o_1 _475_ (.A1(_158_),
    .A2(_162_),
    .B1(_163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__and2b_1 _476_ (.A_N(_003_),
    .B(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__nor2_1 _477_ (.A(_005_),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _481_ (.A(_176_),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__xnor2_1 _482_ (.A(_176_),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap32 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkbuf_1 wire33 (.A(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout44 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkbuf_4 fanout45 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout46 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__conb_1 mult8_2bits_1op_e17298_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
