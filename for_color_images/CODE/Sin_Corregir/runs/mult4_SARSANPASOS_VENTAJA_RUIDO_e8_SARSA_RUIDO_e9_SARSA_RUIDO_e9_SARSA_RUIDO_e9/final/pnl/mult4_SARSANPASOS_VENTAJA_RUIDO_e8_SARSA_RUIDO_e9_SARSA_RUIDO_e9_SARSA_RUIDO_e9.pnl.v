module mult4_SARSANPASOS_VENTAJA_RUIDO_e8_SARSA_RUIDO_e9_SARSA_RUIDO_e9_SARSA_RUIDO_e9 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_1 _27_ (.A(net5),
    ...
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__and3_1 _28_ (.A(net1),
    .B(net6),
    .C(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_01_));
 sky130_fd_sc_hd__a22o_1 _29_ (.A1(net6),
    .A2(net2),
    .B1(net7),
    .B2(net1),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _32_ (.A(net8),
    ...
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__nand4_1 _33_ (.A(net6),
    .B(net2),
    .C(net8),
    .D(net4),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _34_ (.A1(net2),
    ...
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__and2_1 _35_ (.A(net7),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__a21oi_1 _36_ (.A1(_05_),
    .A2(_06_),
    .B1(_07_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_08_));
 sky130_fd_sc_hd__and3_1 _37_ (.A(_05_),
    .B(_06_),
    .C(_07_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _38_ (.A(_08_),
    ...
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__nand2_1 _39_ (.A(net3),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_11_));
 sky130_fd_sc_hd__and3_1 _40_ (.A(net3),
    .B(net8),
    .C(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__nand3_1 _41_ (.A(net3),
    .B(net8),
    .C(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_13_));
 sky130_fd_sc_hd__a22o_1 _42_ (.A1(net6),
    .A2(net3),
    .B1(net8),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__a32o_1 _43_ (.A1(net5),
    .A2(net3),
    .A3(_02_),
    .B1(_01_),
    .B2(net7),
    ...
    .VPWR(VPWR),
    .X(_15_));
 sky130_fd_sc_hd__and3_1 _44_ (.A(_13_),
    .B(_14_),
    .C(_15_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_16_));
 sky130_fd_sc_hd__nor2_1 _45_ (.A(_12_),
    .B(_16_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_17_));
 sky130_fd_sc_hd__nor3_1 _46_ (.A(_08_),
    .B(_09_),
    .C(_13_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_18_));
 sky130_fd_sc_hd__xnor2_1 _47_ (.A(_10_),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net13));
 sky130_fd_sc_hd__a21boi_1 _48_ (.A1(_06_),
    .A2(_07_),
    .B1_N(_05_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_19_));
 sky130_fd_sc_hd__and2_1 _49_ (.A(_11_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__nor2_1 _50_ (.A(_11_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_21_));
 sky130_fd_sc_hd__or2_1 _51_ (.A(_20_),
    .B(_21_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _53_ (.A(_22_),
    ...
    .VPWR(VPWR),
    .Y(net14));
 sky130_fd_sc_hd__a311o_1 _54_ (.A1(net3),
    .A2(net8),
    .A3(_16_),
    .B1(_18_),
    .C1(_21_),
    ...
    .VPWR(VPWR),
    .X(_24_));
 sky130_fd_sc_hd__and3_1 _55_ (.A(net8),
    .B(net4),
    .C(_24_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__xnor2_1 _56_ (.A(_04_),
    .B(_24_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net15));
 sky130_fd_sc_hd__a21oi_1 _57_ (.A1(_13_),
    .A2(_14_),
    .B1(_15_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_25_));
 sky130_fd_sc_hd__nor2_1 _58_ (.A(_16_),
    .B(_25_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net12));
 sky130_fd_sc_hd__clkbuf_1 _59_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_1 _60_ (.A(\mul_ll.pp1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_ef_sc_hd__decap_12 FILLER_1_62 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_1_74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_2_26 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_2_37 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
