module mult8_2bits_1op_e17675 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_1 _230_ (.A(net13),
    ...
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__mux2_1 _231_ (.A0(net44),
    .A1(net45),
    .S(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__and3_1 _232_ (.A(net37),
    .B(net9),
    .C(_165_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__nand4_4 _233_ (.A(net47),
    .B(net44),
    .C(net43),
    .D(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _237_ (.A1(net37),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__and3_1 _238_ (.A(_166_),
    .B(_170_),
    .C(_171_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _253_ (.A(_185_),
    ...
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__a22o_1 _254_ (.A1(net44),
    .A2(net35),
    .B1(net6),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__and4_1 _255_ (.A(net44),
    .B(net45),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__nand4_2 _256_ (.A(net44),
    .B(net45),
    .C(net35),
    .D(net6),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _260_ (.A1(net47),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__and4_1 _261_ (.A(net47),
    .B(net2),
    .C(net15),
    .D(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__nand4_2 _262_ (.A(net47),
    .B(net2),
    .C(net15),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _268_ (.A0(_163_),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__a31o_1 _269_ (.A1(_167_),
    .A2(_173_),
    .A3(_174_),
    .B1(_175_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2111a_1 _271_ (.A1(_175_),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__and4_1 _272_ (.A(_166_),
    .B(_170_),
    .C(_171_),
    .D(_201_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _276_ (.A(_199_),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__o31ai_4 _277_ (.A1(_204_),
    .A2(_205_),
    .A3(_206_),
    .B1(_209_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__or4_1 _278_ (.A(_204_),
    .B(_205_),
    .C(_206_),
    .D(_209_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__nand3_1 _279_ (.A(_198_),
    .B(_210_),
    .C(_211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__a21o_1 _280_ (.A1(_210_),
    .A2(_211_),
    .B1(_198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__nand3_1 _281_ (.A(_192_),
    .B(_212_),
    .C(_213_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _282_ (.A1(_212_),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__and2_1 _283_ (.A(_214_),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__nand2_1 _284_ (.A(net47),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _288_ (.A(net1),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__nand2_1 _289_ (.A(net46),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _292_ (.A(_216_),
    ...
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__xnor2_1 _293_ (.A(_216_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _297_ (.A(net43),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and3_1 _298_ (.A(net43),
    .B(net36),
    .C(_189_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211ai_4 _300_ (.A1(_000_),
    ...
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__a211o_1 _301_ (.A1(net46),
    .A2(net33),
    .B1(_000_),
    .C1(_001_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _305_ (.A(net39),
    ...
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__and3_1 _306_ (.A(net47),
    .B(net40),
    .C(_195_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_2 _309_ (.A(_008_),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__and3_1 _310_ (.A(_196_),
    .B(_011_),
    .C(_012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a21oi_1 _311_ (.A1(_011_),
    .A2(_012_),
    .B1(_196_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__a211o_1 _312_ (.A1(_208_),
    .A2(_210_),
    .B1(_013_),
    .C1(_014_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _317_ (.A1(_212_),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__o211a_1 _318_ (.A1(_017_),
    .A2(_019_),
    .B1(_212_),
    .C1(_214_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__or2_1 _319_ (.A(_020_),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _321_ (.A(_022_),
    ...
    .VPWR(VPWR),
    .Y(net30));
 sky130_fd_sc_hd__a22oi_2 _322_ (.A1(net38),
    .A2(net15),
    .B1(net42),
    .B2(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__and4_1 _323_ (.A(net38),
    .B(net4),
    .C(net15),
    .D(net42),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _324_ (.A(net2),
    ...
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__nor4_1 _325_ (.A(_194_),
    .B(_024_),
    .C(_025_),
    .D(_026_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__or4_1 _326_ (.A(_194_),
    .B(_024_),
    .C(_025_),
    .D(_026_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _348_ (.A1(_216_),
    ...
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__o32a_1 _349_ (.A1(_226_),
    .A2(_228_),
    .A3(_022_),
    .B1(_050_),
    .B2(_021_),
 ...
 sky130_fd_sc_hd__nand2_1 _352_ (.A(_163_),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__nand2_1 _353_ (.A(net38),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _375_ (.A1(_049_),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__xnor2_1 _376_ (.A(_075_),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _385_ (.A1(net38),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__and4_1 _386_ (.A(net38),
    .B(net4),
    .C(net40),
    .D(_194_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _405_ (.A(_103_),
    ...
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__or4b_1 _406_ (.A(_049_),
    .B(_051_),
    .C(_073_),
    .D_N(_074_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _408_ (.A(_074_),
    ...
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__xnor2_1 _409_ (.A(_105_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _413_ (.A1(_109_),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__a211oi_1 _414_ (.A1(net41),
    .A2(net34),
    .B1(_109_),
    .C1(_111_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o22ai_4 _419_ (.A1(_086_),
    ...
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__or4_1 _420_ (.A(_086_),
    .B(_088_),
    .C(_093_),
    .D(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__and3_1 _421_ (.A(_117_),
    .B(_118_),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ba_1 _425_ (.A1(_120_),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__or3b_1 _426_ (.A(_120_),
    .B(_122_),
    .C_N(_123_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _445_ (.A_N(_142_),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__o2bb2a_1 _446_ (.A1_N(_106_),
    .A2_N(_143_),
    .B1(_141_),
    .B2(_142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__xnor2_1 _447_ (.A(_140_),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_1 _456_ (.A1(_139_),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__o211a_1 _457_ (.A1(_138_),
    .A2(_144_),
    .B1(_152_),
    .C1(_139_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__nor2_1 _458_ (.A(_153_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _464_ (.A1(_155_),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__a21o_1 _465_ (.A1(_154_),
    .A2(_158_),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _469_ (.A(net47),
    ...
    .VPWR(VPWR),
    .X(\mul_ll.mul_ll.pp2 ));
 sky130_fd_sc_hd__a21oi_1 _470_ (.A1(net38),
    .A2(net9),
    .B1(_165_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 fanout43 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkbuf_4 fanout44 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
