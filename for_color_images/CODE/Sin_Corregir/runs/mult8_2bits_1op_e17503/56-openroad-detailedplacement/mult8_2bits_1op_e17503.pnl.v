module mult8_2bits_1op_e17503 (VPWR,
 ...
 sky130_fd_sc_hd__inv_2 _234_ (.A(net2),
    ...
    .VPWR(VPWR),
    .Y(\mul_ll.mul_ll.pp2 ));
 sky130_fd_sc_hd__and4_1 _235_ (.A(net45),
    .B(net46),
    .C(net36),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__nand4_2 _236_ (.A(net45),
    .B(net46),
    .C(net35),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__a22o_1 _237_ (.A1(net45),
    .A2(net35),
    .B1(net6),
    .B2(net47),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _241_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__nand4_1 _242_ (.A(net2),
    .B(net15),
    .C(net48),
    .D(net42),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _248_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__nand4_2 _249_ (.A(net2),
    .B(net48),
    .C(net45),
    .D(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__nand2_1 _250_ (.A(net48),
    .B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__mux2_1 _251_ (.A0(net43),
    .A1(_183_),
    .S(_182_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _254_ (.A(_180_),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a22o_1 _255_ (.A1(net48),
    .A2(net45),
    .B1(net46),
    .B2(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _259_ (.A(net43),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__nand3_1 _260_ (.A(net38),
    .B(net43),
    .C(_181_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__or2_1 _261_ (.A(net38),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _265_ (.A1(net38),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__and4_1 _266_ (.A(_182_),
    .B(_196_),
    .C(_197_),
    .D(_198_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__a311oi_2 _267_ (.A1(net43),
    .A2(_193_),
    .A3(_194_),
    .B1(_195_),
    .C1(_199_),
 ...
 sky130_fd_sc_hd__o2111a_1 _268_ (.A1(_195_),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__a22oi_1 _269_ (.A1(_182_),
    .A2(_197_),
    .B1(_198_),
    .B2(_196_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _270_ (.A(_199_),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__or4_1 _271_ (.A(_180_),
    .B(_184_),
    .C(_199_),
    .D(_202_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _272_ (.A(_200_),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__nor2_1 _273_ (.A(_200_),
    .B(_204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_2 _278_ (.A1(_192_),
    ...
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__or4_1 _279_ (.A(_192_),
    .B(_201_),
    .C(_206_),
    .D(_209_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _281_ (.A(_179_),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__a21o_1 _282_ (.A1(_211_),
    .A2(_212_),
    .B1(_179_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o41a_1 _288_ (.A1(_185_),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__xnor2_1 _289_ (.A(_205_),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__and3_1 _290_ (.A(net1),
    .B(net42),
    .C(_222_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _306_ (.A(net43),
    ...
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__and3_1 _307_ (.A(net44),
    .B(net35),
    .C(_169_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _328_ (.A(_024_),
    ...
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__and2b_1 _329_ (.A_N(_227_),
    .B(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__xnor2_1 _330_ (.A(_026_),
    .B(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _333_ (.A(net37),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__nor4_1 _334_ (.A(_174_),
    .B(_028_),
    .C(_029_),
    .D(_030_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__or4_1 _335_ (.A(_174_),
    .B(_028_),
    .C(_029_),
    .D(_030_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__o22ai_1 _336_ (.A1(_174_),
    .A2(_028_),
    .B1(_029_),
    .B2(_030_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _341_ (.A(net44),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__and4_1 _342_ (.A(net45),
    .B(net47),
    .C(net34),
    .D(net8),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _355_ (.A(_020_),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__or2_1 _356_ (.A(_051_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__nor2_1 _357_ (.A(_227_),
    .B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _359_ (.A(_055_),
    ...
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__xnor2_1 _360_ (.A(_053_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2111a_1 _365_ (.A1(_030_),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__a311oi_1 _366_ (.A1(net39),
    .A2(_059_),
    .A3(_060_),
    .B1(_030_),
    .C1(_031_),
 ...
 sky130_fd_sc_hd__and3b_1 _372_ (.A_N(_067_),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__and2_1 _373_ (.A(_065_),
    .B(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _383_ (.A1(_075_),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__nand2b_1 _384_ (.A_N(_078_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__xor2_1 _385_ (.A(_057_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3b_1 _396_ (.A(_089_),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__a21oi_1 _397_ (.A1(_087_),
    .A2(_088_),
    .B1(_091_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _400_ (.A(net44),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__o211a_1 _401_ (.A1(_065_),
    .A2(_068_),
    .B1(_006_),
    .C1(_042_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31ai_2 _404_ (.A1(_069_),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__or4_1 _405_ (.A(_069_),
    .B(_095_),
    .C(_096_),
    .D(_098_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _408_ (.A(_086_),
    ...
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__a21oi_1 _409_ (.A1(_101_),
    .A2(_102_),
    .B1(_086_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__nor2_1 _410_ (.A(_103_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _414_ (.A(_053_),
    ...
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__a2111o_1 _415_ (.A1(_002_),
    .A2(_054_),
    .B1(_080_),
    .C1(_025_),
    .D1(_053_),
 ...
 sky130_fd_sc_hd__a21o_1 _416_ (.A1(_051_),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__a21oi_1 _417_ (.A1(_055_),
    .A2(_109_),
    .B1(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__xor2_1 _418_ (.A(_108_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _427_ (.A(_119_),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__a2bb2o_1 _428_ (.A1_N(_090_),
    .A2_N(_092_),
    .B1(_097_),
    .B2(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__or4bb_1 _429_ (.A(_090_),
    .B(_092_),
    .C_N(_097_),
    .D_N(_099_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _432_ (.A1(_086_),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__a21oi_1 _433_ (.A1(_124_),
    .A2(_125_),
    .B1(_126_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _434_ (.A(_124_),
    ...
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__nand2b_1 _435_ (.A_N(_127_),
    .B(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _451_ (.A(_141_),
    ...
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__a21oi_1 _452_ (.A1(_107_),
    .A2(_128_),
    .B1(_127_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _454_ (.A(_108_),
    ...
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__o2bb2a_1 _455_ (.A1_N(_110_),
    .A2_N(_146_),
    .B1(_147_),
    .B2(_145_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _465_ (.A1(_141_),
    ...
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__o211a_1 _466_ (.A1(_142_),
    .A2(_148_),
    .B1(_156_),
    .C1(_141_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _471_ (.A(_159_),
    ...
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__xor2_1 _472_ (.A(_158_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _476_ (.A(_001_),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__and2_1 _477_ (.A(net48),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout44 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__buf_2 fanout45 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
