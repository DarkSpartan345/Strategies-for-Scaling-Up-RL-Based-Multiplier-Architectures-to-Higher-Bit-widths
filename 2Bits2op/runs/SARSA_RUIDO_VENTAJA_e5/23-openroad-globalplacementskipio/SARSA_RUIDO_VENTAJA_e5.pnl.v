module SARSA_RUIDO_VENTAJA_e5 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__inv_2 _04_ (.A(B[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_03_));
 sky130_fd_sc_hd__and2_2 _05_ (.A(B[1]),
    .B(A[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_00_));
 sky130_fd_sc_hd__and4_2 _06_ (.A(A[0]),
    .B(B[1]),
    .C(B[0]),
    .D(A[1]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(P[3]));
 sky130_fd_sc_hd__a21o_2 _07_ (.A1(A[0]),
    .A2(_03_),
    .B1(P[3]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(P[0]));
 sky130_fd_sc_hd__nor2_2 _08_ (.A(B[1]),
    .B(A[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__nand2b_2 _09_ (.A_N(B[0]),
    .B(A[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _10_ (.A1(_00_),
    ...
    .VPWR(VPWR),
    .Y(P[1]));
 sky130_fd_sc_hd__a21boi_2 _11_ (.A1(A[0]),
    .A2(B[0]),
    .B1_N(_00_),
    .VGND(VGND),
    .VNB(VGND),
