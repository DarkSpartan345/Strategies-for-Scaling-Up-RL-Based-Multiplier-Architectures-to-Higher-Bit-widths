module SarsaNada_e10_1 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_1 _04_ (.A(net3),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _05_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__nand2b_1 _06_ (.A_N(_00_),
    .B(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__o21a_1 _07_ (.A1(net4),
    .A2(net1),
    .B1(_01_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__nor2_1 _08_ (.A(_03_),
    .B(_00_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net8));
 sky130_fd_sc_hd__o211a_1 _09_ (.A1(net4),
    .A2(net2),
    .B1(_03_),
    .C1(_00_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_02_));
 sky130_fd_sc_hd__nor2_1 _10_ (.A(net8),
    .B(_02_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net6));
 sky130_fd_sc_hd__o211a_1 _11_ (.A1(_03_),
    .A2(_00_),
    .B1(net4),
    .C1(net2),
    .VGND(VGND),
