module mult8_comb (VPWR,
 ...
 sky130_fd_sc_hd__a22oi_2 _323_ (.A1(net9),
    ...
    .VPWR(VPWR),
    .Y(_256_));
 sky130_fd_sc_hd__or3_1 _324_ (.A(_254_),
    .B(_255_),
    .C(_256_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _326_ (.A(_253_),
    ...
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__a21o_1 _327_ (.A1(_257_),
    .A2(_258_),
    .B1(_253_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _332_ (.A(_261_),
    ...
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__xor2_1 _333_ (.A(_261_),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _335_ (.A1(_259_),
    ...
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__and3_1 _336_ (.A(_252_),
    .B(_267_),
    .C(_268_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _338_ (.A(_269_),
    ...
    .VPWR(VPWR),
    .Y(_271_));
 sky130_fd_sc_hd__nor3b_1 _339_ (.A(_269_),
    .B(_270_),
    .C_N(_218_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_2 _362_ (.A(_275_),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__a21o_1 _363_ (.A1(_012_),
    .A2(_013_),
    .B1(_275_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _365_ (.A(_016_),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__a211o_1 _366_ (.A1(_014_),
    .A2(_015_),
    .B1(_269_),
    .C1(_272_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4bb_1 _368_ (.A_N(_242_),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a2bb2o_1 _369_ (.A1_N(_242_),
    .A2_N(_019_),
    .B1(_018_),
    .B2(_016_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _405_ (.A_N(_054_),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__a21o_1 _406_ (.A1(_021_),
    .A2(_023_),
    .B1(_020_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _413_ (.A(net43),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__xor2_1 _414_ (.A(_062_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _418_ (.A_N(_066_),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__xnor2_1 _419_ (.A(_065_),
    .B(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _428_ (.A_N(_076_),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__xor2_1 _429_ (.A(_076_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__xor2_1 _430_ (.A(_064_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _432_ (.A_N(_081_),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__xnor2_1 _433_ (.A(_080_),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _434_ (.A(_058_),
    ...
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__xor2_1 _435_ (.A(_058_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2b_1 _437_ (.A_N(_086_),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__xnor2_1 _438_ (.A(_085_),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__a21o_1 _439_ (.A1(_055_),
    .A2(_057_),
    .B1(_054_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _468_ (.A_N(_115_),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__a21bo_1 _469_ (.A1(_088_),
    .A2(_089_),
    .B1_N(_087_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__xor2_1 _470_ (.A(_117_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _475_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__xnor2_1 _476_ (.A(_122_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _479_ (.A_N(_125_),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__nand2_1 _480_ (.A(net37),
    .B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _489_ (.A(_119_),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__xnor2_1 _490_ (.A(_119_),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__nand3_1 _491_ (.A(_111_),
    .B(_113_),
    .C(_138_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _492_ (.A(_139_),
    ...
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__a21oi_1 _493_ (.A1(_111_),
    .A2(_113_),
    .B1(_138_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _497_ (.A1(_089_),
    ...
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__xnor2_1 _498_ (.A(_142_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _502_ (.A(_148_),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__a31o_1 _503_ (.A1(net37),
    .A2(net47),
    .A3(_126_),
    .B1(_125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nand2_1 _504_ (.A(net37),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__and3_1 _505_ (.A(net37),
    .B(net45),
    .C(_150_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ba_1 _522_ (.A1(_140_),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__xnor2_1 _523_ (.A(_168_),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _526_ (.A0(_170_),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__nand2_1 _527_ (.A(net37),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _541_ (.A1(_139_),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a2111o_1 _542_ (.A1(_089_),
    .A2(_143_),
    .B1(_144_),
    .C1(_167_),
    .D1(_141_),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and3_1 _543_ (.A(_186_),
    .B(_187_),
    .C(_188_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o22a_1 _557_ (.A1(_185_),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__or4_1 _558_ (.A(_185_),
    .B(_189_),
    .C(_200_),
    .D(_201_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__nand2b_1 _559_ (.A_N(_202_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o311a_1 _567_ (.A1(_171_),
    ...
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__or2_1 _568_ (.A(_209_),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout40 (.A(net4),
    ...
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__buf_2 fanout41 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
