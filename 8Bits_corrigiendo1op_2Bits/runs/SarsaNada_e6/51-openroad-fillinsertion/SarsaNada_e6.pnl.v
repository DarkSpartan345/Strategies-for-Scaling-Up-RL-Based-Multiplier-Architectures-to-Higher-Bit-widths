module SarsaNada_e6 (VPWR,
 ...
 sky130_fd_sc_hd__a21bo_1 _3_ (.A1(net4),
    .A2(net1),
    .B1_N(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_2_));
 sky130_fd_sc_hd__and2_1 _4_ (.A(net3),
    .B(_2_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__nand4_2 _5_ (.A(net4),
    .B(net3),
    .C(net2),
    .D(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__inv_2 _6_ (.A(_0_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _7_ (.A1(net3),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__and2_1 _8_ (.A(_0_),
    .B(_1_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__and3_1 _9_ (.A(net4),
    .B(net2),
    .C(_0_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__decap_8 FILLER_5_6 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_5_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
