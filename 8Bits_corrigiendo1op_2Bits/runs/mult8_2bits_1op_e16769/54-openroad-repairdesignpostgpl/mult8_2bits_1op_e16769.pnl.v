module mult8_2bits_1op_e16769 (VPWR,
 ...
 sky130_fd_sc_hd__and4_1 _292_ (.A(net33),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__nand4_1 _293_ (.A(net33),
    .B(net48),
    .C(net40),
    .D(net51),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _299_ (.A(_233_),
    ...
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__nand2_1 _300_ (.A(net33),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2111a_1 _319_ (.A1(_221_),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__and2_1 _320_ (.A(net38),
    .B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _322_ (.A_N(_238_),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__or3b_1 _323_ (.A(_238_),
    .B(_255_),
    .C_N(_236_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _324_ (.A1(net48),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__and3_1 _325_ (.A(_253_),
    .B(_257_),
    .C(_258_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand4_2 _344_ (.A(net37),
    ...
    .VPWR(VPWR),
    .Y(_277_));
 sky130_fd_sc_hd__nand4_2 _345_ (.A(net38),
    .B(net45),
    .C(_239_),
    .D(_277_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__a31o_1 _346_ (.A1(net38),
    .A2(net46),
    .A3(_277_),
    .B1(_239_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__o211a_1 _347_ (.A1(_241_),
    .A2(_244_),
    .B1(_278_),
    .C1(_279_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_280_));
 sky130_fd_sc_hd__a211oi_1 _348_ (.A1(_278_),
    .A2(_279_),
    .B1(_241_),
    .C1(_244_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_281_));
 sky130_fd_sc_hd__nor2_1 _349_ (.A(_280_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _350_ (.A(_237_),
    ...
    .VPWR(VPWR),
    .X(_283_));
 sky130_fd_sc_hd__nor2_1 _351_ (.A(_256_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_1 _353_ (.A1(_256_),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__a41o_1 _354_ (.A1(net37),
    .A2(net46),
    .A3(_255_),
    .A4(_278_),
    .B1(_280_),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or4_1 _355_ (.A(_283_),
    .B(_001_),
    .C(_002_),
    .D(_003_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _357_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__and3_1 _358_ (.A(net40),
    .B(net43),
    .C(_252_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _365_ (.A1(_004_),
    ...
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__or3b_1 _366_ (.A(_013_),
    .B(_014_),
    .C_N(_276_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _367_ (.A1(_013_),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__nand4_1 _368_ (.A(net40),
    .B(net50),
    .C(net13),
    .D(net43),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ba_1 _381_ (.A1(_265_),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__xor2_1 _382_ (.A(_028_),
    .B(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _396_ (.A_N(_043_),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__nand4_2 _397_ (.A(net40),
    .B(net50),
    .C(net15),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2111a_1 _398_ (.A1(net13),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__nand4_1 _399_ (.A(net51),
    .B(net41),
    .C(_045_),
    .D(_046_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__a31o_1 _400_ (.A1(net51),
    .A2(net41),
    .A3(_045_),
    .B1(_046_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _402_ (.A1(_047_),
    ...
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__nor2_1 _403_ (.A(_049_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__nand2_1 _404_ (.A(_010_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _412_ (.A(_031_),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__xor2_1 _413_ (.A(_031_),
    .B(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _414_ (.A1(_027_),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__xor2_1 _415_ (.A(_061_),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _416_ (.A(net39),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__nand4_1 _417_ (.A(net37),
    .B(net43),
    .C(_006_),
    .D(_063_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__a31o_1 _418_ (.A1(net37),
    .A2(net43),
    .A3(_006_),
    .B1(_063_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _451_ (.A1(_010_),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__nand4_1 _452_ (.A(net37),
    .B(net39),
    .C(net15),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _467_ (.A1(_032_),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__xor2_1 _468_ (.A(_079_),
    .B(_113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _479_ (.A1(_095_),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__xnor2_1 _480_ (.A(_124_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3b_1 _508_ (.A_N(_149_),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__xor2_1 _509_ (.A(_151_),
    .B(_152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _537_ (.A1(_154_),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__xor2_1 _538_ (.A(_180_),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21bai_1 _556_ (.A1(_153_),
    ...
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__a31o_1 _557_ (.A1(_154_),
    .A2(_156_),
    .A3(_180_),
    .B1(_199_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _580_ (.A(_201_),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__or3_1 _581_ (.A(_217_),
    .B(_219_),
    .C(_220_),
    .VGND(VGND),
    .VNB(VGND),
