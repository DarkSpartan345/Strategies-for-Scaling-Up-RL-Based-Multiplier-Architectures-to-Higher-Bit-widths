module mult8_2bits_1op_e16577 (VPWR,
    VGND,
    A,
    B,
    P);
 ...
 sky130_fd_sc_hd__nand4_1 _291_ (.A(net33),
    ...
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__and3_1 _292_ (.A(net46),
    .B(net48),
    .C(_228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__nand2_1 _293_ (.A(net48),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _301_ (.A(net46),
    ...
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__and4_1 _302_ (.A(net33),
    .B(net46),
    .C(net4),
    .D(net38),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _303_ (.A_N(_237_),
    ...
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__and4_1 _304_ (.A(net40),
    .B(net48),
    .C(net45),
    .D(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__nand4_1 _305_ (.A(net40),
    .B(net48),
    .C(net45),
    .D(net43),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4bb_1 _306_ (.A_N(_239_),
    ...
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__or4_1 _307_ (.A(_221_),
    .B(_223_),
    .C(_228_),
    .D(_239_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__o2111a_1 _308_ (.A1(net33),
    .A2(net45),
    .B1(net48),
    .C1(net40),
    .D1(net46),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__a31o_1 _309_ (.A1(net48),
    .A2(net43),
    .A3(_240_),
    .B1(_243_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__and3_1 _310_ (.A(_238_),
    .B(_242_),
    .C(_244_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _314_ (.A(_247_),
    ...
    .VPWR(VPWR),
    .Y(net26));
 sky130_fd_sc_hd__nand2_1 _315_ (.A(net33),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _318_ (.A(net39),
    ...
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__or3b_1 _319_ (.A(_252_),
    .B(_232_),
    .C_N(_236_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _324_ (.A1(_255_),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__nand2b_1 _325_ (.A_N(_257_),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _328_ (.A(_250_),
    ...
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__and3_1 _329_ (.A(net33),
    .B(net37),
    .C(_262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__a21oi_1 _330_ (.A1(net33),
    .A2(net37),
    .B1(_262_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _331_ (.A(_263_),
    ...
    .VPWR(VPWR),
    .Y(net27));
 sky130_fd_sc_hd__a32o_1 _332_ (.A1(net46),
    .A2(net6),
    .A3(_249_),
    .B1(net36),
    .B2(net45),
    ...
    .VPWR(VPWR),
    .X(_265_));
 sky130_fd_sc_hd__and4b_1 _333_ (.A_N(net33),
    .B(net46),
    .C(net6),
    .D(net36),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _338_ (.A(_269_),
    ...
    .VPWR(VPWR),
    .Y(_271_));
 sky130_fd_sc_hd__nand4_2 _339_ (.A(net4),
    .B(net38),
    .C(net45),
    .D(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__nand4_2 _340_ (.A(net38),
    .B(net43),
    .C(_237_),
    .D(_272_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_273_));
 sky130_fd_sc_hd__a31o_1 _341_ (.A1(net38),
    .A2(net43),
    .A3(_272_),
    .B1(_237_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _348_ (.A(_275_),
    ...
    .VPWR(VPWR),
    .X(_281_));
 sky130_fd_sc_hd__o21ba_1 _349_ (.A1(_257_),
    .A2(_281_),
    .B1_N(_280_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _351_ (.A1(_278_),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__or3_1 _352_ (.A(_278_),
    .B(_282_),
    .C(_283_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and3_1 _353_ (.A(net40),
    .B(net42),
    .C(_250_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _361_ (.A1(_000_),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__or3b_1 _362_ (.A(_009_),
    .B(_010_),
    .C_N(_271_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _363_ (.A1(_009_),
    ...
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__nand4_2 _364_ (.A(net40),
    .B(net49),
    .C(net13),
    .D(net42),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _368_ (.A(_015_),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__nand4_1 _369_ (.A(net34),
    .B(net46),
    .C(net6),
    .D(net36),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _378_ (.A(_024_),
    ...
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__nand2b_1 _379_ (.A_N(_009_),
    .B(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _383_ (.A(net44),
    ...
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__nand4_2 _384_ (.A(net45),
    .B(net44),
    .C(net6),
    .D(net36),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _408_ (.A(_040_),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__xor2_1 _409_ (.A(_040_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _410_ (.A(_027_),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__xor2_1 _411_ (.A(_027_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _417_ (.A1(_225_),
    ...
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__and4_1 _418_ (.A(net2),
    .B(net41),
    .C(_013_),
    .D(_043_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _428_ (.A1(_223_),
    ...
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__or4bb_1 _429_ (.A(_031_),
    .B(_075_),
    .C_N(_074_),
    .D_N(_073_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _444_ (.A(_089_),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__a21oi_1 _445_ (.A1(_059_),
    .A2(_060_),
    .B1(_058_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _446_ (.A_N(_092_),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__xnor2_1 _447_ (.A(_091_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _449_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__nand4_2 _450_ (.A(net38),
    .B(net41),
    .C(_041_),
    .D(_095_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _456_ (.A1(_098_),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__nand2b_1 _457_ (.A_N(_101_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_1 _460_ (.A(net11),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__or3b_1 _461_ (.A(_223_),
    .B(_029_),
    .C_N(_106_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _462_ (.A1(net44),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__nand3_1 _463_ (.A(_075_),
    .B(_107_),
    .C(_108_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _479_ (.A_N(_123_),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nand2_1 _480_ (.A(_089_),
    .B(_093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__xor2_1 _481_ (.A(_125_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_2 _493_ (.A1(_101_),
    ...
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__or4_1 _494_ (.A(_101_),
    .B(_135_),
    .C(_136_),
    .D(_137_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__and2_1 _495_ (.A(_078_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_2 _498_ (.A1(_113_),
    ...
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__or4_1 _499_ (.A(_113_),
    .B(_140_),
    .C(_141_),
    .D(_142_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _502_ (.A1(_138_),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__and3_1 _503_ (.A(_133_),
    .B(_146_),
    .C(_147_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _511_ (.A(_154_),
    ...
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__xnor2_1 _512_ (.A(_153_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_2 _532_ (.A1(_145_),
    ...
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__or3_1 _533_ (.A(_145_),
    .B(_148_),
    .C(_175_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _536_ (.A1(_150_),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__xnor2_1 _537_ (.A(_179_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _554_ (.A_N(_150_),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__a21boi_1 _555_ (.A1(_152_),
    .A2(_177_),
    .B1_N(_155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__a311oi_4 _556_ (.A1(_154_),
    .A2(_176_),
    .A3(_198_),
    .B1(_197_),
    .C1(_178_),
 ...
 sky130_fd_sc_hd__a211oi_1 _568_ (.A1(_195_),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__o211a_1 _569_ (.A1(_194_),
    .A2(_199_),
    .B1(_209_),
    .C1(_195_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _577_ (.A(_217_),
    ...
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__o2111a_1 _578_ (.A1(_194_),
    .A2(_199_),
    .B1(_209_),
    .C1(_218_),
    .D1(_195_),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__xnor2_1 _579_ (.A(_211_),
    .B(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _580_ (.A(_200_),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__or3_1 _581_ (.A(_216_),
    .B(_219_),
    .C(_220_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 fanout33 (.A(net9),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout34 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout44 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkbuf_4 fanout45 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
