module mult8_2bits_1op_e16767 (VPWR,
 ...
 sky130_fd_sc_hd__inv_2 _284_ (.A(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__inv_2 _285_ (.A(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _288_ (.A(net8),
    ...
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__nand3_1 _289_ (.A(net44),
    .B(net32),
    .C(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _294_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__and4_1 _295_ (.A(net44),
    .B(net32),
    .C(net38),
    .D(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__nand4_1 _296_ (.A(net44),
    .B(net32),
    .C(net38),
    .D(net43),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _305_ (.A_N(_238_),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__and4_1 _306_ (.A(net44),
    .B(net38),
    .C(net11),
    .D(net41),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _309_ (.A0(_242_),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__xor2_1 _310_ (.A(_239_),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _314_ (.A(net32),
    ...
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__nand2_1 _315_ (.A(net44),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__o2111a_1 _316_ (.A1(_212_),
    .A2(_231_),
    .B1(_233_),
    .C1(net38),
    .D1(net41),
 ...
 sky130_fd_sc_hd__and2b_1 _326_ (.A_N(_257_),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__xnor2_1 _327_ (.A(_245_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _339_ (.A_N(_269_),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__a31o_1 _340_ (.A1(net44),
    .A2(net41),
    .A3(_230_),
    .B1(_240_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _346_ (.A(_276_),
    ...
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__and3_1 _347_ (.A(_235_),
    .B(_244_),
    .C(_278_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__nor2_1 _348_ (.A(_251_),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_1 _352_ (.A1(_279_),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__or4_1 _353_ (.A(_279_),
    .B(_281_),
    .C(_282_),
    .D(_283_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and3_1 _354_ (.A(net38),
    .B(net40),
    .C(_248_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _362_ (.A1(_000_),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__or3b_1 _363_ (.A(_009_),
    .B(_010_),
    .C_N(_271_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _368_ (.A1(_235_),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__xnor2_1 _369_ (.A(_015_),
    .B(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _371_ (.A(net43),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__xor2_1 _372_ (.A(_014_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _379_ (.A(_024_),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__nand2b_1 _380_ (.A_N(_009_),
    .B(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _382_ (.A(net10),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nand2_1 _383_ (.A(net41),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _409_ (.A(_027_),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__xor2_1 _410_ (.A(_027_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _442_ (.A(_085_),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__a21oi_1 _443_ (.A1(_057_),
    .A2(_058_),
    .B1(_056_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _467_ (.A_N(_111_),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__xnor2_1 _468_ (.A(_110_),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _480_ (.A1(_088_),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__xnor2_1 _481_ (.A(_124_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _500_ (.A(_143_),
    ...
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__a2bb2o_1 _501_ (.A1_N(_136_),
    .A2_N(_137_),
    .B1(_141_),
    .B2(_142_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _509_ (.A(_151_),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__a21o_1 _510_ (.A1(_151_),
    .A2(_152_),
    .B1(_150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__xnor2_1 _511_ (.A(_150_),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _534_ (.A1(_143_),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__or3_1 _535_ (.A(_143_),
    .B(_146_),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _537_ (.A(_177_),
    ...
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__nand2_1 _538_ (.A(_149_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__xnor2_1 _539_ (.A(_180_),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _554_ (.A(_148_),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__a311oi_4 _555_ (.A1(_151_),
    .A2(_152_),
    .A3(_195_),
    .B1(_196_),
    .C1(_179_),
 ...
 sky130_fd_sc_hd__a211oi_1 _568_ (.A1(_193_),
    ...
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__o211a_1 _569_ (.A1(_192_),
    .A2(_197_),
    .B1(_208_),
    .C1(_193_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _576_ (.A_N(_215_),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__o2111a_1 _577_ (.A1(_192_),
    .A2(_197_),
    .B1(_208_),
    .C1(_217_),
    .D1(_193_),
 ...
 sky130_fd_sc_hd__nand2_1 _579_ (.A(_198_),
    ...
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__or3_1 _580_ (.A(_215_),
    .B(_218_),
    .C(_219_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout37 (.A(net3),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__buf_2 fanout38 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout40 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkbuf_4 fanout41 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
