module SarsaNada_e10_1 (VPWR,
 ...
 sky130_fd_sc_hd__a21bo_1 _3_ (.A1(net3),
    .A2(net2),
    .B1_N(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_2_));
 sky130_fd_sc_hd__mux2_1 _4_ (.A0(net1),
    .A1(_2_),
    .S(net4),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _5_ (.A(net4),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__nor2_1 _6_ (.A(net4),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__a22o_1 _7_ (.A1(net3),
    .A2(net2),
    .B1(net1),
    .B2(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1_));
 sky130_fd_sc_hd__o21ba_1 _8_ (.A1(_0_),
    .A2(_1_),
    .B1_N(net8),
    .VGND(VGND),
    .VNB(VGND),
