module SARSANPASOS_VENTAJA_RUIDO_e8 (VPWR,
 ...
 sky130_fd_sc_hd__nand2_1 _1_ (.A(net3),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0_));
 sky130_fd_sc_hd__and4_1 _2_ (.A(net4),
    .B(net3),
    .C(net2),
    .D(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__and3b_1 _3_ (.A_N(net8),
    .B(net1),
    .C(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__and3_1 _4_ (.A(net4),
    .B(net2),
    .C(_0_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_1 _5_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
